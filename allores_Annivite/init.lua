...
if minetest.get_modpath("allores_annivite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_annivite:Annivite", {
	description = S("Annivite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_annivite:allores2 1",
	recipe = "allores_annivite:Annivite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
