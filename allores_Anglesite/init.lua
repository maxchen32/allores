...
if minetest.get_modpath("allores_anglesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_anglesite:Anglesite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_anglesite:allores2 1",
	recipe = "allores_anglesite:Anglesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_anglesite:Anglesite",
