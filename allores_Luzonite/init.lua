...
if minetest.get_modpath("allores_luzonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_luzonite:Luzonite", {
	description = S("Luzonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_luzonite:allores2 1",
	recipe = "allores_luzonite:Luzonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
