...
if minetest.get_modpath("allores_heyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_heyite:Heyite", {
	description = S("Heyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_heyite:allores2 1",
	recipe = "allores_heyite:Heyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
