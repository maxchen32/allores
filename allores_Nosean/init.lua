...
if minetest.get_modpath("allores_nosean") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nosean:Nosean", {
	description = S("Nosean") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nosean:allores2 1",
	recipe = "allores_nosean:Nosean",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
