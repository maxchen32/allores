...
if minetest.get_modpath("allores_morinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_morinite:Morinite", {
	description = S("Morinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_morinite:allores2 1",
	recipe = "allores_morinite:Morinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
