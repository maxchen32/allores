...
if minetest.get_modpath("allores_dixenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dixenite:Dixenite", {
	description = S("Dixenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dixenite:allores2 1",
	recipe = "allores_dixenite:Dixenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
