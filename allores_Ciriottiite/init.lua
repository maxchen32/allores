...
if minetest.get_modpath("allores_ciriottiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ciriottiite:Ciriottiite", {
	description = S("Ciriottiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ciriottiite:allores2 1",
	recipe = "allores_ciriottiite:Ciriottiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ciriottiite:Ciriottiite",
