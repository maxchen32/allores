...
if minetest.get_modpath("allores_coesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_coesite:Coesite", {
	description = S("Coesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_coesite:allores2 1",
	recipe = "allores_coesite:Coesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
