...
if minetest.get_modpath("allores_tyretskite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tyretskite:Tyretskite", {
	description = S("Tyretskite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tyretskite:allores2 1",
	recipe = "allores_tyretskite:Tyretskite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_tyretskite:Tyretskite",
