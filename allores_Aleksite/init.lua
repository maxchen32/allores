...
if minetest.get_modpath("allores_aleksite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_aleksite:Aleksite", {
	description = S("Aleksite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_aleksite:allores2 1",
	recipe = "allores_aleksite:Aleksite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
