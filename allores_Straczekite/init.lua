...
if minetest.get_modpath("allores_straczekite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_straczekite:Straczekite", {
	description = S("Straczekite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_straczekite:allores2 1",
	recipe = "allores_straczekite:Straczekite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_straczekite:Straczekite",
