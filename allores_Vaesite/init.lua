...
if minetest.get_modpath("allores_vaesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vaesite:Vaesite", {
	description = S("Vaesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vaesite:allores2 1",
	recipe = "allores_vaesite:Vaesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
