...
if minetest.get_modpath("allores_martyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_martyite:Martyite", {
	description = S("Martyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_martyite:allores2 1",
	recipe = "allores_martyite:Martyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
