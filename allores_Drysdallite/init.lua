...
if minetest.get_modpath("allores_drysdallite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_drysdallite:Drysdallite", {
	description = S("Drysdallite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_drysdallite:allores2 1",
	recipe = "allores_drysdallite:Drysdallite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_drysdallite:Drysdallite",
