...
if minetest.get_modpath("allores_alunogen") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_alunogen:Alunogen", {
	description = S("Alunogen") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_alunogen:allores2 1",
	recipe = "allores_alunogen:Alunogen",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
