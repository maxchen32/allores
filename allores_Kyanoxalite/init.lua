...
if minetest.get_modpath("allores_kyanoxalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kyanoxalite:Kyanoxalite", {
	description = S("Kyanoxalite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kyanoxalite:allores2 1",
	recipe = "allores_kyanoxalite:Kyanoxalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kyanoxalite:Kyanoxalite",
