...
if minetest.get_modpath("allores_oyelite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_oyelite:Oyelite", {
	description = S("Oyelite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_oyelite:allores2 1",
	recipe = "allores_oyelite:Oyelite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
