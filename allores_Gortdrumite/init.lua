...
if minetest.get_modpath("allores_gortdrumite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gortdrumite:Gortdrumite", {
	description = S("Gortdrumite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gortdrumite:allores2 1",
	recipe = "allores_gortdrumite:Gortdrumite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_gortdrumite:Gortdrumite",
