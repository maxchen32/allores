...
if minetest.get_modpath("allores_fraipontite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fraipontite:Fraipontite", {
	description = S("Fraipontite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fraipontite:allores2 1",
	recipe = "allores_fraipontite:Fraipontite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_fraipontite:Fraipontite",
