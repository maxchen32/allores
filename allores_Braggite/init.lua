...
if minetest.get_modpath("allores_braggite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_braggite:Braggite", {
	description = S("Braggite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_braggite:allores2 1",
	recipe = "allores_braggite:Braggite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
