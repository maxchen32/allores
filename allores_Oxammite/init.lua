...
if minetest.get_modpath("allores_oxammite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_oxammite:Oxammite", {
	description = S("Oxammite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_oxammite:allores2 1",
	recipe = "allores_oxammite:Oxammite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
