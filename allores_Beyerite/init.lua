...
if minetest.get_modpath("allores_beyerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_beyerite:Beyerite", {
	description = S("Beyerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_beyerite:allores2 1",
	recipe = "allores_beyerite:Beyerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
