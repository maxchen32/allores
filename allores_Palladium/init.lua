...
if minetest.get_modpath("allores_palladium") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_palladium:Palladium", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_palladium:allores2 1",
	recipe = "allores_palladium:Palladium",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_palladium:Palladium",
