...
if minetest.get_modpath("allores_orthoclase") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_orthoclase:Orthoclase", {
	description = S("Orthoclase") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_orthoclase:allores2 1",
	recipe = "allores_orthoclase:Orthoclase",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_orthoclase:Orthoclase",
