...
if minetest.get_modpath("allores_spinel") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_spinel:Spinel", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_spinel:allores2 1",
	recipe = "allores_spinel:Spinel",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
