...
if minetest.get_modpath("allores_yangite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_yangite:Yangite", {
	description = S("Yangite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_yangite:allores2 1",
	recipe = "allores_yangite:Yangite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
