...
if minetest.get_modpath("allores_lunokite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lunokite:Lunokite", {
	description = S("Lunokite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lunokite:allores2 1",
	recipe = "allores_lunokite:Lunokite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
