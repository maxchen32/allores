...
if minetest.get_modpath("allores_sayrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sayrite:Sayrite", {
	description = S("Sayrite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sayrite:allores2 1",
	recipe = "allores_sayrite:Sayrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
