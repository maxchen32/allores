...
if minetest.get_modpath("allores_krupickaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_krupickaite:Krupickaite", {
	description = S("Krupickaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_krupickaite:allores2 1",
	recipe = "allores_krupickaite:Krupickaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_krupickaite:Krupickaite",
