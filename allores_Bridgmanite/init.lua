...
if minetest.get_modpath("allores_bridgmanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bridgmanite:Bridgmanite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bridgmanite:allores2 1",
	recipe = "allores_bridgmanite:Bridgmanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bridgmanite:Bridgmanite",
