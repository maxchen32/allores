...
if minetest.get_modpath("allores_grischunite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_grischunite:Grischunite", {
	description = S("Grischunite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_grischunite:allores2 1",
	recipe = "allores_grischunite:Grischunite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_grischunite:Grischunite",
