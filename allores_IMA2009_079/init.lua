...
if minetest.get_modpath("allores_ima2009_079") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ima2009_079:IMA2009_079", {
	description = S("IMA2009_079") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ima2009_079:allores2 1",
	recipe = "allores_ima2009_079:IMA2009_079",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ima2009_079:IMA2009_079",
