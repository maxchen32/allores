...
if minetest.get_modpath("allores_joanneumite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_joanneumite:Joanneumite", {
	description = S("Joanneumite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_joanneumite:allores2 1",
	recipe = "allores_joanneumite:Joanneumite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_joanneumite:Joanneumite",
