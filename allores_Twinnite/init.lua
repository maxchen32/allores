...
if minetest.get_modpath("allores_twinnite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_twinnite:Twinnite", {
	description = S("Twinnite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_twinnite:allores2 1",
	recipe = "allores_twinnite:Twinnite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
