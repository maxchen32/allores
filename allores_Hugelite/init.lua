...
if minetest.get_modpath("allores_hugelite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hugelite:Hugelite", {
	description = S("Hugelite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hugelite:allores2 1",
	recipe = "allores_hugelite:Hugelite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
