...
if minetest.get_modpath("allores_pararealgar") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pararealgar:Pararealgar", {
	description = S("Pararealgar") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pararealgar:allores2 1",
	recipe = "allores_pararealgar:Pararealgar",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_pararealgar:Pararealgar",
