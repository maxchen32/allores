...
if minetest.get_modpath("allores_itoigawaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_itoigawaite:Itoigawaite", {
	description = S("Itoigawaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_itoigawaite:allores2 1",
	recipe = "allores_itoigawaite:Itoigawaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_itoigawaite:Itoigawaite",
