...
if minetest.get_modpath("allores_ercitite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ercitite:Ercitite", {
	description = S("Ercitite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ercitite:allores2 1",
	recipe = "allores_ercitite:Ercitite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
