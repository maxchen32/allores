...
if minetest.get_modpath("allores_esperite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_esperite:Esperite", {
	description = S("Esperite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_esperite:allores2 1",
	recipe = "allores_esperite:Esperite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
