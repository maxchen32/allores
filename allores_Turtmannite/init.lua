...
if minetest.get_modpath("allores_turtmannite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_turtmannite:Turtmannite", {
	description = S("Turtmannite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_turtmannite:allores2 1",
	recipe = "allores_turtmannite:Turtmannite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_turtmannite:Turtmannite",
