...
if minetest.get_modpath("allores_lecoqite_y") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lecoqite_y:Lecoqite_Y", {
	description = S("Lecoqite_Y") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lecoqite_y:allores2 1",
	recipe = "allores_lecoqite_y:Lecoqite_Y",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_lecoqite_y:Lecoqite_Y",
