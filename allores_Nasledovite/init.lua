...
if minetest.get_modpath("allores_nasledovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nasledovite:Nasledovite", {
	description = S("Nasledovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nasledovite:allores2 1",
	recipe = "allores_nasledovite:Nasledovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_nasledovite:Nasledovite",
