...
if minetest.get_modpath("allores_zaherite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zaherite:Zaherite", {
	description = S("Zaherite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zaherite:allores2 1",
	recipe = "allores_zaherite:Zaherite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
