...
if minetest.get_modpath("allores_behounekite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_behounekite:Behounekite", {
	description = S("Behounekite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_behounekite:allores2 1",
	recipe = "allores_behounekite:Behounekite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_behounekite:Behounekite",
