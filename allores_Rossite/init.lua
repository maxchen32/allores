...
if minetest.get_modpath("allores_rossite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rossite:Rossite", {
	description = S("Rossite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rossite:allores2 1",
	recipe = "allores_rossite:Rossite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
