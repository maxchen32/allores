...
if minetest.get_modpath("allores_tsepinite_k") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tsepinite_k:Tsepinite_K", {
	description = S("Tsepinite_K") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tsepinite_k:allores2 1",
	recipe = "allores_tsepinite_k:Tsepinite_K",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_tsepinite_k:Tsepinite_K",
