...
if minetest.get_modpath("allores_aradite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_aradite:Aradite", {
	description = S("Aradite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_aradite:allores2 1",
	recipe = "allores_aradite:Aradite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
