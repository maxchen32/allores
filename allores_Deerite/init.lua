...
if minetest.get_modpath("allores_deerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_deerite:Deerite", {
	description = S("Deerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_deerite:allores2 1",
	recipe = "allores_deerite:Deerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
