...
if minetest.get_modpath("allores_backite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_backite:Backite", {
	description = S("Backite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_backite:allores2 1",
	recipe = "allores_backite:Backite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
