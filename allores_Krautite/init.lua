...
if minetest.get_modpath("allores_krautite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_krautite:Krautite", {
	description = S("Krautite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_krautite:allores2 1",
	recipe = "allores_krautite:Krautite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
