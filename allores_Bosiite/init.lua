...
if minetest.get_modpath("allores_bosiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bosiite:Bosiite", {
	description = S("Bosiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bosiite:allores2 1",
	recipe = "allores_bosiite:Bosiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
