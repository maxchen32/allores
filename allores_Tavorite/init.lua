...
if minetest.get_modpath("allores_tavorite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tavorite:Tavorite", {
	description = S("Tavorite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tavorite:allores2 1",
	recipe = "allores_tavorite:Tavorite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
