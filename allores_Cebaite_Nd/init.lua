...
if minetest.get_modpath("allores_cebaite_nd") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cebaite_nd:Cebaite_Nd", {
	description = S("Cebaite_Nd") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cebaite_nd:allores2 1",
	recipe = "allores_cebaite_nd:Cebaite_Nd",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_cebaite_nd:Cebaite_Nd",
