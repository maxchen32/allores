...
if minetest.get_modpath("allores_saleeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_saleeite:Saleeite", {
	description = S("Saleeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_saleeite:allores2 1",
	recipe = "allores_saleeite:Saleeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
