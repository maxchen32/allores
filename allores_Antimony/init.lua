...
if minetest.get_modpath("allores_antimony") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_antimony:Antimony", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_antimony:allores2 1",
	recipe = "allores_antimony:Antimony",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
