...
if minetest.get_modpath("allores_calcite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_calcite:Calcite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_calcite:allores2 1",
	recipe = "allores_calcite:Calcite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
