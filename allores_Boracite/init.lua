...
if minetest.get_modpath("allores_boracite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_boracite:Boracite", {
	description = S("Boracite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_boracite:allores2 1",
	recipe = "allores_boracite:Boracite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
