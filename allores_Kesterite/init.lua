...
if minetest.get_modpath("allores_kesterite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kesterite:Kesterite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kesterite:allores2 1",
	recipe = "allores_kesterite:Kesterite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kesterite:Kesterite",
