...
if minetest.get_modpath("allores_adanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_adanite:Adanite", {
	description = S("Adanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_adanite:allores2 1",
	recipe = "allores_adanite:Adanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
