...
if minetest.get_modpath("allores_galuskinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_galuskinite:Galuskinite", {
	description = S("Galuskinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_galuskinite:allores2 1",
	recipe = "allores_galuskinite:Galuskinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_galuskinite:Galuskinite",
