...
if minetest.get_modpath("allores_bobmeyerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bobmeyerite:Bobmeyerite", {
	description = S("Bobmeyerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bobmeyerite:allores2 1",
	recipe = "allores_bobmeyerite:Bobmeyerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bobmeyerite:Bobmeyerite",
