...
if minetest.get_modpath("allores_nuffieldite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nuffieldite:Nuffieldite", {
	description = S("Nuffieldite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nuffieldite:allores2 1",
	recipe = "allores_nuffieldite:Nuffieldite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_nuffieldite:Nuffieldite",
