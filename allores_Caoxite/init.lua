...
if minetest.get_modpath("allores_caoxite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_caoxite:Caoxite", {
	description = S("Caoxite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_caoxite:allores2 1",
	recipe = "allores_caoxite:Caoxite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
