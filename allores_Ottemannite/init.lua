...
if minetest.get_modpath("allores_ottemannite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ottemannite:Ottemannite", {
	description = S("Ottemannite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ottemannite:allores2 1",
	recipe = "allores_ottemannite:Ottemannite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ottemannite:Ottemannite",
