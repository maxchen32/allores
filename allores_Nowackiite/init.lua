...
if minetest.get_modpath("allores_nowackiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nowackiite:Nowackiite", {
	description = S("Nowackiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nowackiite:allores2 1",
	recipe = "allores_nowackiite:Nowackiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_nowackiite:Nowackiite",
