...
if minetest.get_modpath("allores_argutite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_argutite:Argutite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_argutite:allores2 1",
	recipe = "allores_argutite:Argutite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
