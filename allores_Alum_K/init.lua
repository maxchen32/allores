...
if minetest.get_modpath("allores_alum_k") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_alum_k:Alum_K", {
	description = S("Alum_K") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_alum_k:allores2 1",
	recipe = "allores_alum_k:Alum_K",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
