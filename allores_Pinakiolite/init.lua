...
if minetest.get_modpath("allores_pinakiolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pinakiolite:Pinakiolite", {
	description = S("Pinakiolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pinakiolite:allores2 1",
	recipe = "allores_pinakiolite:Pinakiolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_pinakiolite:Pinakiolite",
