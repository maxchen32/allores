...
if minetest.get_modpath("allores_oenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_oenite:Oenite", {
	description = S("Oenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_oenite:allores2 1",
	recipe = "allores_oenite:Oenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
