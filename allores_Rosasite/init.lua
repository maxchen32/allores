...
if minetest.get_modpath("allores_rosasite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rosasite:Rosasite", {
	description = S("Rosasite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rosasite:allores2 1",
	recipe = "allores_rosasite:Rosasite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
