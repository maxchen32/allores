...
if minetest.get_modpath("allores_cuprite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cuprite:Cuprite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cuprite:allores2 1",
	recipe = "allores_cuprite:Cuprite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
