...
if minetest.get_modpath("allores_catapleiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_catapleiite:Catapleiite", {
	description = S("Catapleiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_catapleiite:allores2 1",
	recipe = "allores_catapleiite:Catapleiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_catapleiite:Catapleiite",
