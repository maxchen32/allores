...
if minetest.get_modpath("allores_airdite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_airdite:Airdite", {
	description = S("Airdite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_airdite:allores2 1",
	recipe = "allores_airdite:Airdite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
