...
if minetest.get_modpath("allores_covellite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_covellite:Covellite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_covellite:allores2 1",
	recipe = "allores_covellite:Covellite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_covellite:Covellite",
