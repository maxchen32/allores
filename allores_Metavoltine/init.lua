...
if minetest.get_modpath("allores_metavoltine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_metavoltine:Metavoltine", {
	description = S("Metavoltine") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_metavoltine:allores2 1",
	recipe = "allores_metavoltine:Metavoltine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_metavoltine:Metavoltine",
