...
if minetest.get_modpath("allores_johnwalkite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_johnwalkite:Johnwalkite", {
	description = S("Johnwalkite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_johnwalkite:allores2 1",
	recipe = "allores_johnwalkite:Johnwalkite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_johnwalkite:Johnwalkite",
