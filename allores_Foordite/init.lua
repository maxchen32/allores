...
if minetest.get_modpath("allores_foordite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_foordite:Foordite", {
	description = S("Foordite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_foordite:allores2 1",
	recipe = "allores_foordite:Foordite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
