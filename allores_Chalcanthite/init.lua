allores_chalcanthite = {}
local S = minetest.get_translator(minetest.get_current_modname())

if minetest.get_modpath("allores_chalcanthite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chalcanthite:Chalcanthite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chalcanthite:allores2 1",
	recipe = "allores_chalcanthite:Chalcanthite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chalcanthite:Chalcanthite",
