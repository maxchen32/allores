...
if minetest.get_modpath("allores_olivenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_olivenite:Olivenite", {
	description = S("Olivenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_olivenite:allores2 1",
	recipe = "allores_olivenite:Olivenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_olivenite:Olivenite",
