...
if minetest.get_modpath("allores_hibonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hibonite:Hibonite", {
	description = S("Hibonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hibonite:allores2 1",
	recipe = "allores_hibonite:Hibonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
