...
if minetest.get_modpath("allores_silicon") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_silicon:Silicon", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_silicon:allores2 1",
	recipe = "allores_silicon:Silicon",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
