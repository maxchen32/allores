...
if minetest.get_modpath("allores_stutzite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_stutzite:Stutzite", {
	description = S("Stutzite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_stutzite:allores2 1",
	recipe = "allores_stutzite:Stutzite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
