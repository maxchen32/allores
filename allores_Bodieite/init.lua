...
if minetest.get_modpath("allores_bodieite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bodieite:Bodieite", {
	description = S("Bodieite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bodieite:allores2 1",
	recipe = "allores_bodieite:Bodieite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
