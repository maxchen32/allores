...
if minetest.get_modpath("allores_godlevskite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_godlevskite:Godlevskite", {
	description = S("Godlevskite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_godlevskite:allores2 1",
	recipe = "allores_godlevskite:Godlevskite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_godlevskite:Godlevskite",
