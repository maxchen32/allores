...
if minetest.get_modpath("allores_rozenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rozenite:Rozenite", {
	description = S("Rozenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rozenite:allores2 1",
	recipe = "allores_rozenite:Rozenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
