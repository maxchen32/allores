...
if minetest.get_modpath("allores_cookeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cookeite:Cookeite", {
	description = S("Cookeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cookeite:allores2 1",
	recipe = "allores_cookeite:Cookeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
