...
if minetest.get_modpath("allores_tilasite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tilasite:Tilasite", {
	description = S("Tilasite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tilasite:allores2 1",
	recipe = "allores_tilasite:Tilasite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
