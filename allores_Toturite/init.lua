...
if minetest.get_modpath("allores_toturite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_toturite:Toturite", {
	description = S("Toturite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_toturite:allores2 1",
	recipe = "allores_toturite:Toturite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
