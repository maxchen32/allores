...
if minetest.get_modpath("allores_tripuhyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tripuhyite:Tripuhyite", {
	description = S("Tripuhyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tripuhyite:allores2 1",
	recipe = "allores_tripuhyite:Tripuhyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_tripuhyite:Tripuhyite",
