...
if minetest.get_modpath("allores_gottardiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gottardiite:Gottardiite", {
	description = S("Gottardiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gottardiite:allores2 1",
	recipe = "allores_gottardiite:Gottardiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_gottardiite:Gottardiite",
