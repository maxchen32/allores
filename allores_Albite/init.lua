...
if minetest.get_modpath("allores_albite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_albite:Albite", {
	description = S("Albite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_albite:allores2 1",
	recipe = "allores_albite:Albite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
