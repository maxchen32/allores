...
if minetest.get_modpath("allores_attakolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_attakolite:Attakolite", {
	description = S("Attakolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_attakolite:allores2 1",
	recipe = "allores_attakolite:Attakolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_attakolite:Attakolite",
