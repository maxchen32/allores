...
if minetest.get_modpath("allores_bukovskyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bukovskyite:Bukovskyite", {
	description = S("Bukovskyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bukovskyite:allores2 1",
	recipe = "allores_bukovskyite:Bukovskyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bukovskyite:Bukovskyite",
