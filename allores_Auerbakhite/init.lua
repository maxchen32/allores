...
if minetest.get_modpath("allores_auerbakhite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_auerbakhite:Auerbakhite", {
	description = S("Auerbakhite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_auerbakhite:allores2 1",
	recipe = "allores_auerbakhite:Auerbakhite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_auerbakhite:Auerbakhite",
