...
if minetest.get_modpath("allores_wulfenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wulfenite:Wulfenite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wulfenite:allores2 1",
	recipe = "allores_wulfenite:Wulfenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_wulfenite:Wulfenite",
