...
if minetest.get_modpath("allores_iodargyrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_iodargyrite:Iodargyrite", {
	description = S("Iodargyrite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_iodargyrite:allores2 1",
	recipe = "allores_iodargyrite:Iodargyrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_iodargyrite:Iodargyrite",
