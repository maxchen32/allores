...
if minetest.get_modpath("allores_greigite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_greigite:Greigite", {
	description = S("Greigite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_greigite:allores2 1",
	recipe = "allores_greigite:Greigite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
