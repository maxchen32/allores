...
if minetest.get_modpath("allores_jarandolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jarandolite:Jarandolite", {
	description = S("Jarandolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jarandolite:allores2 1",
	recipe = "allores_jarandolite:Jarandolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_jarandolite:Jarandolite",
