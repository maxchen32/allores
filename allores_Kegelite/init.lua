...
if minetest.get_modpath("allores_kegelite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kegelite:Kegelite", {
	description = S("Kegelite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kegelite:allores2 1",
	recipe = "allores_kegelite:Kegelite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
