...
if minetest.get_modpath("allores_tokkoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tokkoite:Tokkoite", {
	description = S("Tokkoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tokkoite:allores2 1",
	recipe = "allores_tokkoite:Tokkoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
