...
if minetest.get_modpath("allores_fehrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fehrite:Fehrite", {
	description = S("Fehrite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fehrite:allores2 1",
	recipe = "allores_fehrite:Fehrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
