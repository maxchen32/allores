...
if minetest.get_modpath("allores_trona") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_trona:Trona", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_trona:allores2 1",
	recipe = "allores_trona:Trona",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
