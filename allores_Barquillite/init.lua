...
if minetest.get_modpath("allores_barquillite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_barquillite:Barquillite", {
	description = S("Barquillite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_barquillite:allores2 1",
	recipe = "allores_barquillite:Barquillite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_barquillite:Barquillite",
