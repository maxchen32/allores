...
if minetest.get_modpath("allores_therasiaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_therasiaite:Therasiaite", {
	description = S("Therasiaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_therasiaite:allores2 1",
	recipe = "allores_therasiaite:Therasiaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_therasiaite:Therasiaite",
