...
if minetest.get_modpath("allores_galaxite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_galaxite:Galaxite", {
	description = S("Galaxite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_galaxite:allores2 1",
	recipe = "allores_galaxite:Galaxite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
