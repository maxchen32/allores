...
if minetest.get_modpath("allores_stibarsen") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_stibarsen:Stibarsen", {
	description = S("Stibarsen") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_stibarsen:allores2 1",
	recipe = "allores_stibarsen:Stibarsen",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_stibarsen:Stibarsen",
