...
if minetest.get_modpath("allores_paqueite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_paqueite:Paqueite", {
	description = S("Paqueite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_paqueite:allores2 1",
	recipe = "allores_paqueite:Paqueite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
