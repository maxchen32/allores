...
if minetest.get_modpath("allores_namuwite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_namuwite:Namuwite", {
	description = S("Namuwite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_namuwite:allores2 1",
	recipe = "allores_namuwite:Namuwite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
