...
if minetest.get_modpath("allores_zorite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zorite:Zorite", {
	description = S("Zorite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zorite:allores2 1",
	recipe = "allores_zorite:Zorite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
