...
if minetest.get_modpath("allores_wenjiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wenjiite:Wenjiite", {
	description = S("Wenjiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wenjiite:allores2 1",
	recipe = "allores_wenjiite:Wenjiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
