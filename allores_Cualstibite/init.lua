...
if minetest.get_modpath("allores_cualstibite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cualstibite:Cualstibite", {
	description = S("Cualstibite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cualstibite:allores2 1",
	recipe = "allores_cualstibite:Cualstibite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_cualstibite:Cualstibite",
