...
if minetest.get_modpath("allores_aheylite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_aheylite:Aheylite", {
	description = S("Aheylite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_aheylite:allores2 1",
	recipe = "allores_aheylite:Aheylite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
