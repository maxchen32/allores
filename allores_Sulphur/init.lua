...
if minetest.get_modpath("allores_sulphur") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sulphur:Sulphur", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sulphur:allores2 1",
	recipe = "allores_sulphur:Sulphur",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
