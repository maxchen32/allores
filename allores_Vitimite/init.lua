...
if minetest.get_modpath("allores_vitimite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vitimite:Vitimite", {
	description = S("Vitimite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vitimite:allores2 1",
	recipe = "allores_vitimite:Vitimite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
