...
if minetest.get_modpath("allores_sztrokayite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sztrokayite:Sztrokayite", {
	description = S("Sztrokayite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sztrokayite:allores2 1",
	recipe = "allores_sztrokayite:Sztrokayite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_sztrokayite:Sztrokayite",
