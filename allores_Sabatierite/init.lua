...
if minetest.get_modpath("allores_sabatierite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sabatierite:Sabatierite", {
	description = S("Sabatierite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sabatierite:allores2 1",
	recipe = "allores_sabatierite:Sabatierite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_sabatierite:Sabatierite",
