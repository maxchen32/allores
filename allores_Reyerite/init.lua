...
if minetest.get_modpath("allores_reyerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_reyerite:Reyerite", {
	description = S("Reyerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_reyerite:allores2 1",
	recipe = "allores_reyerite:Reyerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
