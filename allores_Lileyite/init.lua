...
if minetest.get_modpath("allores_lileyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lileyite:Lileyite", {
	description = S("Lileyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lileyite:allores2 1",
	recipe = "allores_lileyite:Lileyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
