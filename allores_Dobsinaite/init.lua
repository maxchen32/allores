...
if minetest.get_modpath("allores_dobsinaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dobsinaite:Dobsinaite", {
	description = S("Dobsinaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dobsinaite:allores2 1",
	recipe = "allores_dobsinaite:Dobsinaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_dobsinaite:Dobsinaite",
