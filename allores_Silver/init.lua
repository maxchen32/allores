...
if minetest.get_modpath("allores_silver") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_silver:Silver", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_silver:allores2 1",
	recipe = "allores_silver:Silver",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
