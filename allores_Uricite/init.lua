...
if minetest.get_modpath("allores_uricite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_uricite:Uricite", {
	description = S("Uricite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_uricite:allores2 1",
	recipe = "allores_uricite:Uricite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
