...
if minetest.get_modpath("allores_cossaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cossaite:Cossaite", {
	description = S("Cossaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cossaite:allores2 1",
	recipe = "allores_cossaite:Cossaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
