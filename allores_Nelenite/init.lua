...
if minetest.get_modpath("allores_nelenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nelenite:Nelenite", {
	description = S("Nelenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nelenite:allores2 1",
	recipe = "allores_nelenite:Nelenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
