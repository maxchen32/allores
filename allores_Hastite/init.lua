...
if minetest.get_modpath("allores_hastite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hastite:Hastite", {
	description = S("Hastite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hastite:allores2 1",
	recipe = "allores_hastite:Hastite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
