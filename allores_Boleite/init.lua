...
if minetest.get_modpath("allores_boleite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_boleite:Boleite", {
	description = S("Boleite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_boleite:allores2 1",
	recipe = "allores_boleite:Boleite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
