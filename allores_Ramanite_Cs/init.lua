...
if minetest.get_modpath("allores_ramanite_cs") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ramanite_cs:Ramanite_Cs", {
	description = S("Ramanite_Cs") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ramanite_cs:allores2 1",
	recipe = "allores_ramanite_cs:Ramanite_Cs",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ramanite_cs:Ramanite_Cs",
