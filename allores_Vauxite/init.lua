...
if minetest.get_modpath("allores_vauxite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vauxite:Vauxite", {
	description = S("Vauxite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vauxite:allores2 1",
	recipe = "allores_vauxite:Vauxite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
