...
if minetest.get_modpath("allores_ruthenium") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ruthenium:Ruthenium", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ruthenium:allores2 1",
	recipe = "allores_ruthenium:Ruthenium",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ruthenium:Ruthenium",
