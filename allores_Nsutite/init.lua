...
if minetest.get_modpath("allores_nsutite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nsutite:Nsutite", {
	description = S("Nsutite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nsutite:allores2 1",
	recipe = "allores_nsutite:Nsutite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
