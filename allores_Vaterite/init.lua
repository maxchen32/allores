...
if minetest.get_modpath("allores_vaterite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vaterite:Vaterite", {
	description = S("Vaterite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vaterite:allores2 1",
	recipe = "allores_vaterite:Vaterite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
