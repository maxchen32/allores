...
if minetest.get_modpath("allores_riesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_riesite:Riesite", {
	description = S("Riesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_riesite:allores2 1",
	recipe = "allores_riesite:Riesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
