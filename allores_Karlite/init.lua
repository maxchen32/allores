...
if minetest.get_modpath("allores_karlite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_karlite:Karlite", {
	description = S("Karlite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_karlite:allores2 1",
	recipe = "allores_karlite:Karlite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
