...
if minetest.get_modpath("allores_vanthoffite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vanthoffite:Vanthoffite", {
	description = S("Vanthoffite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vanthoffite:allores2 1",
	recipe = "allores_vanthoffite:Vanthoffite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_vanthoffite:Vanthoffite",
