...
if minetest.get_modpath("allores_nasinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nasinite:Nasinite", {
	description = S("Nasinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nasinite:allores2 1",
	recipe = "allores_nasinite:Nasinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
