...
if minetest.get_modpath("allores_schreyerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_schreyerite:Schreyerite", {
	description = S("Schreyerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_schreyerite:allores2 1",
	recipe = "allores_schreyerite:Schreyerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_schreyerite:Schreyerite",
