allores_thortveitite = {}
local S = minetest.get_translator(minetest.get_current_modname())

if minetest.get_modpath("allores_thortveitite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_thortveitite:Thortveitite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_thortveitite:allores2 1",
	recipe = "allores_thortveitite:Thortveitite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_thortveitite:Thortveitite",
