...
if minetest.get_modpath("allores_samraite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_samraite:Samraite", {
	description = S("Samraite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_samraite:allores2 1",
	recipe = "allores_samraite:Samraite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
