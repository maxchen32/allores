...
if minetest.get_modpath("allores_mgriite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mgriite:Mgriite", {
	description = S("Mgriite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mgriite:allores2 1",
	recipe = "allores_mgriite:Mgriite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
