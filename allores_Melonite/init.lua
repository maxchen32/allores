...
if minetest.get_modpath("allores_melonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_melonite:Melonite", {
	description = S("Melonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_melonite:allores2 1",
	recipe = "allores_melonite:Melonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
