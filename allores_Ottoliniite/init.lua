...
if minetest.get_modpath("allores_ottoliniite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ottoliniite:Ottoliniite", {
	description = S("Ottoliniite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ottoliniite:allores2 1",
	recipe = "allores_ottoliniite:Ottoliniite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ottoliniite:Ottoliniite",
