...
if minetest.get_modpath("allores_rebulite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rebulite:Rebulite", {
	description = S("Rebulite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rebulite:allores2 1",
	recipe = "allores_rebulite:Rebulite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
