...
if minetest.get_modpath("allores_humboldtine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_humboldtine:Humboldtine", {
	description = S("Humboldtine") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_humboldtine:allores2 1",
	recipe = "allores_humboldtine:Humboldtine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_humboldtine:Humboldtine",
