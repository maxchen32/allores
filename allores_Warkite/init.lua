...
if minetest.get_modpath("allores_warkite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_warkite:Warkite", {
	description = S("Warkite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_warkite:allores2 1",
	recipe = "allores_warkite:Warkite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
