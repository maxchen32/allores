...
if minetest.get_modpath("allores_welinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_welinite:Welinite", {
	description = S("Welinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_welinite:allores2 1",
	recipe = "allores_welinite:Welinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
