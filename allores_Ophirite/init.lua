...
if minetest.get_modpath("allores_ophirite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ophirite:Ophirite", {
	description = S("Ophirite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ophirite:allores2 1",
	recipe = "allores_ophirite:Ophirite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
