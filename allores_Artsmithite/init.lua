...
if minetest.get_modpath("allores_artsmithite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_artsmithite:Artsmithite", {
	description = S("Artsmithite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_artsmithite:allores2 1",
	recipe = "allores_artsmithite:Artsmithite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_artsmithite:Artsmithite",
