...
if minetest.get_modpath("allores_panguite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_panguite:Panguite", {
	description = S("Panguite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_panguite:allores2 1",
	recipe = "allores_panguite:Panguite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
