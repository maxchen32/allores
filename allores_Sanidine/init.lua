...
if minetest.get_modpath("allores_sanidine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sanidine:Sanidine", {
	description = S("Sanidine") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sanidine:allores2 1",
	recipe = "allores_sanidine:Sanidine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
