...
if minetest.get_modpath("allores_kainite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kainite:Kainite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kainite:allores2 1",
	recipe = "allores_kainite:Kainite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
