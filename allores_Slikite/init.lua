...
if minetest.get_modpath("allores_slikite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_slikite:Slikite", {
	description = S("Slikite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_slikite:allores2 1",
	recipe = "allores_slikite:Slikite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
