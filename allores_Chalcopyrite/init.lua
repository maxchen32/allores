allores_chalcopyrite = {}
local S = minetest.get_translator(minetest.get_current_modname())

if minetest.get_modpath("allores_chalcopyrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chalcopyrite:Chalcopyrite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chalcopyrite:allores2 1",
	recipe = "allores_chalcopyrite:Chalcopyrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chalcopyrite:Chalcopyrite",
