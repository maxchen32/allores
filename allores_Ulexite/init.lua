...
if minetest.get_modpath("allores_ulexite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ulexite:Ulexite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ulexite:allores2 1",
	recipe = "allores_ulexite:Ulexite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
