...
if minetest.get_modpath("allores_zheshengite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zheshengite:Zheshengite", {
	description = S("Zheshengite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zheshengite:allores2 1",
	recipe = "allores_zheshengite:Zheshengite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_zheshengite:Zheshengite",
