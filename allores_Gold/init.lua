...
if minetest.get_modpath("allores_gold") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gold:Gold", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gold:allores2 1",
	recipe = "allores_gold:Gold",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
