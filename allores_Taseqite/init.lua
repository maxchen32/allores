...
if minetest.get_modpath("allores_taseqite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_taseqite:Taseqite", {
	description = S("Taseqite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_taseqite:allores2 1",
	recipe = "allores_taseqite:Taseqite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
