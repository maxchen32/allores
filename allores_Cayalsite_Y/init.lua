...
if minetest.get_modpath("allores_cayalsite_y") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cayalsite_y:Cayalsite_Y", {
	description = S("Cayalsite_Y") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cayalsite_y:allores2 1",
	recipe = "allores_cayalsite_y:Cayalsite_Y",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_cayalsite_y:Cayalsite_Y",
