...
if minetest.get_modpath("allores_smythite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_smythite:Smythite", {
	description = S("Smythite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_smythite:allores2 1",
	recipe = "allores_smythite:Smythite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
