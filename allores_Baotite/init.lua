...
if minetest.get_modpath("allores_baotite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_baotite:Baotite", {
	description = S("Baotite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_baotite:allores2 1",
	recipe = "allores_baotite:Baotite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
