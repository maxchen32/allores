...
if minetest.get_modpath("allores_brushite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_brushite:Brushite", {
	description = S("Brushite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_brushite:allores2 1",
	recipe = "allores_brushite:Brushite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
