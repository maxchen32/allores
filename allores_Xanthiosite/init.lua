...
if minetest.get_modpath("allores_xanthiosite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_xanthiosite:Xanthiosite", {
	description = S("Xanthiosite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_xanthiosite:allores2 1",
	recipe = "allores_xanthiosite:Xanthiosite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_xanthiosite:Xanthiosite",
