...
if minetest.get_modpath("allores_szmikite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_szmikite:Szmikite", {
	description = S("Szmikite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_szmikite:allores2 1",
	recipe = "allores_szmikite:Szmikite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
