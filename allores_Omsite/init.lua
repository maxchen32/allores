...
if minetest.get_modpath("allores_omsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_omsite:Omsite", {
	description = S("Omsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_omsite:allores2 1",
	recipe = "allores_omsite:Omsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
