...
if minetest.get_modpath("allores_nabimusaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nabimusaite:Nabimusaite", {
	description = S("Nabimusaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nabimusaite:allores2 1",
	recipe = "allores_nabimusaite:Nabimusaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_nabimusaite:Nabimusaite",
