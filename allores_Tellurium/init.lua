...
if minetest.get_modpath("allores_tellurium") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tellurium:Tellurium", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tellurium:allores2 1",
	recipe = "allores_tellurium:Tellurium",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_tellurium:Tellurium",
