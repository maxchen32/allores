...
if minetest.get_modpath("allores_khinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_khinite:Khinite", {
	description = S("Khinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_khinite:allores2 1",
	recipe = "allores_khinite:Khinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
