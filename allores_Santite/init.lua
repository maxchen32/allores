...
if minetest.get_modpath("allores_santite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_santite:Santite", {
	description = S("Santite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_santite:allores2 1",
	recipe = "allores_santite:Santite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
