...
if minetest.get_modpath("allores_bederite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bederite:Bederite", {
	description = S("Bederite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bederite:allores2 1",
	recipe = "allores_bederite:Bederite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
