...
if minetest.get_modpath("allores_alterite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_alterite:Alterite", {
	description = S("Alterite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_alterite:allores2 1",
	recipe = "allores_alterite:Alterite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
