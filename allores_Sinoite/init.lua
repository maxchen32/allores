...
if minetest.get_modpath("allores_sinoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sinoite:Sinoite", {
	description = S("Sinoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sinoite:allores2 1",
	recipe = "allores_sinoite:Sinoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
