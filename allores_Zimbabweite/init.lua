...
if minetest.get_modpath("allores_zimbabweite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zimbabweite:Zimbabweite", {
	description = S("Zimbabweite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zimbabweite:allores2 1",
	recipe = "allores_zimbabweite:Zimbabweite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_zimbabweite:Zimbabweite",
