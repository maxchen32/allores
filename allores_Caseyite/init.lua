...
if minetest.get_modpath("allores_caseyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_caseyite:Caseyite", {
	description = S("Caseyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_caseyite:allores2 1",
	recipe = "allores_caseyite:Caseyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
