...
if minetest.get_modpath("allores_kumtyubeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kumtyubeite:Kumtyubeite", {
	description = S("Kumtyubeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kumtyubeite:allores2 1",
	recipe = "allores_kumtyubeite:Kumtyubeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kumtyubeite:Kumtyubeite",
