...
if minetest.get_modpath("allores_celsian") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_celsian:Celsian", {
	description = S("Celsian") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_celsian:allores2 1",
	recipe = "allores_celsian:Celsian",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
