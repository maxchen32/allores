...
if minetest.get_modpath("allores_pekoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pekoite:Pekoite", {
	description = S("Pekoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pekoite:allores2 1",
	recipe = "allores_pekoite:Pekoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
