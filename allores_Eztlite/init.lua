...
if minetest.get_modpath("allores_eztlite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_eztlite:Eztlite", {
	description = S("Eztlite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_eztlite:allores2 1",
	recipe = "allores_eztlite:Eztlite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
