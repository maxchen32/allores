...
if minetest.get_modpath("allores_ulvospinel") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ulvospinel:Ulvospinel", {
	description = S("Ulvospinel") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ulvospinel:allores2 1",
	recipe = "allores_ulvospinel:Ulvospinel",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ulvospinel:Ulvospinel",
