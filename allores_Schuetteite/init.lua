...
if minetest.get_modpath("allores_schuetteite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_schuetteite:Schuetteite", {
	description = S("Schuetteite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_schuetteite:allores2 1",
	recipe = "allores_schuetteite:Schuetteite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_schuetteite:Schuetteite",
