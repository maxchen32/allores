...
if minetest.get_modpath("allores_karelianite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_karelianite:Karelianite", {
	description = S("Karelianite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_karelianite:allores2 1",
	recipe = "allores_karelianite:Karelianite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_karelianite:Karelianite",
