...
if minetest.get_modpath("allores_faustite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_faustite:Faustite", {
	description = S("Faustite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_faustite:allores2 1",
	recipe = "allores_faustite:Faustite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
