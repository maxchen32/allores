...
if minetest.get_modpath("allores_verbeekite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_verbeekite:Verbeekite", {
	description = S("Verbeekite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_verbeekite:allores2 1",
	recipe = "allores_verbeekite:Verbeekite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_verbeekite:Verbeekite",
