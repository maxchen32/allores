...
if minetest.get_modpath("allores_bergslagite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bergslagite:Bergslagite", {
	description = S("Bergslagite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bergslagite:allores2 1",
	recipe = "allores_bergslagite:Bergslagite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bergslagite:Bergslagite",
