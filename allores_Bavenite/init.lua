...
if minetest.get_modpath("allores_bavenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bavenite:Bavenite", {
	description = S("Bavenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bavenite:allores2 1",
	recipe = "allores_bavenite:Bavenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
