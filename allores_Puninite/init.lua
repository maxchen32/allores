...
if minetest.get_modpath("allores_puninite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_puninite:Puninite", {
	description = S("Puninite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_puninite:allores2 1",
	recipe = "allores_puninite:Puninite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
