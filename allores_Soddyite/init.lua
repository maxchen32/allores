...
if minetest.get_modpath("allores_soddyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_soddyite:Soddyite", {
	description = S("Soddyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_soddyite:allores2 1",
	recipe = "allores_soddyite:Soddyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
