...
if minetest.get_modpath("allores_reidite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_reidite:Reidite", {
	description = S("Reidite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_reidite:allores2 1",
	recipe = "allores_reidite:Reidite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
