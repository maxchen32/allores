...
if minetest.get_modpath("allores_jankovicite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jankovicite:Jankovicite", {
	description = S("Jankovicite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jankovicite:allores2 1",
	recipe = "allores_jankovicite:Jankovicite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_jankovicite:Jankovicite",
