...
if minetest.get_modpath("allores_fedorite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fedorite:Fedorite", {
	description = S("Fedorite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fedorite:allores2 1",
	recipe = "allores_fedorite:Fedorite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
