...
if minetest.get_modpath("allores_moganite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_moganite:Moganite", {
	description = S("Moganite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_moganite:allores2 1",
	recipe = "allores_moganite:Moganite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
