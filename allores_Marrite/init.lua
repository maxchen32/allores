...
if minetest.get_modpath("allores_marrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_marrite:Marrite", {
	description = S("Marrite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_marrite:allores2 1",
	recipe = "allores_marrite:Marrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
