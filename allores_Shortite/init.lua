...
if minetest.get_modpath("allores_shortite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_shortite:Shortite", {
	description = S("Shortite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_shortite:allores2 1",
	recipe = "allores_shortite:Shortite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
