...
if minetest.get_modpath("allores_huenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_huenite:Huenite", {
	description = S("Huenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_huenite:allores2 1",
	recipe = "allores_huenite:Huenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
