...
if minetest.get_modpath("allores_hazenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hazenite:Hazenite", {
	description = S("Hazenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hazenite:allores2 1",
	recipe = "allores_hazenite:Hazenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
