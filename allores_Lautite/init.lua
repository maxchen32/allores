...
if minetest.get_modpath("allores_lautite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lautite:Lautite", {
	description = S("Lautite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lautite:allores2 1",
	recipe = "allores_lautite:Lautite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
