...
if minetest.get_modpath("allores_polyhalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_polyhalite:Polyhalite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_polyhalite:allores2 1",
	recipe = "allores_polyhalite:Polyhalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_polyhalite:Polyhalite",
