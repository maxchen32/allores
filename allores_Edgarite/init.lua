...
if minetest.get_modpath("allores_edgarite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_edgarite:Edgarite", {
	description = S("Edgarite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_edgarite:allores2 1",
	recipe = "allores_edgarite:Edgarite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
