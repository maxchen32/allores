...
if minetest.get_modpath("allores_uvanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_uvanite:Uvanite", {
	description = S("Uvanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_uvanite:allores2 1",
	recipe = "allores_uvanite:Uvanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
