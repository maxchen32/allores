...
if minetest.get_modpath("allores_brianite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_brianite:Brianite", {
	description = S("Brianite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_brianite:allores2 1",
	recipe = "allores_brianite:Brianite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
