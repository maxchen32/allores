...
if minetest.get_modpath("allores_utahite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_utahite:Utahite", {
	description = S("Utahite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_utahite:allores2 1",
	recipe = "allores_utahite:Utahite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
