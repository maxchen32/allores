...
if minetest.get_modpath("allores_leiteite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_leiteite:Leiteite", {
	description = S("Leiteite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_leiteite:allores2 1",
	recipe = "allores_leiteite:Leiteite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
