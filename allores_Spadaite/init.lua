...
if minetest.get_modpath("allores_spadaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_spadaite:Spadaite", {
	description = S("Spadaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_spadaite:allores2 1",
	recipe = "allores_spadaite:Spadaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
