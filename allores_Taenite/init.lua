...
if minetest.get_modpath("allores_taenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_taenite:Taenite", {
	description = S("Taenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_taenite:allores2 1",
	recipe = "allores_taenite:Taenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
