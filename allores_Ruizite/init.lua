...
if minetest.get_modpath("allores_ruizite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ruizite:Ruizite", {
	description = S("Ruizite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ruizite:allores2 1",
	recipe = "allores_ruizite:Ruizite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
