...
if minetest.get_modpath("allores_katoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_katoite:Katoite", {
	description = S("Katoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_katoite:allores2 1",
	recipe = "allores_katoite:Katoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
