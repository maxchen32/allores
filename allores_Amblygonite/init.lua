...
if minetest.get_modpath("allores_amblygonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_amblygonite:Amblygonite", {
	description = S("Amblygonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_amblygonite:allores2 1",
	recipe = "allores_amblygonite:Amblygonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_amblygonite:Amblygonite",
