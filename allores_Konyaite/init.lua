...
if minetest.get_modpath("allores_konyaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_konyaite:Konyaite", {
	description = S("Konyaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_konyaite:allores2 1",
	recipe = "allores_konyaite:Konyaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
