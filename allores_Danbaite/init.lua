...
if minetest.get_modpath("allores_danbaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_danbaite:Danbaite", {
	description = S("Danbaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_danbaite:allores2 1",
	recipe = "allores_danbaite:Danbaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
