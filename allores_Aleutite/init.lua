...
if minetest.get_modpath("allores_aleutite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_aleutite:Aleutite", {
	description = S("Aleutite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_aleutite:allores2 1",
	recipe = "allores_aleutite:Aleutite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
