...
if minetest.get_modpath("allores_ekaterinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ekaterinite:Ekaterinite", {
	description = S("Ekaterinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ekaterinite:allores2 1",
	recipe = "allores_ekaterinite:Ekaterinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ekaterinite:Ekaterinite",
