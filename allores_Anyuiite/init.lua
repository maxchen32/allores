...
if minetest.get_modpath("allores_anyuiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_anyuiite:Anyuiite", {
	description = S("Anyuiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_anyuiite:allores2 1",
	recipe = "allores_anyuiite:Anyuiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
