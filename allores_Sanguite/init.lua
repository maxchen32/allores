...
if minetest.get_modpath("allores_sanguite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sanguite:Sanguite", {
	description = S("Sanguite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sanguite:allores2 1",
	recipe = "allores_sanguite:Sanguite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
