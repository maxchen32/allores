...
if minetest.get_modpath("allores_valleriite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_valleriite:Valleriite", {
	description = S("Valleriite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_valleriite:allores2 1",
	recipe = "allores_valleriite:Valleriite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_valleriite:Valleriite",
