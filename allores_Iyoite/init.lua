...
if minetest.get_modpath("allores_iyoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_iyoite:Iyoite", {
	description = S("Iyoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_iyoite:allores2 1",
	recipe = "allores_iyoite:Iyoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
