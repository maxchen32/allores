...
if minetest.get_modpath("allores_smrkovecite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_smrkovecite:Smrkovecite", {
	description = S("Smrkovecite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_smrkovecite:allores2 1",
	recipe = "allores_smrkovecite:Smrkovecite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_smrkovecite:Smrkovecite",
