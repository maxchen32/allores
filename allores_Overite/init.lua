...
if minetest.get_modpath("allores_overite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_overite:Overite", {
	description = S("Overite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_overite:allores2 1",
	recipe = "allores_overite:Overite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
