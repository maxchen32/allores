...
if minetest.get_modpath("allores_eveite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_eveite:Eveite", {
	description = S("Eveite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_eveite:allores2 1",
	recipe = "allores_eveite:Eveite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
