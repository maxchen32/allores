...
if minetest.get_modpath("allores_partzite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_partzite:Partzite", {
	description = S("Partzite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_partzite:allores2 1",
	recipe = "allores_partzite:Partzite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
