...
if minetest.get_modpath("allores_dargaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dargaite:Dargaite", {
	description = S("Dargaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dargaite:allores2 1",
	recipe = "allores_dargaite:Dargaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
