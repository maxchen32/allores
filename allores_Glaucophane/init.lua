...
if minetest.get_modpath("allores_glaucophane") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_glaucophane:Glaucophane", {
	description = S("Glaucophane") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_glaucophane:allores2 1",
	recipe = "allores_glaucophane:Glaucophane",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_glaucophane:Glaucophane",
