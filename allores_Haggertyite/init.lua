...
if minetest.get_modpath("allores_haggertyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_haggertyite:Haggertyite", {
	description = S("Haggertyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_haggertyite:allores2 1",
	recipe = "allores_haggertyite:Haggertyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_haggertyite:Haggertyite",
