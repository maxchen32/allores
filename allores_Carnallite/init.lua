...
if minetest.get_modpath("allores_carnallite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_carnallite:Carnallite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_carnallite:allores2 1",
	recipe = "allores_carnallite:Carnallite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_carnallite:Carnallite",
