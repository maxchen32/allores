...
if minetest.get_modpath("allores_jarosite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jarosite:Jarosite", {
	description = S("Jarosite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jarosite:allores2 1",
	recipe = "allores_jarosite:Jarosite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
