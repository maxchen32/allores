...
if minetest.get_modpath("allores_taramite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_taramite:Taramite", {
	description = S("Taramite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_taramite:allores2 1",
	recipe = "allores_taramite:Taramite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
