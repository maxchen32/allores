...
if minetest.get_modpath("allores_smamite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_smamite:Smamite", {
	description = S("Smamite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_smamite:allores2 1",
	recipe = "allores_smamite:Smamite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
