...
if minetest.get_modpath("allores_tangeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tangeite:Tangeite", {
	description = S("Tangeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tangeite:allores2 1",
	recipe = "allores_tangeite:Tangeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
