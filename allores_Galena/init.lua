...
if minetest.get_modpath("allores_galena") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_galena:Galena", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_galena:allores2 1",
	recipe = "allores_galena:Galena",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
