...
if minetest.get_modpath("allores_breyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_breyite:Breyite", {
	description = S("Breyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_breyite:allores2 1",
	recipe = "allores_breyite:Breyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
