...
if minetest.get_modpath("allores_komkovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_komkovite:Komkovite", {
	description = S("Komkovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_komkovite:allores2 1",
	recipe = "allores_komkovite:Komkovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_komkovite:Komkovite",
