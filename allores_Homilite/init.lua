...
if minetest.get_modpath("allores_homilite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_homilite:Homilite", {
	description = S("Homilite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_homilite:allores2 1",
	recipe = "allores_homilite:Homilite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
