...
if minetest.get_modpath("allores_goethite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_goethite:Goethite", {
	description = S("Goethite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_goethite:allores2 1",
	recipe = "allores_goethite:Goethite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
