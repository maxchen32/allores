...
if minetest.get_modpath("allores_pyrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pyrite:Pyrite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pyrite:allores2 1",
	recipe = "allores_pyrite:Pyrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
