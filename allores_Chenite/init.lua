...
if minetest.get_modpath("allores_chenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chenite:Chenite", {
	description = S("Chenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chenite:allores2 1",
	recipe = "allores_chenite:Chenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
