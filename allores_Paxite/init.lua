...
if minetest.get_modpath("allores_paxite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_paxite:Paxite", {
	description = S("Paxite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_paxite:allores2 1",
	recipe = "allores_paxite:Paxite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
