...
if minetest.get_modpath("allores_polkanovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_polkanovite:Polkanovite", {
	description = S("Polkanovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_polkanovite:allores2 1",
	recipe = "allores_polkanovite:Polkanovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_polkanovite:Polkanovite",
