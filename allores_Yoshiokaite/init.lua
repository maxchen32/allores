...
if minetest.get_modpath("allores_yoshiokaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_yoshiokaite:Yoshiokaite", {
	description = S("Yoshiokaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_yoshiokaite:allores2 1",
	recipe = "allores_yoshiokaite:Yoshiokaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_yoshiokaite:Yoshiokaite",
