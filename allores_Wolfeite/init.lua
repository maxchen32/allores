...
if minetest.get_modpath("allores_wolfeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wolfeite:Wolfeite", {
	description = S("Wolfeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wolfeite:allores2 1",
	recipe = "allores_wolfeite:Wolfeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
