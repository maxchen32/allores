...
if minetest.get_modpath("allores_brindleyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_brindleyite:Brindleyite", {
	description = S("Brindleyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_brindleyite:allores2 1",
	recipe = "allores_brindleyite:Brindleyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_brindleyite:Brindleyite",
