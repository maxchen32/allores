...
if minetest.get_modpath("allores_meifuite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_meifuite:Meifuite", {
	description = S("Meifuite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_meifuite:allores2 1",
	recipe = "allores_meifuite:Meifuite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
