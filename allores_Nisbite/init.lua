...
if minetest.get_modpath("allores_nisbite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nisbite:Nisbite", {
	description = S("Nisbite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nisbite:allores2 1",
	recipe = "allores_nisbite:Nisbite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
