...
if minetest.get_modpath("allores_sudoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sudoite:Sudoite", {
	description = S("Sudoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sudoite:allores2 1",
	recipe = "allores_sudoite:Sudoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
