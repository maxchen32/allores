...
if minetest.get_modpath("allores_jianshuiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jianshuiite:Jianshuiite", {
	description = S("Jianshuiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jianshuiite:allores2 1",
	recipe = "allores_jianshuiite:Jianshuiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_jianshuiite:Jianshuiite",
