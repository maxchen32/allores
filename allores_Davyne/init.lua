...
if minetest.get_modpath("allores_davyne") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_davyne:Davyne", {
	description = S("Davyne") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_davyne:allores2 1",
	recipe = "allores_davyne:Davyne",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
