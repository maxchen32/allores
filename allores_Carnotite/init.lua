...
if minetest.get_modpath("allores_carnotite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_carnotite:Carnotite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_carnotite:allores2 1",
	recipe = "allores_carnotite:Carnotite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_carnotite:Carnotite",
