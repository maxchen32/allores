...
if minetest.get_modpath("allores_todorokite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_todorokite:Todorokite", {
	description = S("Todorokite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_todorokite:allores2 1",
	recipe = "allores_todorokite:Todorokite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_todorokite:Todorokite",
