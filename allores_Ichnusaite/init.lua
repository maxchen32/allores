...
if minetest.get_modpath("allores_ichnusaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ichnusaite:Ichnusaite", {
	description = S("Ichnusaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ichnusaite:allores2 1",
	recipe = "allores_ichnusaite:Ichnusaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ichnusaite:Ichnusaite",
