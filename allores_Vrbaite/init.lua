...
if minetest.get_modpath("allores_vrbaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vrbaite:Vrbaite", {
	description = S("Vrbaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vrbaite:allores2 1",
	recipe = "allores_vrbaite:Vrbaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
