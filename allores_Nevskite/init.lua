...
if minetest.get_modpath("allores_nevskite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nevskite:Nevskite", {
	description = S("Nevskite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nevskite:allores2 1",
	recipe = "allores_nevskite:Nevskite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
