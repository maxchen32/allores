...
if minetest.get_modpath("allores_hillite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hillite:Hillite", {
	description = S("Hillite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hillite:allores2 1",
	recipe = "allores_hillite:Hillite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
