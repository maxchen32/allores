...
if minetest.get_modpath("allores_gwihabaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gwihabaite:Gwihabaite", {
	description = S("Gwihabaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gwihabaite:allores2 1",
	recipe = "allores_gwihabaite:Gwihabaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_gwihabaite:Gwihabaite",
