...
if minetest.get_modpath("allores_azurite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_azurite:Azurite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_azurite:allores2 1",
	recipe = "allores_azurite:Azurite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
