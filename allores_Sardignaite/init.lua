...
if minetest.get_modpath("allores_sardignaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sardignaite:Sardignaite", {
	description = S("Sardignaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sardignaite:allores2 1",
	recipe = "allores_sardignaite:Sardignaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_sardignaite:Sardignaite",
