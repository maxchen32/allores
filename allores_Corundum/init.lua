...
if minetest.get_modpath("allores_corundum") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_corundum:Corundum", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_corundum:allores2 1",
	recipe = "allores_corundum:Corundum",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
