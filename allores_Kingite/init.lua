...
if minetest.get_modpath("allores_kingite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kingite:Kingite", {
	description = S("Kingite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kingite:allores2 1",
	recipe = "allores_kingite:Kingite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
