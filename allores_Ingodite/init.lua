...
if minetest.get_modpath("allores_ingodite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ingodite:Ingodite", {
	description = S("Ingodite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ingodite:allores2 1",
	recipe = "allores_ingodite:Ingodite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
