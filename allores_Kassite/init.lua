...
if minetest.get_modpath("allores_kassite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kassite:Kassite", {
	description = S("Kassite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kassite:allores2 1",
	recipe = "allores_kassite:Kassite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
