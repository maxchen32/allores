...
if minetest.get_modpath("allores_volkovskite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_volkovskite:Volkovskite", {
	description = S("Volkovskite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_volkovskite:allores2 1",
	recipe = "allores_volkovskite:Volkovskite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_volkovskite:Volkovskite",
