...
if minetest.get_modpath("allores_hubeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hubeite:Hubeite", {
	description = S("Hubeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hubeite:allores2 1",
	recipe = "allores_hubeite:Hubeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
