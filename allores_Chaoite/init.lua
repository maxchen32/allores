...
if minetest.get_modpath("allores_chaoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chaoite:Chaoite", {
	description = S("Chaoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chaoite:allores2 1",
	recipe = "allores_chaoite:Chaoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
