...
if minetest.get_modpath("allores_saamite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_saamite:Saamite", {
	description = S("Saamite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_saamite:allores2 1",
	recipe = "allores_saamite:Saamite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
