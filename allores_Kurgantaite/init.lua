...
if minetest.get_modpath("allores_kurgantaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kurgantaite:Kurgantaite", {
	description = S("Kurgantaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kurgantaite:allores2 1",
	recipe = "allores_kurgantaite:Kurgantaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kurgantaite:Kurgantaite",
