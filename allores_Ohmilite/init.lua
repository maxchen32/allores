...
if minetest.get_modpath("allores_ohmilite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ohmilite:Ohmilite", {
	description = S("Ohmilite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ohmilite:allores2 1",
	recipe = "allores_ohmilite:Ohmilite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
