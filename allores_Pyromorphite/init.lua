allores_pyromorphite = {}
local S = minetest.get_translator(minetest.get_current_modname())

if minetest.get_modpath("allores_pyromorphite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pyromorphite:Pyromorphite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pyromorphite:allores2 1",
	recipe = "allores_pyromorphite:Pyromorphite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_pyromorphite:Pyromorphite",
