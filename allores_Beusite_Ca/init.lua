...
if minetest.get_modpath("allores_beusite_ca") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_beusite_ca:Beusite_Ca", {
	description = S("Beusite_Ca") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_beusite_ca:allores2 1",
	recipe = "allores_beusite_ca:Beusite_Ca",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_beusite_ca:Beusite_Ca",
