...
if minetest.get_modpath("allores_aluminium") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_aluminium:Aluminium", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_aluminium:allores2 1",
	recipe = "allores_aluminium:Aluminium",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_aluminium:Aluminium",
