...
if minetest.get_modpath("allores_nolanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nolanite:Nolanite", {
	description = S("Nolanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nolanite:allores2 1",
	recipe = "allores_nolanite:Nolanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
