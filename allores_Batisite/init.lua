...
if minetest.get_modpath("allores_batisite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_batisite:Batisite", {
	description = S("Batisite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_batisite:allores2 1",
	recipe = "allores_batisite:Batisite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
