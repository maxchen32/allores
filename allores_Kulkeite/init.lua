...
if minetest.get_modpath("allores_kulkeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kulkeite:Kulkeite", {
	description = S("Kulkeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kulkeite:allores2 1",
	recipe = "allores_kulkeite:Kulkeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
