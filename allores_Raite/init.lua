...
if minetest.get_modpath("allores_raite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_raite:Raite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_raite:allores2 1",
	recipe = "allores_raite:Raite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
