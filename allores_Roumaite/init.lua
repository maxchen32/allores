...
if minetest.get_modpath("allores_roumaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_roumaite:Roumaite", {
	description = S("Roumaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_roumaite:allores2 1",
	recipe = "allores_roumaite:Roumaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
