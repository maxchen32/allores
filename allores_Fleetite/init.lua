...
if minetest.get_modpath("allores_fleetite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fleetite:Fleetite", {
	description = S("Fleetite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fleetite:allores2 1",
	recipe = "allores_fleetite:Fleetite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
