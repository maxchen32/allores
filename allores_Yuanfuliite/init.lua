...
if minetest.get_modpath("allores_yuanfuliite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_yuanfuliite:Yuanfuliite", {
	description = S("Yuanfuliite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_yuanfuliite:allores2 1",
	recipe = "allores_yuanfuliite:Yuanfuliite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_yuanfuliite:Yuanfuliite",
