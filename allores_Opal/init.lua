...
if minetest.get_modpath("allores_opal") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_opal:Opal", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_opal:allores2 1",
	recipe = "allores_opal:Opal",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
