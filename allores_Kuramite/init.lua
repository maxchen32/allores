...
if minetest.get_modpath("allores_kuramite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kuramite:Kuramite", {
	description = S("Kuramite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kuramite:allores2 1",
	recipe = "allores_kuramite:Kuramite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
