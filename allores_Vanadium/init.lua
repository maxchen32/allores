...
if minetest.get_modpath("allores_vanadium") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vanadium:Vanadium", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vanadium:allores2 1",
	recipe = "allores_vanadium:Vanadium",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
