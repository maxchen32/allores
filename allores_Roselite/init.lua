...
if minetest.get_modpath("allores_roselite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_roselite:Roselite", {
	description = S("Roselite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_roselite:allores2 1",
	recipe = "allores_roselite:Roselite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
