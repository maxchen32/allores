...
if minetest.get_modpath("allores_amesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_amesite:Amesite", {
	description = S("Amesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_amesite:allores2 1",
	recipe = "allores_amesite:Amesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
