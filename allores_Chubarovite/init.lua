...
if minetest.get_modpath("allores_chubarovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chubarovite:Chubarovite", {
	description = S("Chubarovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chubarovite:allores2 1",
	recipe = "allores_chubarovite:Chubarovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chubarovite:Chubarovite",
