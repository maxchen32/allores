...
if minetest.get_modpath("allores_lead") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lead:Lead", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lead:allores2 1",
	recipe = "allores_lead:Lead",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
