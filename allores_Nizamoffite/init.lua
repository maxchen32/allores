...
if minetest.get_modpath("allores_nizamoffite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nizamoffite:Nizamoffite", {
	description = S("Nizamoffite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nizamoffite:allores2 1",
	recipe = "allores_nizamoffite:Nizamoffite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_nizamoffite:Nizamoffite",
