...
if minetest.get_modpath("allores_alvanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_alvanite:Alvanite", {
	description = S("Alvanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_alvanite:allores2 1",
	recipe = "allores_alvanite:Alvanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
