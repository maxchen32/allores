...
if minetest.get_modpath("allores_yagiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_yagiite:Yagiite", {
	description = S("Yagiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_yagiite:allores2 1",
	recipe = "allores_yagiite:Yagiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
