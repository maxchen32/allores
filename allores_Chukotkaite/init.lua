...
if minetest.get_modpath("allores_chukotkaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chukotkaite:Chukotkaite", {
	description = S("Chukotkaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chukotkaite:allores2 1",
	recipe = "allores_chukotkaite:Chukotkaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chukotkaite:Chukotkaite",
