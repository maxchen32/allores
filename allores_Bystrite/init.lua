...
if minetest.get_modpath("allores_bystrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bystrite:Bystrite", {
	description = S("Bystrite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bystrite:allores2 1",
	recipe = "allores_bystrite:Bystrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
