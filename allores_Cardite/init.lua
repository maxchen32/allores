...
if minetest.get_modpath("allores_cardite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cardite:Cardite", {
	description = S("Cardite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cardite:allores2 1",
	recipe = "allores_cardite:Cardite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
