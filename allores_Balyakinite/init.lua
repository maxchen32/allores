...
if minetest.get_modpath("allores_balyakinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_balyakinite:Balyakinite", {
	description = S("Balyakinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_balyakinite:allores2 1",
	recipe = "allores_balyakinite:Balyakinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_balyakinite:Balyakinite",
