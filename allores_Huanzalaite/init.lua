...
if minetest.get_modpath("allores_huanzalaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_huanzalaite:Huanzalaite", {
	description = S("Huanzalaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_huanzalaite:allores2 1",
	recipe = "allores_huanzalaite:Huanzalaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_huanzalaite:Huanzalaite",
