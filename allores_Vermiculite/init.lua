...
if minetest.get_modpath("allores_vermiculite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vermiculite:Vermiculite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vermiculite:allores2 1",
	recipe = "allores_vermiculite:Vermiculite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_vermiculite:Vermiculite",
