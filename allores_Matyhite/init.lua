...
if minetest.get_modpath("allores_matyhite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_matyhite:Matyhite", {
	description = S("Matyhite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_matyhite:allores2 1",
	recipe = "allores_matyhite:Matyhite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
