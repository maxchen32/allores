...
if minetest.get_modpath("allores_sborgite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sborgite:Sborgite", {
	description = S("Sborgite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sborgite:allores2 1",
	recipe = "allores_sborgite:Sborgite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
