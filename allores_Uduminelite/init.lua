...
if minetest.get_modpath("allores_uduminelite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_uduminelite:Uduminelite", {
	description = S("Uduminelite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_uduminelite:allores2 1",
	recipe = "allores_uduminelite:Uduminelite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_uduminelite:Uduminelite",
