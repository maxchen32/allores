...
if minetest.get_modpath("allores_ericssonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ericssonite:Ericssonite", {
	description = S("Ericssonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ericssonite:allores2 1",
	recipe = "allores_ericssonite:Ericssonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ericssonite:Ericssonite",
