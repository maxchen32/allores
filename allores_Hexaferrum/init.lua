...
if minetest.get_modpath("allores_hexaferrum") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hexaferrum:Hexaferrum", {
	description = S("Hexaferrum") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hexaferrum:allores2 1",
	recipe = "allores_hexaferrum:Hexaferrum",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hexaferrum:Hexaferrum",
