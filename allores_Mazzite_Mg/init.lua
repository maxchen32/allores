...
if minetest.get_modpath("allores_mazzite_mg") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mazzite_mg:Mazzite_Mg", {
	description = S("Mazzite_Mg") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mazzite_mg:allores2 1",
	recipe = "allores_mazzite_mg:Mazzite_Mg",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_mazzite_mg:Mazzite_Mg",
