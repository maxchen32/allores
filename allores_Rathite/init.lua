...
if minetest.get_modpath("allores_rathite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rathite:Rathite", {
	description = S("Rathite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rathite:allores2 1",
	recipe = "allores_rathite:Rathite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
