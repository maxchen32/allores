...
if minetest.get_modpath("allores_quadruphite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_quadruphite:Quadruphite", {
	description = S("Quadruphite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_quadruphite:allores2 1",
	recipe = "allores_quadruphite:Quadruphite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_quadruphite:Quadruphite",
