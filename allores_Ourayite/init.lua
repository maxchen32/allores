...
if minetest.get_modpath("allores_ourayite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ourayite:Ourayite", {
	description = S("Ourayite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ourayite:allores2 1",
	recipe = "allores_ourayite:Ourayite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
