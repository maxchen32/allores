...
if minetest.get_modpath("allores_ziesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ziesite:Ziesite", {
	description = S("Ziesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ziesite:allores2 1",
	recipe = "allores_ziesite:Ziesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
