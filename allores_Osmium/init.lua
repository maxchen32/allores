...
if minetest.get_modpath("allores_osmium") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_osmium:Osmium", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_osmium:allores2 1",
	recipe = "allores_osmium:Osmium",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
