...
if minetest.get_modpath("allores_helvine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_helvine:Helvine", {
	description = S("Helvine") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_helvine:allores2 1",
	recipe = "allores_helvine:Helvine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
