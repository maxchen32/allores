...
if minetest.get_modpath("allores_takeuchiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_takeuchiite:Takeuchiite", {
	description = S("Takeuchiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_takeuchiite:allores2 1",
	recipe = "allores_takeuchiite:Takeuchiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_takeuchiite:Takeuchiite",
