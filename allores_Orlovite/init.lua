...
if minetest.get_modpath("allores_orlovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_orlovite:Orlovite", {
	description = S("Orlovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_orlovite:allores2 1",
	recipe = "allores_orlovite:Orlovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
