...
if minetest.get_modpath("allores_kuksite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kuksite:Kuksite", {
	description = S("Kuksite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kuksite:allores2 1",
	recipe = "allores_kuksite:Kuksite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
