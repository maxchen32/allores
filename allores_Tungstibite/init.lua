...
if minetest.get_modpath("allores_tungstibite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tungstibite:Tungstibite", {
	description = S("Tungstibite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tungstibite:allores2 1",
	recipe = "allores_tungstibite:Tungstibite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_tungstibite:Tungstibite",
