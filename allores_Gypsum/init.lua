...
if minetest.get_modpath("allores_gypsum") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gypsum:Gypsum", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gypsum:allores2 1",
	recipe = "allores_gypsum:Gypsum",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
