...
if minetest.get_modpath("allores_nierite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nierite:Nierite", {
	description = S("Nierite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nierite:allores2 1",
	recipe = "allores_nierite:Nierite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
