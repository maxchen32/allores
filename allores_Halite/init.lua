...
if minetest.get_modpath("allores_halite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_halite:Halite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_halite:allores2 1",
	recipe = "allores_halite:Halite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
