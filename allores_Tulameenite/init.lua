...
if minetest.get_modpath("allores_tulameenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tulameenite:Tulameenite", {
	description = S("Tulameenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tulameenite:allores2 1",
	recipe = "allores_tulameenite:Tulameenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_tulameenite:Tulameenite",
