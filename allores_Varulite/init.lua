...
if minetest.get_modpath("allores_varulite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_varulite:Varulite", {
	description = S("Varulite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_varulite:allores2 1",
	recipe = "allores_varulite:Varulite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
