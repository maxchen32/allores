...
if minetest.get_modpath("allores_chromium") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chromium:Chromium", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chromium:allores2 1",
	recipe = "allores_chromium:Chromium",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
