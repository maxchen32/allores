...
if minetest.get_modpath("allores_nepheline") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nepheline:Nepheline", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nepheline:allores2 1",
	recipe = "allores_nepheline:Nepheline",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_nepheline:Nepheline",
