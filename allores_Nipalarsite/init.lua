...
if minetest.get_modpath("allores_nipalarsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nipalarsite:Nipalarsite", {
	description = S("Nipalarsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nipalarsite:allores2 1",
	recipe = "allores_nipalarsite:Nipalarsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_nipalarsite:Nipalarsite",
