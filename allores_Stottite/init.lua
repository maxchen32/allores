...
if minetest.get_modpath("allores_stottite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_stottite:Stottite", {
	description = S("Stottite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_stottite:allores2 1",
	recipe = "allores_stottite:Stottite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
