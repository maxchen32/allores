...
if minetest.get_modpath("allores_kapellasite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kapellasite:Kapellasite", {
	description = S("Kapellasite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kapellasite:allores2 1",
	recipe = "allores_kapellasite:Kapellasite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kapellasite:Kapellasite",
