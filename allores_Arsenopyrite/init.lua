allores_arsenopyrite = {}
local S = minetest.get_translator(minetest.get_current_modname())

if minetest.get_modpath("allores_arsenopyrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_arsenopyrite:Arsenopyrite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_arsenopyrite:allores2 1",
	recipe = "allores_arsenopyrite:Arsenopyrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_arsenopyrite:Arsenopyrite",
