...
if minetest.get_modpath("allores_artinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_artinite:Artinite", {
	description = S("Artinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_artinite:allores2 1",
	recipe = "allores_artinite:Artinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
