...
if minetest.get_modpath("allores_khorixasite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_khorixasite:Khorixasite", {
	description = S("Khorixasite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_khorixasite:allores2 1",
	recipe = "allores_khorixasite:Khorixasite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_khorixasite:Khorixasite",
