...
if minetest.get_modpath("allores_pellyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pellyite:Pellyite", {
	description = S("Pellyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pellyite:allores2 1",
	recipe = "allores_pellyite:Pellyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
