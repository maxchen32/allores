...
if minetest.get_modpath("allores_cymrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cymrite:Cymrite", {
	description = S("Cymrite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cymrite:allores2 1",
	recipe = "allores_cymrite:Cymrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
