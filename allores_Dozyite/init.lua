...
if minetest.get_modpath("allores_dozyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dozyite:Dozyite", {
	description = S("Dozyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dozyite:allores2 1",
	recipe = "allores_dozyite:Dozyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
