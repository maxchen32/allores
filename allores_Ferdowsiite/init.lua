...
if minetest.get_modpath("allores_ferdowsiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ferdowsiite:Ferdowsiite", {
	description = S("Ferdowsiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ferdowsiite:allores2 1",
	recipe = "allores_ferdowsiite:Ferdowsiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ferdowsiite:Ferdowsiite",
