...
if minetest.get_modpath("allores_hopeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hopeite:Hopeite", {
	description = S("Hopeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hopeite:allores2 1",
	recipe = "allores_hopeite:Hopeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
