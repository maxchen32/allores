...
if minetest.get_modpath("allores_tibiscumite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tibiscumite:Tibiscumite", {
	description = S("Tibiscumite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tibiscumite:allores2 1",
	recipe = "allores_tibiscumite:Tibiscumite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_tibiscumite:Tibiscumite",
