...
if minetest.get_modpath("allores_stannite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_stannite:Stannite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_stannite:allores2 1",
	recipe = "allores_stannite:Stannite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
