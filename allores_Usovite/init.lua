...
if minetest.get_modpath("allores_usovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_usovite:Usovite", {
	description = S("Usovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_usovite:allores2 1",
	recipe = "allores_usovite:Usovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
