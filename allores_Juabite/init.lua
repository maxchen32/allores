...
if minetest.get_modpath("allores_juabite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_juabite:Juabite", {
	description = S("Juabite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_juabite:allores2 1",
	recipe = "allores_juabite:Juabite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
