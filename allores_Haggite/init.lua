...
if minetest.get_modpath("allores_haggite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_haggite:Haggite", {
	description = S("Haggite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_haggite:allores2 1",
	recipe = "allores_haggite:Haggite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
