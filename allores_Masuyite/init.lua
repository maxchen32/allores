...
if minetest.get_modpath("allores_masuyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_masuyite:Masuyite", {
	description = S("Masuyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_masuyite:allores2 1",
	recipe = "allores_masuyite:Masuyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
