...
if minetest.get_modpath("allores_rauchite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rauchite:Rauchite", {
	description = S("Rauchite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rauchite:allores2 1",
	recipe = "allores_rauchite:Rauchite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
