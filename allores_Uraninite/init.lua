...
if minetest.get_modpath("allores_uraninite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_uraninite:Uraninite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_uraninite:allores2 1",
	recipe = "allores_uraninite:Uraninite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_uraninite:Uraninite",
