...
if minetest.get_modpath("allores_sorbyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sorbyite:Sorbyite", {
	description = S("Sorbyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sorbyite:allores2 1",
	recipe = "allores_sorbyite:Sorbyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
