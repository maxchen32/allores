...
if minetest.get_modpath("allores_tokyoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tokyoite:Tokyoite", {
	description = S("Tokyoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tokyoite:allores2 1",
	recipe = "allores_tokyoite:Tokyoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
