...
if minetest.get_modpath("allores_jarlite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jarlite:Jarlite", {
	description = S("Jarlite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jarlite:allores2 1",
	recipe = "allores_jarlite:Jarlite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
