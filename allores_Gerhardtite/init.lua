...
if minetest.get_modpath("allores_gerhardtite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gerhardtite:Gerhardtite", {
	description = S("Gerhardtite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gerhardtite:allores2 1",
	recipe = "allores_gerhardtite:Gerhardtite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_gerhardtite:Gerhardtite",
