...
if minetest.get_modpath("allores_novakite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_novakite:Novakite", {
	description = S("Novakite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_novakite:allores2 1",
	recipe = "allores_novakite:Novakite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
