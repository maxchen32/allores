...
if minetest.get_modpath("allores_klajite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_klajite:Klajite", {
	description = S("Klajite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_klajite:allores2 1",
	recipe = "allores_klajite:Klajite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
