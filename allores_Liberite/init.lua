...
if minetest.get_modpath("allores_liberite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_liberite:Liberite", {
	description = S("Liberite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_liberite:allores2 1",
	recipe = "allores_liberite:Liberite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
