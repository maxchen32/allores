...
if minetest.get_modpath("allores_digenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_digenite:Digenite", {
	description = S("Digenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_digenite:allores2 1",
	recipe = "allores_digenite:Digenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
