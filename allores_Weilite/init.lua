...
if minetest.get_modpath("allores_weilite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_weilite:Weilite", {
	description = S("Weilite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_weilite:allores2 1",
	recipe = "allores_weilite:Weilite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
