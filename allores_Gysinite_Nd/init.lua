...
if minetest.get_modpath("allores_gysinite_nd") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gysinite_nd:Gysinite_Nd", {
	description = S("Gysinite_Nd") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gysinite_nd:allores2 1",
	recipe = "allores_gysinite_nd:Gysinite_Nd",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_gysinite_nd:Gysinite_Nd",
