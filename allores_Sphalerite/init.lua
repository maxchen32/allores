...
if minetest.get_modpath("allores_sphalerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sphalerite:Sphalerite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sphalerite:allores2 1",
	recipe = "allores_sphalerite:Sphalerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_sphalerite:Sphalerite",
