...
if minetest.get_modpath("allores_oldsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_oldsite:Oldsite", {
	description = S("Oldsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_oldsite:allores2 1",
	recipe = "allores_oldsite:Oldsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
