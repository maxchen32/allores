...
if minetest.get_modpath("allores_turanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_turanite:Turanite", {
	description = S("Turanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_turanite:allores2 1",
	recipe = "allores_turanite:Turanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
