...
if minetest.get_modpath("allores_leadamalgam") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_leadamalgam:Leadamalgam", {
	description = S("Leadamalgam") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_leadamalgam:allores2 1",
	recipe = "allores_leadamalgam:Leadamalgam",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_leadamalgam:Leadamalgam",
