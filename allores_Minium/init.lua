...
if minetest.get_modpath("allores_minium") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_minium:Minium", {
	description = S("Minium") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_minium:allores2 1",
	recipe = "allores_minium:Minium",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
