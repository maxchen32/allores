...
if minetest.get_modpath("allores_suanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_suanite:Suanite", {
	description = S("Suanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_suanite:allores2 1",
	recipe = "allores_suanite:Suanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
