...
if minetest.get_modpath("allores_eugenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_eugenite:Eugenite", {
	description = S("Eugenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_eugenite:allores2 1",
	recipe = "allores_eugenite:Eugenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
