...
if minetest.get_modpath("allores_bohuslavite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bohuslavite:Bohuslavite", {
	description = S("Bohuslavite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bohuslavite:allores2 1",
	recipe = "allores_bohuslavite:Bohuslavite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bohuslavite:Bohuslavite",
