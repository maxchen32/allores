...
if minetest.get_modpath("allores_heneuite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_heneuite:Heneuite", {
	description = S("Heneuite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_heneuite:allores2 1",
	recipe = "allores_heneuite:Heneuite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
