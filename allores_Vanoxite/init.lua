...
if minetest.get_modpath("allores_vanoxite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vanoxite:Vanoxite", {
	description = S("Vanoxite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vanoxite:allores2 1",
	recipe = "allores_vanoxite:Vanoxite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
