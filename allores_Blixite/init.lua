...
if minetest.get_modpath("allores_blixite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_blixite:Blixite", {
	description = S("Blixite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_blixite:allores2 1",
	recipe = "allores_blixite:Blixite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
