...
if minetest.get_modpath("allores_shigaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_shigaite:Shigaite", {
	description = S("Shigaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_shigaite:allores2 1",
	recipe = "allores_shigaite:Shigaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
