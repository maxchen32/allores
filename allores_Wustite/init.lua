...
if minetest.get_modpath("allores_wustite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wustite:Wustite", {
	description = S("Wustite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wustite:allores2 1",
	recipe = "allores_wustite:Wustite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
