...
if minetest.get_modpath("allores_giorgiosite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_giorgiosite:Giorgiosite", {
	description = S("Giorgiosite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_giorgiosite:allores2 1",
	recipe = "allores_giorgiosite:Giorgiosite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_giorgiosite:Giorgiosite",
