...
if minetest.get_modpath("allores_usturite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_usturite:Usturite", {
	description = S("Usturite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_usturite:allores2 1",
	recipe = "allores_usturite:Usturite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
