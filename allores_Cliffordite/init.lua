...
if minetest.get_modpath("allores_cliffordite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cliffordite:Cliffordite", {
	description = S("Cliffordite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cliffordite:allores2 1",
	recipe = "allores_cliffordite:Cliffordite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_cliffordite:Cliffordite",
