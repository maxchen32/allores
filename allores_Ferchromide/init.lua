...
if minetest.get_modpath("allores_ferchromide") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ferchromide:Ferchromide", {
	description = S("Ferchromide") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ferchromide:allores2 1",
	recipe = "allores_ferchromide:Ferchromide",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ferchromide:Ferchromide",
