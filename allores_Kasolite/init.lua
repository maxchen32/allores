...
if minetest.get_modpath("allores_kasolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kasolite:Kasolite", {
	description = S("Kasolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kasolite:allores2 1",
	recipe = "allores_kasolite:Kasolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
