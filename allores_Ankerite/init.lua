...
if minetest.get_modpath("allores_ankerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ankerite:Ankerite", {
	description = S("Ankerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ankerite:allores2 1",
	recipe = "allores_ankerite:Ankerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
