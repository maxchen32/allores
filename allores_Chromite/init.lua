...
if minetest.get_modpath("allores_chromite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chromite:Chromite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chromite:allores2 1",
	recipe = "allores_chromite:Chromite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
