...
if minetest.get_modpath("allores_freedite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_freedite:Freedite", {
	description = S("Freedite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_freedite:allores2 1",
	recipe = "allores_freedite:Freedite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
