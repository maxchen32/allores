...
if minetest.get_modpath("allores_wyartiteii") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wyartiteii:WyartiteII", {
	description = S("WyartiteII") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wyartiteii:allores2 1",
	recipe = "allores_wyartiteii:WyartiteII",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_wyartiteii:WyartiteII",
