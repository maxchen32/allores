...
if minetest.get_modpath("allores_wittite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wittite:Wittite", {
	description = S("Wittite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wittite:allores2 1",
	recipe = "allores_wittite:Wittite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
