...
if minetest.get_modpath("allores_pisekite_y") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pisekite_y:Pisekite_Y", {
	description = S("Pisekite_Y") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pisekite_y:allores2 1",
	recipe = "allores_pisekite_y:Pisekite_Y",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_pisekite_y:Pisekite_Y",
