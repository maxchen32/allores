...
if minetest.get_modpath("allores_celestine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_celestine:Celestine", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_celestine:allores2 1",
	recipe = "allores_celestine:Celestine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_celestine:Celestine",
