...
if minetest.get_modpath("allores_bityite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bityite:Bityite", {
	description = S("Bityite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bityite:allores2 1",
	recipe = "allores_bityite:Bityite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
