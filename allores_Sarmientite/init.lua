...
if minetest.get_modpath("allores_sarmientite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sarmientite:Sarmientite", {
	description = S("Sarmientite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sarmientite:allores2 1",
	recipe = "allores_sarmientite:Sarmientite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_sarmientite:Sarmientite",
