...
if minetest.get_modpath("allores_iridium") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_iridium:Iridium", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_iridium:allores2 1",
	recipe = "allores_iridium:Iridium",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
