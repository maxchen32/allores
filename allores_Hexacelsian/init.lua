...
if minetest.get_modpath("allores_hexacelsian") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hexacelsian:Hexacelsian", {
	description = S("Hexacelsian") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hexacelsian:allores2 1",
	recipe = "allores_hexacelsian:Hexacelsian",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hexacelsian:Hexacelsian",
