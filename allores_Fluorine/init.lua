...
if minetest.get_modpath("allores_fluorine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fluorine:Fluorine", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fluorine:allores2 1",
	recipe = "allores_fluorine:Fluorine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
