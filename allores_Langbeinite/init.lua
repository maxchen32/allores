...
if minetest.get_modpath("allores_langbeinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_langbeinite:Langbeinite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_langbeinite:allores2 1",
	recipe = "allores_langbeinite:Langbeinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_langbeinite:Langbeinite",
