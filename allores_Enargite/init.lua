...
if minetest.get_modpath("allores_enargite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_enargite:Enargite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_enargite:allores2 1",
	recipe = "allores_enargite:Enargite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
