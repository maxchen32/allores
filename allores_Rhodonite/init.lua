...
if minetest.get_modpath("allores_rhodonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rhodonite:Rhodonite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rhodonite:allores2 1",
	recipe = "allores_rhodonite:Rhodonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_rhodonite:Rhodonite",
