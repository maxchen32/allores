allores_polylithionite = {}
local S = minetest.get_translator(minetest.get_current_modname())

if minetest.get_modpath("allores_polylithionite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_polylithionite:Polylithionite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_polylithionite:allores2 1",
	recipe = "allores_polylithionite:Polylithionite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_polylithionite:Polylithionite",
