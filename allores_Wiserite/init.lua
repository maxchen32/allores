...
if minetest.get_modpath("allores_wiserite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wiserite:Wiserite", {
	description = S("Wiserite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wiserite:allores2 1",
	recipe = "allores_wiserite:Wiserite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
