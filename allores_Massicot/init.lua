...
if minetest.get_modpath("allores_massicot") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_massicot:Massicot", {
	description = S("Massicot") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_massicot:allores2 1",
	recipe = "allores_massicot:Massicot",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
