...
if minetest.get_modpath("allores_jeppeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jeppeite:Jeppeite", {
	description = S("Jeppeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jeppeite:allores2 1",
	recipe = "allores_jeppeite:Jeppeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
