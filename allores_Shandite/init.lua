...
if minetest.get_modpath("allores_shandite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_shandite:Shandite", {
	description = S("Shandite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_shandite:allores2 1",
	recipe = "allores_shandite:Shandite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
