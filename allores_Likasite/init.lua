...
if minetest.get_modpath("allores_likasite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_likasite:Likasite", {
	description = S("Likasite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_likasite:allores2 1",
	recipe = "allores_likasite:Likasite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
