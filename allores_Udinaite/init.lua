...
if minetest.get_modpath("allores_udinaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_udinaite:Udinaite", {
	description = S("Udinaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_udinaite:allores2 1",
	recipe = "allores_udinaite:Udinaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
