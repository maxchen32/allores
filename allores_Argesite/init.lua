...
if minetest.get_modpath("allores_argesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_argesite:Argesite", {
	description = S("Argesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_argesite:allores2 1",
	recipe = "allores_argesite:Argesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
