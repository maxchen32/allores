...
if minetest.get_modpath("allores_ramosite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ramosite:Ramosite", {
	description = S("Ramosite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ramosite:allores2 1",
	recipe = "allores_ramosite:Ramosite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
