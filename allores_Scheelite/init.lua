...
if minetest.get_modpath("allores_scheelite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_scheelite:Scheelite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_scheelite:allores2 1",
	recipe = "allores_scheelite:Scheelite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_scheelite:Scheelite",
