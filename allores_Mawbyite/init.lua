...
if minetest.get_modpath("allores_mawbyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mawbyite:Mawbyite", {
	description = S("Mawbyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mawbyite:allores2 1",
	recipe = "allores_mawbyite:Mawbyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
