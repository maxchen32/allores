...
if minetest.get_modpath("allores_teineite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_teineite:Teineite", {
	description = S("Teineite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_teineite:allores2 1",
	recipe = "allores_teineite:Teineite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
