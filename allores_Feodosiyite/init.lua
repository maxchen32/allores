...
if minetest.get_modpath("allores_feodosiyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_feodosiyite:Feodosiyite", {
	description = S("Feodosiyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_feodosiyite:allores2 1",
	recipe = "allores_feodosiyite:Feodosiyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_feodosiyite:Feodosiyite",
