...
if minetest.get_modpath("allores_finnemanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_finnemanite:Finnemanite", {
	description = S("Finnemanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_finnemanite:allores2 1",
	recipe = "allores_finnemanite:Finnemanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_finnemanite:Finnemanite",
