...
if minetest.get_modpath("allores_claraite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_claraite:Claraite", {
	description = S("Claraite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_claraite:allores2 1",
	recipe = "allores_claraite:Claraite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
