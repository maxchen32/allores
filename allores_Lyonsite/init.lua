...
if minetest.get_modpath("allores_lyonsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lyonsite:Lyonsite", {
	description = S("Lyonsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lyonsite:allores2 1",
	recipe = "allores_lyonsite:Lyonsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
