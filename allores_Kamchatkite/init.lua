...
if minetest.get_modpath("allores_kamchatkite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kamchatkite:Kamchatkite", {
	description = S("Kamchatkite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kamchatkite:allores2 1",
	recipe = "allores_kamchatkite:Kamchatkite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kamchatkite:Kamchatkite",
