...
if minetest.get_modpath("allores_goldamalgam") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_goldamalgam:Goldamalgam", {
	description = S("Goldamalgam") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_goldamalgam:allores2 1",
	recipe = "allores_goldamalgam:Goldamalgam",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_goldamalgam:Goldamalgam",
