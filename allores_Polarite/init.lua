...
if minetest.get_modpath("allores_polarite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_polarite:Polarite", {
	description = S("Polarite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_polarite:allores2 1",
	recipe = "allores_polarite:Polarite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
