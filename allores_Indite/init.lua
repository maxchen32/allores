...
if minetest.get_modpath("allores_indite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_indite:Indite", {
	description = S("Indite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_indite:allores2 1",
	recipe = "allores_indite:Indite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
