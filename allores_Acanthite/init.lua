...
if minetest.get_modpath("allores_acanthite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_acanthite:Acanthite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_acanthite:allores2 1",
	recipe = "allores_acanthite:Acanthite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_acanthite:Acanthite",
