...
if minetest.get_modpath("allores_aerugite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_aerugite:Aerugite", {
	description = S("Aerugite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_aerugite:allores2 1",
	recipe = "allores_aerugite:Aerugite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
