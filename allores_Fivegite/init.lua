...
if minetest.get_modpath("allores_fivegite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fivegite:Fivegite", {
	description = S("Fivegite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fivegite:allores2 1",
	recipe = "allores_fivegite:Fivegite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
