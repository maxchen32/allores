...
if minetest.get_modpath("allores_painite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_painite:Painite", {
	description = S("Painite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_painite:allores2 1",
	recipe = "allores_painite:Painite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
