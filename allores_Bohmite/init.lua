...
if minetest.get_modpath("allores_bohmite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bohmite:Bohmite", {
	description = S("Bohmite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bohmite:allores2 1",
	recipe = "allores_bohmite:Bohmite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
