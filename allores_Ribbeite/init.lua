...
if minetest.get_modpath("allores_ribbeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ribbeite:Ribbeite", {
	description = S("Ribbeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ribbeite:allores2 1",
	recipe = "allores_ribbeite:Ribbeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
