...
if minetest.get_modpath("allores_grimmite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_grimmite:Grimmite", {
	description = S("Grimmite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_grimmite:allores2 1",
	recipe = "allores_grimmite:Grimmite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
