...
if minetest.get_modpath("allores_rohaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rohaite:Rohaite", {
	description = S("Rohaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rohaite:allores2 1",
	recipe = "allores_rohaite:Rohaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
