...
if minetest.get_modpath("allores_foitite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_foitite:Foitite", {
	description = S("Foitite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_foitite:allores2 1",
	recipe = "allores_foitite:Foitite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
