...
if minetest.get_modpath("allores_voronkovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_voronkovite:Voronkovite", {
	description = S("Voronkovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_voronkovite:allores2 1",
	recipe = "allores_voronkovite:Voronkovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_voronkovite:Voronkovite",
