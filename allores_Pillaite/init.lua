...
if minetest.get_modpath("allores_pillaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pillaite:Pillaite", {
	description = S("Pillaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pillaite:allores2 1",
	recipe = "allores_pillaite:Pillaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
