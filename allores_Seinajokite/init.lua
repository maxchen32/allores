...
if minetest.get_modpath("allores_seinajokite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_seinajokite:Seinajokite", {
	description = S("Seinajokite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_seinajokite:allores2 1",
	recipe = "allores_seinajokite:Seinajokite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_seinajokite:Seinajokite",
