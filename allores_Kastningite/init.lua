...
if minetest.get_modpath("allores_kastningite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kastningite:Kastningite", {
	description = S("Kastningite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kastningite:allores2 1",
	recipe = "allores_kastningite:Kastningite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kastningite:Kastningite",
