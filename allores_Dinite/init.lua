...
if minetest.get_modpath("allores_dinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dinite:Dinite", {
	description = S("Dinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dinite:allores2 1",
	recipe = "allores_dinite:Dinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
