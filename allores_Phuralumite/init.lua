...
if minetest.get_modpath("allores_phuralumite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_phuralumite:Phuralumite", {
	description = S("Phuralumite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_phuralumite:allores2 1",
	recipe = "allores_phuralumite:Phuralumite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_phuralumite:Phuralumite",
