...
if minetest.get_modpath("allores_davisite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_davisite:Davisite", {
	description = S("Davisite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_davisite:allores2 1",
	recipe = "allores_davisite:Davisite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
