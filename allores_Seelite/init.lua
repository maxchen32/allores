...
if minetest.get_modpath("allores_seelite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_seelite:Seelite", {
	description = S("Seelite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_seelite:allores2 1",
	recipe = "allores_seelite:Seelite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
