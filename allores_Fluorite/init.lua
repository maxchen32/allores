...
if minetest.get_modpath("allores_fluorite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fluorite:Fluorite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fluorite:allores2 1",
	recipe = "allores_fluorite:Fluorite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
