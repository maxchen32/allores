...
if minetest.get_modpath("allores_hausmannite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hausmannite:Hausmannite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hausmannite:allores2 1",
	recipe = "allores_hausmannite:Hausmannite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hausmannite:Hausmannite",
