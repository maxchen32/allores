...
if minetest.get_modpath("allores_tuite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tuite:Tuite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tuite:allores2 1",
	recipe = "allores_tuite:Tuite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
