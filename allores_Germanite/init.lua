...
if minetest.get_modpath("allores_germanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_germanite:Germanite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_germanite:allores2 1",
	recipe = "allores_germanite:Germanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_germanite:Germanite",
