...
if minetest.get_modpath("allores_bilinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bilinite:Bilinite", {
	description = S("Bilinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bilinite:allores2 1",
	recipe = "allores_bilinite:Bilinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
