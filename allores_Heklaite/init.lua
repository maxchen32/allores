...
if minetest.get_modpath("allores_heklaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_heklaite:Heklaite", {
	description = S("Heklaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_heklaite:allores2 1",
	recipe = "allores_heklaite:Heklaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
