...
if minetest.get_modpath("allores_nepouite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nepouite:Nepouite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nepouite:allores2 1",
	recipe = "allores_nepouite:Nepouite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
