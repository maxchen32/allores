...
if minetest.get_modpath("allores_millerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_millerite:Millerite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_millerite:allores2 1",
	recipe = "allores_millerite:Millerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_millerite:Millerite",
