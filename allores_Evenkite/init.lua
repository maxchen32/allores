...
if minetest.get_modpath("allores_evenkite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_evenkite:Evenkite", {
	description = S("Evenkite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_evenkite:allores2 1",
	recipe = "allores_evenkite:Evenkite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
