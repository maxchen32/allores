...
if minetest.get_modpath("allores_tanohataite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tanohataite:Tanohataite", {
	description = S("Tanohataite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tanohataite:allores2 1",
	recipe = "allores_tanohataite:Tanohataite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_tanohataite:Tanohataite",
