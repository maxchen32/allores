...
if minetest.get_modpath("allores_magnesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_magnesite:Magnesite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_magnesite:allores2 1",
	recipe = "allores_magnesite:Magnesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_magnesite:Magnesite",
