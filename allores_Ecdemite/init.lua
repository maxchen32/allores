...
if minetest.get_modpath("allores_ecdemite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ecdemite:Ecdemite", {
	description = S("Ecdemite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ecdemite:allores2 1",
	recipe = "allores_ecdemite:Ecdemite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
