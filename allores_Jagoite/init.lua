...
if minetest.get_modpath("allores_jagoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jagoite:Jagoite", {
	description = S("Jagoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jagoite:allores2 1",
	recipe = "allores_jagoite:Jagoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
