...
if minetest.get_modpath("allores_eggletonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_eggletonite:Eggletonite", {
	description = S("Eggletonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_eggletonite:allores2 1",
	recipe = "allores_eggletonite:Eggletonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_eggletonite:Eggletonite",
