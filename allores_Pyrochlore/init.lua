...
if minetest.get_modpath("allores_pyrochlore") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pyrochlore:Pyrochlore", {
	description = S("Pyrochlore") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pyrochlore:allores2 1",
	recipe = "allores_pyrochlore:Pyrochlore",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_pyrochlore:Pyrochlore",
