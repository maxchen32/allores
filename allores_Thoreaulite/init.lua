...
if minetest.get_modpath("allores_thoreaulite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_thoreaulite:Thoreaulite", {
	description = S("Thoreaulite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_thoreaulite:allores2 1",
	recipe = "allores_thoreaulite:Thoreaulite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_thoreaulite:Thoreaulite",
