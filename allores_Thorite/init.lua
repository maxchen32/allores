...
if minetest.get_modpath("allores_thorite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_thorite:Thorite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_thorite:allores2 1",
	recipe = "allores_thorite:Thorite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
