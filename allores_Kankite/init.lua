...
if minetest.get_modpath("allores_kankite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kankite:Kankite", {
	description = S("Kankite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kankite:allores2 1",
	recipe = "allores_kankite:Kankite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
