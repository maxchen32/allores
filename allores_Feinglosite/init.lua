...
if minetest.get_modpath("allores_feinglosite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_feinglosite:Feinglosite", {
	description = S("Feinglosite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_feinglosite:allores2 1",
	recipe = "allores_feinglosite:Feinglosite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_feinglosite:Feinglosite",
