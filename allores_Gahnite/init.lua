...
if minetest.get_modpath("allores_gahnite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gahnite:Gahnite", {
	description = S("Gahnite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gahnite:allores2 1",
	recipe = "allores_gahnite:Gahnite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
