...
if minetest.get_modpath("allores_linekite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_linekite:Linekite", {
	description = S("Linekite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_linekite:allores2 1",
	recipe = "allores_linekite:Linekite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
