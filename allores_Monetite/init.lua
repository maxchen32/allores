...
if minetest.get_modpath("allores_monetite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_monetite:Monetite", {
	description = S("Monetite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_monetite:allores2 1",
	recipe = "allores_monetite:Monetite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
