...
if minetest.get_modpath("allores_zippeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zippeite:Zippeite", {
	description = S("Zippeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zippeite:allores2 1",
	recipe = "allores_zippeite:Zippeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
