...
if minetest.get_modpath("allores_simonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_simonite:Simonite", {
	description = S("Simonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_simonite:allores2 1",
	recipe = "allores_simonite:Simonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
