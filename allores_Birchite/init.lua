...
if minetest.get_modpath("allores_birchite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_birchite:Birchite", {
	description = S("Birchite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_birchite:allores2 1",
	recipe = "allores_birchite:Birchite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
