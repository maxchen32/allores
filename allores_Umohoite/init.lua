...
if minetest.get_modpath("allores_umohoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_umohoite:Umohoite", {
	description = S("Umohoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_umohoite:allores2 1",
	recipe = "allores_umohoite:Umohoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
