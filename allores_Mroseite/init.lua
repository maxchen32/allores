...
if minetest.get_modpath("allores_mroseite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mroseite:Mroseite", {
	description = S("Mroseite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mroseite:allores2 1",
	recipe = "allores_mroseite:Mroseite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
