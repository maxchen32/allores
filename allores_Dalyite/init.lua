...
if minetest.get_modpath("allores_dalyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dalyite:Dalyite", {
	description = S("Dalyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dalyite:allores2 1",
	recipe = "allores_dalyite:Dalyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
