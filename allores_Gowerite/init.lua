...
if minetest.get_modpath("allores_gowerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gowerite:Gowerite", {
	description = S("Gowerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gowerite:allores2 1",
	recipe = "allores_gowerite:Gowerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
