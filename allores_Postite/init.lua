...
if minetest.get_modpath("allores_postite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_postite:Postite", {
	description = S("Postite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_postite:allores2 1",
	recipe = "allores_postite:Postite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
