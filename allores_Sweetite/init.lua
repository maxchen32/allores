...
if minetest.get_modpath("allores_sweetite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sweetite:Sweetite", {
	description = S("Sweetite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sweetite:allores2 1",
	recipe = "allores_sweetite:Sweetite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
