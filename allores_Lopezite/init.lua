...
if minetest.get_modpath("allores_lopezite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lopezite:Lopezite", {
	description = S("Lopezite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lopezite:allores2 1",
	recipe = "allores_lopezite:Lopezite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
