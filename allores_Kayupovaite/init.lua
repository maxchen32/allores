...
if minetest.get_modpath("allores_kayupovaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kayupovaite:Kayupovaite", {
	description = S("Kayupovaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kayupovaite:allores2 1",
	recipe = "allores_kayupovaite:Kayupovaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kayupovaite:Kayupovaite",
