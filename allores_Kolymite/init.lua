...
if minetest.get_modpath("allores_kolymite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kolymite:Kolymite", {
	description = S("Kolymite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kolymite:allores2 1",
	recipe = "allores_kolymite:Kolymite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
