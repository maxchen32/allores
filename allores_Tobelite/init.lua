...
if minetest.get_modpath("allores_tobelite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tobelite:Tobelite", {
	description = S("Tobelite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tobelite:allores2 1",
	recipe = "allores_tobelite:Tobelite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
