...
if minetest.get_modpath("allores_cyprine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cyprine:Cyprine", {
	description = S("Cyprine") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cyprine:allores2 1",
	recipe = "allores_cyprine:Cyprine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
