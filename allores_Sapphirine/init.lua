...
if minetest.get_modpath("allores_sapphirine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sapphirine:Sapphirine", {
	description = S("Sapphirine") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sapphirine:allores2 1",
	recipe = "allores_sapphirine:Sapphirine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_sapphirine:Sapphirine",
