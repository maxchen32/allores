...
if minetest.get_modpath("allores_suessite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_suessite:Suessite", {
	description = S("Suessite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_suessite:allores2 1",
	recipe = "allores_suessite:Suessite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
