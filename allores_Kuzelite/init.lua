...
if minetest.get_modpath("allores_kuzelite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kuzelite:Kuzelite", {
	description = S("Kuzelite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kuzelite:allores2 1",
	recipe = "allores_kuzelite:Kuzelite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
