...
if minetest.get_modpath("allores_jalpaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jalpaite:Jalpaite", {
	description = S("Jalpaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jalpaite:allores2 1",
	recipe = "allores_jalpaite:Jalpaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
