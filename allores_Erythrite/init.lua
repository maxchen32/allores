...
if minetest.get_modpath("allores_erythrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_erythrite:Erythrite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_erythrite:allores2 1",
	recipe = "allores_erythrite:Erythrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_erythrite:Erythrite",
