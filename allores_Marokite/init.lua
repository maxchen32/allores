...
if minetest.get_modpath("allores_marokite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_marokite:Marokite", {
	description = S("Marokite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_marokite:allores2 1",
	recipe = "allores_marokite:Marokite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
