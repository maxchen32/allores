...
if minetest.get_modpath("allores_verneite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_verneite:Verneite", {
	description = S("Verneite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_verneite:allores2 1",
	recipe = "allores_verneite:Verneite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
