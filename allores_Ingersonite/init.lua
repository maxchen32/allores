...
if minetest.get_modpath("allores_ingersonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ingersonite:Ingersonite", {
	description = S("Ingersonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ingersonite:allores2 1",
	recipe = "allores_ingersonite:Ingersonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ingersonite:Ingersonite",
