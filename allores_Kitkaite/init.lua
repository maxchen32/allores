...
if minetest.get_modpath("allores_kitkaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kitkaite:Kitkaite", {
	description = S("Kitkaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kitkaite:allores2 1",
	recipe = "allores_kitkaite:Kitkaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
