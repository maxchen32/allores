...
if minetest.get_modpath("allores_nekoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nekoite:Nekoite", {
	description = S("Nekoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nekoite:allores2 1",
	recipe = "allores_nekoite:Nekoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
