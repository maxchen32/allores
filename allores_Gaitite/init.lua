...
if minetest.get_modpath("allores_gaitite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gaitite:Gaitite", {
	description = S("Gaitite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gaitite:allores2 1",
	recipe = "allores_gaitite:Gaitite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
