...
if minetest.get_modpath("allores_serendibite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_serendibite:Serendibite", {
	description = S("Serendibite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_serendibite:allores2 1",
	recipe = "allores_serendibite:Serendibite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_serendibite:Serendibite",
