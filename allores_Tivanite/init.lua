...
if minetest.get_modpath("allores_tivanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tivanite:Tivanite", {
	description = S("Tivanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tivanite:allores2 1",
	recipe = "allores_tivanite:Tivanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
