...
if minetest.get_modpath("allores_bouazzerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bouazzerite:Bouazzerite", {
	description = S("Bouazzerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bouazzerite:allores2 1",
	recipe = "allores_bouazzerite:Bouazzerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bouazzerite:Bouazzerite",
