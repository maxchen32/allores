...
if minetest.get_modpath("allores_hoganite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hoganite:Hoganite", {
	description = S("Hoganite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hoganite:allores2 1",
	recipe = "allores_hoganite:Hoganite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
