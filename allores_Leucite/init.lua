...
if minetest.get_modpath("allores_leucite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_leucite:Leucite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_leucite:allores2 1",
	recipe = "allores_leucite:Leucite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
