...
if minetest.get_modpath("allores_flamite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_flamite:Flamite", {
	description = S("Flamite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_flamite:allores2 1",
	recipe = "allores_flamite:Flamite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
