...
if minetest.get_modpath("allores_gurimite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gurimite:Gurimite", {
	description = S("Gurimite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gurimite:allores2 1",
	recipe = "allores_gurimite:Gurimite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
