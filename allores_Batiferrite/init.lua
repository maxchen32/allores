...
if minetest.get_modpath("allores_batiferrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_batiferrite:Batiferrite", {
	description = S("Batiferrite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_batiferrite:allores2 1",
	recipe = "allores_batiferrite:Batiferrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_batiferrite:Batiferrite",
