allores_skutterudite = {}
local S = minetest.get_translator(minetest.get_current_modname())

if minetest.get_modpath("allores_skutterudite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_skutterudite:Skutterudite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_skutterudite:allores2 1",
	recipe = "allores_skutterudite:Skutterudite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_skutterudite:Skutterudite",
