...
if minetest.get_modpath("allores_kapustinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kapustinite:Kapustinite", {
	description = S("Kapustinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kapustinite:allores2 1",
	recipe = "allores_kapustinite:Kapustinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kapustinite:Kapustinite",
