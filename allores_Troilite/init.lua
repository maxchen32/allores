...
if minetest.get_modpath("allores_troilite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_troilite:Troilite", {
	description = S("Troilite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_troilite:allores2 1",
	recipe = "allores_troilite:Troilite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
