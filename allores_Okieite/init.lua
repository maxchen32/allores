...
if minetest.get_modpath("allores_okieite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_okieite:Okieite", {
	description = S("Okieite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_okieite:allores2 1",
	recipe = "allores_okieite:Okieite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
