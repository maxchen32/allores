...
if minetest.get_modpath("allores_fahleite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fahleite:Fahleite", {
	description = S("Fahleite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fahleite:allores2 1",
	recipe = "allores_fahleite:Fahleite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
