...
if minetest.get_modpath("allores_zolenskyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zolenskyite:Zolenskyite", {
	description = S("Zolenskyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zolenskyite:allores2 1",
	recipe = "allores_zolenskyite:Zolenskyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_zolenskyite:Zolenskyite",
