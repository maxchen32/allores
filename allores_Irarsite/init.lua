...
if minetest.get_modpath("allores_irarsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_irarsite:Irarsite", {
	description = S("Irarsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_irarsite:allores2 1",
	recipe = "allores_irarsite:Irarsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
