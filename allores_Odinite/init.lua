...
if minetest.get_modpath("allores_odinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_odinite:Odinite", {
	description = S("Odinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_odinite:allores2 1",
	recipe = "allores_odinite:Odinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
