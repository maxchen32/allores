...
if minetest.get_modpath("allores_kellyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kellyite:Kellyite", {
	description = S("Kellyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kellyite:allores2 1",
	recipe = "allores_kellyite:Kellyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
