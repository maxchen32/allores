...
if minetest.get_modpath("allores_majakite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_majakite:Majakite", {
	description = S("Majakite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_majakite:allores2 1",
	recipe = "allores_majakite:Majakite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
