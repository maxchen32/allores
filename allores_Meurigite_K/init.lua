...
if minetest.get_modpath("allores_meurigite_k") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_meurigite_k:Meurigite_K", {
	description = S("Meurigite_K") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_meurigite_k:allores2 1",
	recipe = "allores_meurigite_k:Meurigite_K",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_meurigite_k:Meurigite_K",
