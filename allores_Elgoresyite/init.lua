...
if minetest.get_modpath("allores_elgoresyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_elgoresyite:Elgoresyite", {
	description = S("Elgoresyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_elgoresyite:allores2 1",
	recipe = "allores_elgoresyite:Elgoresyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_elgoresyite:Elgoresyite",
