...
if minetest.get_modpath("allores_tychite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tychite:Tychite", {
	description = S("Tychite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tychite:allores2 1",
	recipe = "allores_tychite:Tychite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
