...
if minetest.get_modpath("allores_nordite_ce") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nordite_ce:Nordite_Ce", {
	description = S("Nordite_Ce") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nordite_ce:allores2 1",
	recipe = "allores_nordite_ce:Nordite_Ce",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_nordite_ce:Nordite_Ce",
