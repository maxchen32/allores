...
if minetest.get_modpath("allores_boltwoodite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_boltwoodite:Boltwoodite", {
	description = S("Boltwoodite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_boltwoodite:allores2 1",
	recipe = "allores_boltwoodite:Boltwoodite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_boltwoodite:Boltwoodite",
