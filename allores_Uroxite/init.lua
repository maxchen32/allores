...
if minetest.get_modpath("allores_uroxite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_uroxite:Uroxite", {
	description = S("Uroxite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_uroxite:allores2 1",
	recipe = "allores_uroxite:Uroxite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
