...
if minetest.get_modpath("allores_bicapite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bicapite:Bicapite", {
	description = S("Bicapite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bicapite:allores2 1",
	recipe = "allores_bicapite:Bicapite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
