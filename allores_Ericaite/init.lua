...
if minetest.get_modpath("allores_ericaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ericaite:Ericaite", {
	description = S("Ericaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ericaite:allores2 1",
	recipe = "allores_ericaite:Ericaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
