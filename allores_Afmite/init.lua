...
if minetest.get_modpath("allores_afmite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_afmite:Afmite", {
	description = S("Afmite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_afmite:allores2 1",
	recipe = "allores_afmite:Afmite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
