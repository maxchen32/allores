...
if minetest.get_modpath("allores_biagioniite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_biagioniite:Biagioniite", {
	description = S("Biagioniite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_biagioniite:allores2 1",
	recipe = "allores_biagioniite:Biagioniite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_biagioniite:Biagioniite",
