...
if minetest.get_modpath("allores_sasaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sasaite:Sasaite", {
	description = S("Sasaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sasaite:allores2 1",
	recipe = "allores_sasaite:Sasaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
