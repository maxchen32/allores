...
if minetest.get_modpath("allores_barbosalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_barbosalite:Barbosalite", {
	description = S("Barbosalite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_barbosalite:allores2 1",
	recipe = "allores_barbosalite:Barbosalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_barbosalite:Barbosalite",
