...
if minetest.get_modpath("allores_nealite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nealite:Nealite", {
	description = S("Nealite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nealite:allores2 1",
	recipe = "allores_nealite:Nealite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
