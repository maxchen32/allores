...
if minetest.get_modpath("allores_nickel") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nickel:Nickel", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nickel:allores2 1",
	recipe = "allores_nickel:Nickel",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
