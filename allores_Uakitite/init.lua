...
if minetest.get_modpath("allores_uakitite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_uakitite:Uakitite", {
	description = S("Uakitite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_uakitite:allores2 1",
	recipe = "allores_uakitite:Uakitite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
