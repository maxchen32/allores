...
if minetest.get_modpath("allores_weeksite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_weeksite:Weeksite", {
	description = S("Weeksite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_weeksite:allores2 1",
	recipe = "allores_weeksite:Weeksite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
