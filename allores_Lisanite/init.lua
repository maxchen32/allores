...
if minetest.get_modpath("allores_lisanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lisanite:Lisanite", {
	description = S("Lisanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lisanite:allores2 1",
	recipe = "allores_lisanite:Lisanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
