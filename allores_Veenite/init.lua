...
if minetest.get_modpath("allores_veenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_veenite:Veenite", {
	description = S("Veenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_veenite:allores2 1",
	recipe = "allores_veenite:Veenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
