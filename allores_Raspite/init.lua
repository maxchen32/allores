...
if minetest.get_modpath("allores_raspite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_raspite:Raspite", {
	description = S("Raspite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_raspite:allores2 1",
	recipe = "allores_raspite:Raspite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
