...
if minetest.get_modpath("allores_nimite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nimite:Nimite", {
	description = S("Nimite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nimite:allores2 1",
	recipe = "allores_nimite:Nimite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
