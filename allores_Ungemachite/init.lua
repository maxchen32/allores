...
if minetest.get_modpath("allores_ungemachite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ungemachite:Ungemachite", {
	description = S("Ungemachite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ungemachite:allores2 1",
	recipe = "allores_ungemachite:Ungemachite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ungemachite:Ungemachite",
