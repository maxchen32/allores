...
if minetest.get_modpath("allores_tounkite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tounkite:Tounkite", {
	description = S("Tounkite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tounkite:allores2 1",
	recipe = "allores_tounkite:Tounkite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
