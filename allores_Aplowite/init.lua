...
if minetest.get_modpath("allores_aplowite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_aplowite:Aplowite", {
	description = S("Aplowite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_aplowite:allores2 1",
	recipe = "allores_aplowite:Aplowite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
