...
if minetest.get_modpath("allores_roweite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_roweite:Roweite", {
	description = S("Roweite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_roweite:allores2 1",
	recipe = "allores_roweite:Roweite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
