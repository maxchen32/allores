...
if minetest.get_modpath("allores_alunite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_alunite:Alunite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_alunite:allores2 1",
	recipe = "allores_alunite:Alunite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
