...
if minetest.get_modpath("allores_oligoclase") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_oligoclase:Oligoclase", {
	description = S("Oligoclase") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_oligoclase:allores2 1",
	recipe = "allores_oligoclase:Oligoclase",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_oligoclase:Oligoclase",
