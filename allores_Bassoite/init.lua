...
if minetest.get_modpath("allores_bassoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bassoite:Bassoite", {
	description = S("Bassoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bassoite:allores2 1",
	recipe = "allores_bassoite:Bassoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
