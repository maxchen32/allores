...
if minetest.get_modpath("allores_tondiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tondiite:Tondiite", {
	description = S("Tondiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tondiite:allores2 1",
	recipe = "allores_tondiite:Tondiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
