...
if minetest.get_modpath("allores_skinnerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_skinnerite:Skinnerite", {
	description = S("Skinnerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_skinnerite:allores2 1",
	recipe = "allores_skinnerite:Skinnerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_skinnerite:Skinnerite",
