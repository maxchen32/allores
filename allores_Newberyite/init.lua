...
if minetest.get_modpath("allores_newberyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_newberyite:Newberyite", {
	description = S("Newberyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_newberyite:allores2 1",
	recipe = "allores_newberyite:Newberyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_newberyite:Newberyite",
