...
if minetest.get_modpath("allores_escheite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_escheite:Escheite", {
	description = S("Escheite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_escheite:allores2 1",
	recipe = "allores_escheite:Escheite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
