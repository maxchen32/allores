allores_clausthalite = {}
local S = minetest.get_translator(minetest.get_current_modname())

if minetest.get_modpath("allores_clausthalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_clausthalite:Clausthalite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_clausthalite:allores2 1",
	recipe = "allores_clausthalite:Clausthalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_clausthalite:Clausthalite",
