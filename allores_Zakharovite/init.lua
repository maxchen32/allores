...
if minetest.get_modpath("allores_zakharovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zakharovite:Zakharovite", {
	description = S("Zakharovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zakharovite:allores2 1",
	recipe = "allores_zakharovite:Zakharovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_zakharovite:Zakharovite",
