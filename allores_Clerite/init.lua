...
if minetest.get_modpath("allores_clerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_clerite:Clerite", {
	description = S("Clerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_clerite:allores2 1",
	recipe = "allores_clerite:Clerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
