...
if minetest.get_modpath("allores_dagenaisite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dagenaisite:Dagenaisite", {
	description = S("Dagenaisite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dagenaisite:allores2 1",
	recipe = "allores_dagenaisite:Dagenaisite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_dagenaisite:Dagenaisite",
