...
if minetest.get_modpath("allores_smithsonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_smithsonite:Smithsonite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_smithsonite:allores2 1",
	recipe = "allores_smithsonite:Smithsonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_smithsonite:Smithsonite",
