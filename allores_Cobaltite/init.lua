...
if minetest.get_modpath("allores_cobaltite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cobaltite:Cobaltite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cobaltite:allores2 1",
	recipe = "allores_cobaltite:Cobaltite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_cobaltite:Cobaltite",
