...
if minetest.get_modpath("allores_traskite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_traskite:Traskite", {
	description = S("Traskite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_traskite:allores2 1",
	recipe = "allores_traskite:Traskite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
