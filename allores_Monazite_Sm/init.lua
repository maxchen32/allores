...
if minetest.get_modpath("allores_monazite_sm") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_monazite_sm:Monazite_Sm", {
	description = S("Monazite_Sm") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_monazite_sm:allores2 1",
	recipe = "allores_monazite_sm:Monazite_Sm",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_monazite_sm:Monazite_Sm",
