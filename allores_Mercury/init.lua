...
if minetest.get_modpath("allores_mercury") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mercury:Mercury", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mercury:allores2 1",
	recipe = "allores_mercury:Mercury",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
