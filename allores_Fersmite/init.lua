...
if minetest.get_modpath("allores_fersmite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fersmite:Fersmite", {
	description = S("Fersmite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fersmite:allores2 1",
	recipe = "allores_fersmite:Fersmite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
