...
if minetest.get_modpath("allores_kupletskite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kupletskite:Kupletskite", {
	description = S("Kupletskite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kupletskite:allores2 1",
	recipe = "allores_kupletskite:Kupletskite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kupletskite:Kupletskite",
