...
if minetest.get_modpath("allores_ciprianiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ciprianiite:Ciprianiite", {
	description = S("Ciprianiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ciprianiite:allores2 1",
	recipe = "allores_ciprianiite:Ciprianiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ciprianiite:Ciprianiite",
