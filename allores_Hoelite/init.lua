...
if minetest.get_modpath("allores_hoelite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hoelite:Hoelite", {
	description = S("Hoelite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hoelite:allores2 1",
	recipe = "allores_hoelite:Hoelite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
