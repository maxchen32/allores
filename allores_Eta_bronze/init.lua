...
if minetest.get_modpath("allores_eta_bronze") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_eta_bronze:Eta_bronze", {
	description = S("Eta_bronze") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_eta_bronze:allores2 1",
	recipe = "allores_eta_bronze:Eta_bronze",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_eta_bronze:Eta_bronze",
