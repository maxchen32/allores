...
if minetest.get_modpath("allores_mirnyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mirnyite:Mirnyite", {
	description = S("Mirnyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mirnyite:allores2 1",
	recipe = "allores_mirnyite:Mirnyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
