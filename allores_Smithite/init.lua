...
if minetest.get_modpath("allores_smithite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_smithite:Smithite", {
	description = S("Smithite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_smithite:allores2 1",
	recipe = "allores_smithite:Smithite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
