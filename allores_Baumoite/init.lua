...
if minetest.get_modpath("allores_baumoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_baumoite:Baumoite", {
	description = S("Baumoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_baumoite:allores2 1",
	recipe = "allores_baumoite:Baumoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
