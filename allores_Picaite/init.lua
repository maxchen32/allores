...
if minetest.get_modpath("allores_picaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_picaite:Picaite", {
	description = S("Picaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_picaite:allores2 1",
	recipe = "allores_picaite:Picaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
