...
if minetest.get_modpath("allores_molysite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_molysite:Molysite", {
	description = S("Molysite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_molysite:allores2 1",
	recipe = "allores_molysite:Molysite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
