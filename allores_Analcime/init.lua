...
if minetest.get_modpath("allores_analcime") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_analcime:Analcime", {
	description = S("Analcime") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_analcime:allores2 1",
	recipe = "allores_analcime:Analcime",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
