...
if minetest.get_modpath("allores_laachite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_laachite:Laachite", {
	description = S("Laachite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_laachite:allores2 1",
	recipe = "allores_laachite:Laachite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
