...
if minetest.get_modpath("allores_asisite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_asisite:Asisite", {
	description = S("Asisite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_asisite:allores2 1",
	recipe = "allores_asisite:Asisite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
