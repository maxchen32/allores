...
if minetest.get_modpath("allores_zodacite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zodacite:Zodacite", {
	description = S("Zodacite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zodacite:allores2 1",
	recipe = "allores_zodacite:Zodacite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
