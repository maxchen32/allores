...
if minetest.get_modpath("allores_hinsdalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hinsdalite:Hinsdalite", {
	description = S("Hinsdalite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hinsdalite:allores2 1",
	recipe = "allores_hinsdalite:Hinsdalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hinsdalite:Hinsdalite",
