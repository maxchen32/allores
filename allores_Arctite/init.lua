...
if minetest.get_modpath("allores_arctite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_arctite:Arctite", {
	description = S("Arctite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_arctite:allores2 1",
	recipe = "allores_arctite:Arctite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
