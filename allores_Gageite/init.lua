...
if minetest.get_modpath("allores_gageite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gageite:Gageite", {
	description = S("Gageite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gageite:allores2 1",
	recipe = "allores_gageite:Gageite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
