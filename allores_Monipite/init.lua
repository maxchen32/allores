...
if minetest.get_modpath("allores_monipite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_monipite:Monipite", {
	description = S("Monipite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_monipite:allores2 1",
	recipe = "allores_monipite:Monipite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
