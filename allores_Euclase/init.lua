...
if minetest.get_modpath("allores_euclase") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_euclase:Euclase", {
	description = S("Euclase") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_euclase:allores2 1",
	recipe = "allores_euclase:Euclase",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
