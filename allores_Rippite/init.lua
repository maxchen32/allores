...
if minetest.get_modpath("allores_rippite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rippite:Rippite", {
	description = S("Rippite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rippite:allores2 1",
	recipe = "allores_rippite:Rippite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
