...
if minetest.get_modpath("allores_tritomite_y") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tritomite_y:Tritomite_Y", {
	description = S("Tritomite_Y") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tritomite_y:allores2 1",
	recipe = "allores_tritomite_y:Tritomite_Y",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_tritomite_y:Tritomite_Y",
