...
if minetest.get_modpath("allores_gibbsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gibbsite:Gibbsite", {
	description = S("Gibbsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gibbsite:allores2 1",
	recipe = "allores_gibbsite:Gibbsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
