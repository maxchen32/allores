...
if minetest.get_modpath("allores_theisite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_theisite:Theisite", {
	description = S("Theisite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_theisite:allores2 1",
	recipe = "allores_theisite:Theisite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
