...
if minetest.get_modpath("allores_fluoborite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fluoborite:Fluoborite", {
	description = S("Fluoborite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fluoborite:allores2 1",
	recipe = "allores_fluoborite:Fluoborite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_fluoborite:Fluoborite",
