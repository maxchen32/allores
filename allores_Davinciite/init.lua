...
if minetest.get_modpath("allores_davinciite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_davinciite:Davinciite", {
	description = S("Davinciite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_davinciite:allores2 1",
	recipe = "allores_davinciite:Davinciite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_davinciite:Davinciite",
