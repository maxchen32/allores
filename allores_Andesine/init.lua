...
if minetest.get_modpath("allores_andesine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_andesine:Andesine", {
	description = S("Andesine") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_andesine:allores2 1",
	recipe = "allores_andesine:Andesine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
