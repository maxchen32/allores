...
if minetest.get_modpath("allores_ramanite_rb") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ramanite_rb:Ramanite_Rb", {
	description = S("Ramanite_Rb") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ramanite_rb:allores2 1",
	recipe = "allores_ramanite_rb:Ramanite_Rb",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ramanite_rb:Ramanite_Rb",
