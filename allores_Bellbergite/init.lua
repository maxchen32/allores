...
if minetest.get_modpath("allores_bellbergite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bellbergite:Bellbergite", {
	description = S("Bellbergite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bellbergite:allores2 1",
	recipe = "allores_bellbergite:Bellbergite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bellbergite:Bellbergite",
