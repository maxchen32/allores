...
if minetest.get_modpath("allores_wicksite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wicksite:Wicksite", {
	description = S("Wicksite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wicksite:allores2 1",
	recipe = "allores_wicksite:Wicksite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
