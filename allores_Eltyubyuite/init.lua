...
if minetest.get_modpath("allores_eltyubyuite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_eltyubyuite:Eltyubyuite", {
	description = S("Eltyubyuite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_eltyubyuite:allores2 1",
	recipe = "allores_eltyubyuite:Eltyubyuite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_eltyubyuite:Eltyubyuite",
