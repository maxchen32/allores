...
if minetest.get_modpath("allores_augelite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_augelite:Augelite", {
	description = S("Augelite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_augelite:allores2 1",
	recipe = "allores_augelite:Augelite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
