...
if minetest.get_modpath("allores_pottsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pottsite:Pottsite", {
	description = S("Pottsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pottsite:allores2 1",
	recipe = "allores_pottsite:Pottsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
