...
if minetest.get_modpath("allores_heimite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_heimite:Heimite", {
	description = S("Heimite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_heimite:allores2 1",
	recipe = "allores_heimite:Heimite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
