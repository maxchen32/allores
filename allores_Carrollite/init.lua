...
if minetest.get_modpath("allores_carrollite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_carrollite:Carrollite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_carrollite:allores2 1",
	recipe = "allores_carrollite:Carrollite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_carrollite:Carrollite",
