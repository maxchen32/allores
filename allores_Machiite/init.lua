...
if minetest.get_modpath("allores_machiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_machiite:Machiite", {
	description = S("Machiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_machiite:allores2 1",
	recipe = "allores_machiite:Machiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
