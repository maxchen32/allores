...
if minetest.get_modpath("allores_nitratine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nitratine:Nitratine", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nitratine:allores2 1",
	recipe = "allores_nitratine:Nitratine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_nitratine:Nitratine",
