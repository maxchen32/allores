...
if minetest.get_modpath("allores_hematite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hematite:Hematite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hematite:allores2 1",
	recipe = "allores_hematite:Hematite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
