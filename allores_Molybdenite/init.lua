...
if minetest.get_modpath("allores_molybdenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_molybdenite:Molybdenite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_molybdenite:allores2 1",
	recipe = "allores_molybdenite:Molybdenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_molybdenite:Molybdenite",
