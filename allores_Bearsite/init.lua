...
if minetest.get_modpath("allores_bearsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bearsite:Bearsite", {
	description = S("Bearsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bearsite:allores2 1",
	recipe = "allores_bearsite:Bearsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
