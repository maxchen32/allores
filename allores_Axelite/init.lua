...
if minetest.get_modpath("allores_axelite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_axelite:Axelite", {
	description = S("Axelite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_axelite:allores2 1",
	recipe = "allores_axelite:Axelite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
