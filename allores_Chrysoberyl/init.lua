...
if minetest.get_modpath("allores_chrysoberyl") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chrysoberyl:Chrysoberyl", {
	description = S("Chrysoberyl") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chrysoberyl:allores2 1",
	recipe = "allores_chrysoberyl:Chrysoberyl",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chrysoberyl:Chrysoberyl",
