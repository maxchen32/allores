...
if minetest.get_modpath("allores_hedyphane") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hedyphane:Hedyphane", {
	description = S("Hedyphane") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hedyphane:allores2 1",
	recipe = "allores_hedyphane:Hedyphane",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hedyphane:Hedyphane",
