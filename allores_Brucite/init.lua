...
if minetest.get_modpath("allores_brucite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_brucite:Brucite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_brucite:allores2 1",
	recipe = "allores_brucite:Brucite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
