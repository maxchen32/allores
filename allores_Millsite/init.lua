...
if minetest.get_modpath("allores_millsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_millsite:Millsite", {
	description = S("Millsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_millsite:allores2 1",
	recipe = "allores_millsite:Millsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
