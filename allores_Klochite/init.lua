...
if minetest.get_modpath("allores_klochite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_klochite:Klochite", {
	description = S("Klochite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_klochite:allores2 1",
	recipe = "allores_klochite:Klochite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
