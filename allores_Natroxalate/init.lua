...
if minetest.get_modpath("allores_natroxalate") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_natroxalate:Natroxalate", {
	description = S("Natroxalate") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_natroxalate:allores2 1",
	recipe = "allores_natroxalate:Natroxalate",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_natroxalate:Natroxalate",
