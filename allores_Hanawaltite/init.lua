...
if minetest.get_modpath("allores_hanawaltite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hanawaltite:Hanawaltite", {
	description = S("Hanawaltite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hanawaltite:allores2 1",
	recipe = "allores_hanawaltite:Hanawaltite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hanawaltite:Hanawaltite",
