...
if minetest.get_modpath("allores_chromferide") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chromferide:Chromferide", {
	description = S("Chromferide") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chromferide:allores2 1",
	recipe = "allores_chromferide:Chromferide",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chromferide:Chromferide",
