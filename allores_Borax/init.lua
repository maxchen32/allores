...
if minetest.get_modpath("allores_borax") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_borax:Borax", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_borax:allores2 1",
	recipe = "allores_borax:Borax",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
