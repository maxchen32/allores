...
if minetest.get_modpath("allores_lazulite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lazulite:Lazulite", {
	description = S("Lazulite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lazulite:allores2 1",
	recipe = "allores_lazulite:Lazulite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
