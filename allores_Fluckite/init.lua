...
if minetest.get_modpath("allores_fluckite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fluckite:Fluckite", {
	description = S("Fluckite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fluckite:allores2 1",
	recipe = "allores_fluckite:Fluckite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
