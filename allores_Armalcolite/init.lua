...
if minetest.get_modpath("allores_armalcolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_armalcolite:Armalcolite", {
	description = S("Armalcolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_armalcolite:allores2 1",
	recipe = "allores_armalcolite:Armalcolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_armalcolite:Armalcolite",
