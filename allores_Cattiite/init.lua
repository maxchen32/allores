...
if minetest.get_modpath("allores_cattiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cattiite:Cattiite", {
	description = S("Cattiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cattiite:allores2 1",
	recipe = "allores_cattiite:Cattiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
