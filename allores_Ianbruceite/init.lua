...
if minetest.get_modpath("allores_ianbruceite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ianbruceite:Ianbruceite", {
	description = S("Ianbruceite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ianbruceite:allores2 1",
	recipe = "allores_ianbruceite:Ianbruceite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ianbruceite:Ianbruceite",
