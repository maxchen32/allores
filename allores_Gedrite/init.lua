...
if minetest.get_modpath("allores_gedrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gedrite:Gedrite", {
	description = S("Gedrite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gedrite:allores2 1",
	recipe = "allores_gedrite:Gedrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
