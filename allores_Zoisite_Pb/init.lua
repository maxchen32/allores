...
if minetest.get_modpath("allores_zoisite_pb") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zoisite_pb:Zoisite_Pb", {
	description = S("Zoisite_Pb") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zoisite_pb:allores2 1",
	recipe = "allores_zoisite_pb:Zoisite_Pb",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_zoisite_pb:Zoisite_Pb",
