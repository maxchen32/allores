...
if minetest.get_modpath("allores_cerium") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cerium:Cerium", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cerium:allores2 1",
	recipe = "allores_cerium:Cerium",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
