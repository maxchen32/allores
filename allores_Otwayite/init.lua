...
if minetest.get_modpath("allores_otwayite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_otwayite:Otwayite", {
	description = S("Otwayite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_otwayite:allores2 1",
	recipe = "allores_otwayite:Otwayite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
