...
if minetest.get_modpath("allores_alabandite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_alabandite:Alabandite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_alabandite:allores2 1",
	recipe = "allores_alabandite:Alabandite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_alabandite:Alabandite",
