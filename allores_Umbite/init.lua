...
if minetest.get_modpath("allores_umbite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_umbite:Umbite", {
	description = S("Umbite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_umbite:allores2 1",
	recipe = "allores_umbite:Umbite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
