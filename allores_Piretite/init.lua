...
if minetest.get_modpath("allores_piretite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_piretite:Piretite", {
	description = S("Piretite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_piretite:allores2 1",
	recipe = "allores_piretite:Piretite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
