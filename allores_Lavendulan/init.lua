...
if minetest.get_modpath("allores_lavendulan") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lavendulan:Lavendulan", {
	description = S("Lavendulan") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lavendulan:allores2 1",
	recipe = "allores_lavendulan:Lavendulan",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_lavendulan:Lavendulan",
