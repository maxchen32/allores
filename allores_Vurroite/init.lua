...
if minetest.get_modpath("allores_vurroite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vurroite:Vurroite", {
	description = S("Vurroite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vurroite:allores2 1",
	recipe = "allores_vurroite:Vurroite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
