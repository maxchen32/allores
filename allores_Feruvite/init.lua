...
if minetest.get_modpath("allores_feruvite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_feruvite:Feruvite", {
	description = S("Feruvite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_feruvite:allores2 1",
	recipe = "allores_feruvite:Feruvite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
