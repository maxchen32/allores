...
if minetest.get_modpath("allores_iowaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_iowaite:Iowaite", {
	description = S("Iowaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_iowaite:allores2 1",
	recipe = "allores_iowaite:Iowaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
