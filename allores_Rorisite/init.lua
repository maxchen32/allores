...
if minetest.get_modpath("allores_rorisite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rorisite:Rorisite", {
	description = S("Rorisite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rorisite:allores2 1",
	recipe = "allores_rorisite:Rorisite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
