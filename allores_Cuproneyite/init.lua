...
if minetest.get_modpath("allores_cuproneyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cuproneyite:Cuproneyite", {
	description = S("Cuproneyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cuproneyite:allores2 1",
	recipe = "allores_cuproneyite:Cuproneyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_cuproneyite:Cuproneyite",
