...
if minetest.get_modpath("allores_canutite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_canutite:Canutite", {
	description = S("Canutite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_canutite:allores2 1",
	recipe = "allores_canutite:Canutite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
