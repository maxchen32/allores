...
if minetest.get_modpath("allores_fersilicite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fersilicite:Fersilicite", {
	description = S("Fersilicite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fersilicite:allores2 1",
	recipe = "allores_fersilicite:Fersilicite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_fersilicite:Fersilicite",
