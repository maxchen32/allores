...
if minetest.get_modpath("allores_molybdenum") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_molybdenum:Molybdenum", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_molybdenum:allores2 1",
	recipe = "allores_molybdenum:Molybdenum",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_molybdenum:Molybdenum",
