...
if minetest.get_modpath("allores_ephesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ephesite:Ephesite", {
	description = S("Ephesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ephesite:allores2 1",
	recipe = "allores_ephesite:Ephesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
