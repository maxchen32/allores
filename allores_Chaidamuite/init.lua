...
if minetest.get_modpath("allores_chaidamuite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chaidamuite:Chaidamuite", {
	description = S("Chaidamuite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chaidamuite:allores2 1",
	recipe = "allores_chaidamuite:Chaidamuite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chaidamuite:Chaidamuite",
