...
if minetest.get_modpath("allores_indium") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_indium:Indium", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_indium:allores2 1",
	recipe = "allores_indium:Indium",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
