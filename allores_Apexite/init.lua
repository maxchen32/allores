...
if minetest.get_modpath("allores_apexite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_apexite:Apexite", {
	description = S("Apexite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_apexite:allores2 1",
	recipe = "allores_apexite:Apexite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
