...
if minetest.get_modpath("allores_combeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_combeite:Combeite", {
	description = S("Combeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_combeite:allores2 1",
	recipe = "allores_combeite:Combeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
