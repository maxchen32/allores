...
if minetest.get_modpath("allores_epsomite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_epsomite:Epsomite", {
	description = S("Epsomite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_epsomite:allores2 1",
	recipe = "allores_epsomite:Epsomite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
