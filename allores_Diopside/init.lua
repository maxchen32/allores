...
if minetest.get_modpath("allores_diopside") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_diopside:Diopside", {
	description = S("Diopside") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_diopside:allores2 1",
	recipe = "allores_diopside:Diopside",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
