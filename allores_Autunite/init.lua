...
if minetest.get_modpath("allores_autunite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_autunite:Autunite", {
	description = S("Autunite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_autunite:allores2 1",
	recipe = "allores_autunite:Autunite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
