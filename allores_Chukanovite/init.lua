...
if minetest.get_modpath("allores_chukanovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chukanovite:Chukanovite", {
	description = S("Chukanovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chukanovite:allores2 1",
	recipe = "allores_chukanovite:Chukanovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chukanovite:Chukanovite",
