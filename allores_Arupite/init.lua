...
if minetest.get_modpath("allores_arupite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_arupite:Arupite", {
	description = S("Arupite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_arupite:allores2 1",
	recipe = "allores_arupite:Arupite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
