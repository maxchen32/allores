...
if minetest.get_modpath("allores_kosmochlor") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kosmochlor:Kosmochlor", {
	description = S("Kosmochlor") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kosmochlor:allores2 1",
	recipe = "allores_kosmochlor:Kosmochlor",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kosmochlor:Kosmochlor",
