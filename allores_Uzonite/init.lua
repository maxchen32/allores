...
if minetest.get_modpath("allores_uzonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_uzonite:Uzonite", {
	description = S("Uzonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_uzonite:allores2 1",
	recipe = "allores_uzonite:Uzonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
