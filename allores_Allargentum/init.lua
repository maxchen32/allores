...
if minetest.get_modpath("allores_allargentum") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_allargentum:Allargentum", {
	description = S("Allargentum") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_allargentum:allores2 1",
	recipe = "allores_allargentum:Allargentum",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_allargentum:Allargentum",
