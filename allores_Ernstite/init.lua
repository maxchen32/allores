...
if minetest.get_modpath("allores_ernstite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ernstite:Ernstite", {
	description = S("Ernstite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ernstite:allores2 1",
	recipe = "allores_ernstite:Ernstite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
