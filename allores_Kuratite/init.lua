...
if minetest.get_modpath("allores_kuratite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kuratite:Kuratite", {
	description = S("Kuratite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kuratite:allores2 1",
	recipe = "allores_kuratite:Kuratite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
