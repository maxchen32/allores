...
if minetest.get_modpath("allores_szaibelyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_szaibelyite:Szaibelyite", {
	description = S("Szaibelyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_szaibelyite:allores2 1",
	recipe = "allores_szaibelyite:Szaibelyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_szaibelyite:Szaibelyite",
