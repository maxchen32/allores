...
if minetest.get_modpath("allores_tamboite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tamboite:Tamboite", {
	description = S("Tamboite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tamboite:allores2 1",
	recipe = "allores_tamboite:Tamboite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
