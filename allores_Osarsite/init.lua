...
if minetest.get_modpath("allores_osarsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_osarsite:Osarsite", {
	description = S("Osarsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_osarsite:allores2 1",
	recipe = "allores_osarsite:Osarsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
