...
if minetest.get_modpath("allores_dittmarite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dittmarite:Dittmarite", {
	description = S("Dittmarite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dittmarite:allores2 1",
	recipe = "allores_dittmarite:Dittmarite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_dittmarite:Dittmarite",
