...
if minetest.get_modpath("allores_chondrodite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chondrodite:Chondrodite", {
	description = S("Chondrodite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chondrodite:allores2 1",
	recipe = "allores_chondrodite:Chondrodite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chondrodite:Chondrodite",
