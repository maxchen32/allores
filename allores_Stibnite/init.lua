...
if minetest.get_modpath("allores_stibnite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_stibnite:Stibnite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_stibnite:allores2 1",
	recipe = "allores_stibnite:Stibnite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
