...
if minetest.get_modpath("allores_hydrohalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hydrohalite:Hydrohalite", {
	description = S("Hydrohalite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hydrohalite:allores2 1",
	recipe = "allores_hydrohalite:Hydrohalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hydrohalite:Hydrohalite",
