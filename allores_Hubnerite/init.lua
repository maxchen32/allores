...
if minetest.get_modpath("allores_hubnerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hubnerite:Hubnerite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hubnerite:allores2 1",
	recipe = "allores_hubnerite:Hubnerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hubnerite:Hubnerite",
