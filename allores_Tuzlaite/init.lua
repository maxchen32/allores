...
if minetest.get_modpath("allores_tuzlaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tuzlaite:Tuzlaite", {
	description = S("Tuzlaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tuzlaite:allores2 1",
	recipe = "allores_tuzlaite:Tuzlaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
