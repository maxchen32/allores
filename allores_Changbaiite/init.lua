...
if minetest.get_modpath("allores_changbaiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_changbaiite:Changbaiite", {
	description = S("Changbaiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_changbaiite:allores2 1",
	recipe = "allores_changbaiite:Changbaiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_changbaiite:Changbaiite",
