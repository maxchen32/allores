...
if minetest.get_modpath("allores_tsumcorite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tsumcorite:Tsumcorite", {
	description = S("Tsumcorite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tsumcorite:allores2 1",
	recipe = "allores_tsumcorite:Tsumcorite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_tsumcorite:Tsumcorite",
