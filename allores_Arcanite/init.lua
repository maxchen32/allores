...
if minetest.get_modpath("allores_arcanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_arcanite:Arcanite", {
	description = S("Arcanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_arcanite:allores2 1",
	recipe = "allores_arcanite:Arcanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
