...
if minetest.get_modpath("allores_vargite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vargite:Vargite", {
	description = S("Vargite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vargite:allores2 1",
	recipe = "allores_vargite:Vargite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
