...
if minetest.get_modpath("allores_nalivkinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nalivkinite:Nalivkinite", {
	description = S("Nalivkinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nalivkinite:allores2 1",
	recipe = "allores_nalivkinite:Nalivkinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_nalivkinite:Nalivkinite",
