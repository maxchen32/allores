...
if minetest.get_modpath("allores_kaolinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kaolinite:Kaolinite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kaolinite:allores2 1",
	recipe = "allores_kaolinite:Kaolinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kaolinite:Kaolinite",
