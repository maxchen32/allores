...
if minetest.get_modpath("allores_joseite_a") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_joseite_a:Joseite_A", {
	description = S("Joseite_A") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_joseite_a:allores2 1",
	recipe = "allores_joseite_a:Joseite_A",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_joseite_a:Joseite_A",
