...
if minetest.get_modpath("allores_vivianite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vivianite:Vivianite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vivianite:allores2 1",
	recipe = "allores_vivianite:Vivianite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_vivianite:Vivianite",
