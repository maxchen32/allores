...
if minetest.get_modpath("allores_sigloite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sigloite:Sigloite", {
	description = S("Sigloite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sigloite:allores2 1",
	recipe = "allores_sigloite:Sigloite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
