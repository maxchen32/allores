...
if minetest.get_modpath("allores_almandine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_almandine:Almandine", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_almandine:allores2 1",
	recipe = "allores_almandine:Almandine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_almandine:Almandine",
