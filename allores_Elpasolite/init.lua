...
if minetest.get_modpath("allores_elpasolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_elpasolite:Elpasolite", {
	description = S("Elpasolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_elpasolite:allores2 1",
	recipe = "allores_elpasolite:Elpasolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_elpasolite:Elpasolite",
