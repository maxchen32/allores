...
if minetest.get_modpath("allores_burtite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_burtite:Burtite", {
	description = S("Burtite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_burtite:allores2 1",
	recipe = "allores_burtite:Burtite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
