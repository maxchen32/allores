...
if minetest.get_modpath("allores_bojarite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bojarite:Bojarite", {
	description = S("Bojarite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bojarite:allores2 1",
	recipe = "allores_bojarite:Bojarite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
