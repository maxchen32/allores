...
if minetest.get_modpath("allores_oxy_dravite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_oxy_dravite:Oxy_dravite", {
	description = S("Oxy_dravite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_oxy_dravite:allores2 1",
	recipe = "allores_oxy_dravite:Oxy_dravite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_oxy_dravite:Oxy_dravite",
