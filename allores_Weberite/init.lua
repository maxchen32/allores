...
if minetest.get_modpath("allores_weberite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_weberite:Weberite", {
	description = S("Weberite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_weberite:allores2 1",
	recipe = "allores_weberite:Weberite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
