...
if minetest.get_modpath("allores_bolotinaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bolotinaite:Bolotinaite", {
	description = S("Bolotinaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bolotinaite:allores2 1",
	recipe = "allores_bolotinaite:Bolotinaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bolotinaite:Bolotinaite",
