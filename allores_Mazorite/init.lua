...
if minetest.get_modpath("allores_mazorite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mazorite:Mazorite", {
	description = S("Mazorite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mazorite:allores2 1",
	recipe = "allores_mazorite:Mazorite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
