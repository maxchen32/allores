...
if minetest.get_modpath("allores_vimsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vimsite:Vimsite", {
	description = S("Vimsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vimsite:allores2 1",
	recipe = "allores_vimsite:Vimsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
