...
if minetest.get_modpath("allores_vranaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vranaite:Vranaite", {
	description = S("Vranaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vranaite:allores2 1",
	recipe = "allores_vranaite:Vranaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
