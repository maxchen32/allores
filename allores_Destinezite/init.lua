...
if minetest.get_modpath("allores_destinezite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_destinezite:Destinezite", {
	description = S("Destinezite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_destinezite:allores2 1",
	recipe = "allores_destinezite:Destinezite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_destinezite:Destinezite",
