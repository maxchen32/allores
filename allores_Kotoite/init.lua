...
if minetest.get_modpath("allores_kotoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kotoite:Kotoite", {
	description = S("Kotoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kotoite:allores2 1",
	recipe = "allores_kotoite:Kotoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
