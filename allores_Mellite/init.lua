...
if minetest.get_modpath("allores_mellite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mellite:Mellite", {
	description = S("Mellite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mellite:allores2 1",
	recipe = "allores_mellite:Mellite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
