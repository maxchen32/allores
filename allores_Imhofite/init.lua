...
if minetest.get_modpath("allores_imhofite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_imhofite:Imhofite", {
	description = S("Imhofite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_imhofite:allores2 1",
	recipe = "allores_imhofite:Imhofite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
