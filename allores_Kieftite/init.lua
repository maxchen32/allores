...
if minetest.get_modpath("allores_kieftite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kieftite:Kieftite", {
	description = S("Kieftite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kieftite:allores2 1",
	recipe = "allores_kieftite:Kieftite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
