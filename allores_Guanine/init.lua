...
if minetest.get_modpath("allores_guanine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_guanine:Guanine", {
	description = S("Guanine") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_guanine:allores2 1",
	recipe = "allores_guanine:Guanine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
