...
if minetest.get_modpath("allores_magnetite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_magnetite:Magnetite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_magnetite:allores2 1",
	recipe = "allores_magnetite:Magnetite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_magnetite:Magnetite",
