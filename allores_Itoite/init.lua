...
if minetest.get_modpath("allores_itoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_itoite:Itoite", {
	description = S("Itoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_itoite:allores2 1",
	recipe = "allores_itoite:Itoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
