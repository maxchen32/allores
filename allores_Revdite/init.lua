...
if minetest.get_modpath("allores_revdite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_revdite:Revdite", {
	description = S("Revdite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_revdite:allores2 1",
	recipe = "allores_revdite:Revdite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
