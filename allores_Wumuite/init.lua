...
if minetest.get_modpath("allores_wumuite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wumuite:Wumuite", {
	description = S("Wumuite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wumuite:allores2 1",
	recipe = "allores_wumuite:Wumuite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
