...
if minetest.get_modpath("allores_leesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_leesite:Leesite", {
	description = S("Leesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_leesite:allores2 1",
	recipe = "allores_leesite:Leesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
