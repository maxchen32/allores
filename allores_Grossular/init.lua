...
if minetest.get_modpath("allores_grossular") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_grossular:Grossular", {
	description = S("Grossular") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_grossular:allores2 1",
	recipe = "allores_grossular:Grossular",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_grossular:Grossular",
