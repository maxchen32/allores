...
if minetest.get_modpath("allores_goyazite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_goyazite:Goyazite", {
	description = S("Goyazite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_goyazite:allores2 1",
	recipe = "allores_goyazite:Goyazite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
