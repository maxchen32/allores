...
if minetest.get_modpath("allores_eirikite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_eirikite:Eirikite", {
	description = S("Eirikite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_eirikite:allores2 1",
	recipe = "allores_eirikite:Eirikite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
