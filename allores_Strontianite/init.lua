allores_strontianite = {}
local S = minetest.get_translator(minetest.get_current_modname())

if minetest.get_modpath("allores_strontianite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_strontianite:Strontianite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_strontianite:allores2 1",
	recipe = "allores_strontianite:Strontianite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_strontianite:Strontianite",
