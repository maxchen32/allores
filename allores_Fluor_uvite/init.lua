...
if minetest.get_modpath("allores_fluor_uvite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fluor_uvite:Fluor_uvite", {
	description = S("Fluor_uvite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fluor_uvite:allores2 1",
	recipe = "allores_fluor_uvite:Fluor_uvite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_fluor_uvite:Fluor_uvite",
