...
if minetest.get_modpath("allores_petalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_petalite:Petalite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_petalite:allores2 1",
	recipe = "allores_petalite:Petalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
