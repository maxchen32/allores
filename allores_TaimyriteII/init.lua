...
if minetest.get_modpath("allores_taimyriteii") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_taimyriteii:TaimyriteII", {
	description = S("TaimyriteII") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_taimyriteii:allores2 1",
	recipe = "allores_taimyriteii:TaimyriteII",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_taimyriteii:TaimyriteII",
