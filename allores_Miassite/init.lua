...
if minetest.get_modpath("allores_miassite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_miassite:Miassite", {
	description = S("Miassite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_miassite:allores2 1",
	recipe = "allores_miassite:Miassite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
