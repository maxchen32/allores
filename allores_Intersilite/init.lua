...
if minetest.get_modpath("allores_intersilite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_intersilite:Intersilite", {
	description = S("Intersilite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_intersilite:allores2 1",
	recipe = "allores_intersilite:Intersilite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_intersilite:Intersilite",
