allores_rhodochrosite = {}
local S = minetest.get_translator(minetest.get_current_modname())

if minetest.get_modpath("allores_rhodochrosite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rhodochrosite:Rhodochrosite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rhodochrosite:allores2 1",
	recipe = "allores_rhodochrosite:Rhodochrosite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_rhodochrosite:Rhodochrosite",
