...
if minetest.get_modpath("allores_hemihedrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hemihedrite:Hemihedrite", {
	description = S("Hemihedrite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hemihedrite:allores2 1",
	recipe = "allores_hemihedrite:Hemihedrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hemihedrite:Hemihedrite",
