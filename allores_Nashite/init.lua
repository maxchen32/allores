...
if minetest.get_modpath("allores_nashite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nashite:Nashite", {
	description = S("Nashite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nashite:allores2 1",
	recipe = "allores_nashite:Nashite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
