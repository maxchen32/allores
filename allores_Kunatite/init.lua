...
if minetest.get_modpath("allores_kunatite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kunatite:Kunatite", {
	description = S("Kunatite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kunatite:allores2 1",
	recipe = "allores_kunatite:Kunatite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
