...
if minetest.get_modpath("allores_liuite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_liuite:Liuite", {
	description = S("Liuite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_liuite:allores2 1",
	recipe = "allores_liuite:Liuite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
