...
if minetest.get_modpath("allores_pomite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pomite:Pomite", {
	description = S("Pomite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pomite:allores2 1",
	recipe = "allores_pomite:Pomite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
