...
if minetest.get_modpath("allores_tululite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tululite:Tululite", {
	description = S("Tululite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tululite:allores2 1",
	recipe = "allores_tululite:Tululite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
