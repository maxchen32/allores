...
if minetest.get_modpath("allores_hauyne") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hauyne:Hauyne", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hauyne:allores2 1",
	recipe = "allores_hauyne:Hauyne",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
