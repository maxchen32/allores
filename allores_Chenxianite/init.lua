...
if minetest.get_modpath("allores_chenxianite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chenxianite:Chenxianite", {
	description = S("Chenxianite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chenxianite:allores2 1",
	recipe = "allores_chenxianite:Chenxianite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chenxianite:Chenxianite",
