...
if minetest.get_modpath("allores_insizwaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_insizwaite:Insizwaite", {
	description = S("Insizwaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_insizwaite:allores2 1",
	recipe = "allores_insizwaite:Insizwaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_insizwaite:Insizwaite",
