...
if minetest.get_modpath("allores_iranite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_iranite:Iranite", {
	description = S("Iranite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_iranite:allores2 1",
	recipe = "allores_iranite:Iranite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
