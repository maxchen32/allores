...
if minetest.get_modpath("allores_cadmoselite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cadmoselite:Cadmoselite", {
	description = S("Cadmoselite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cadmoselite:allores2 1",
	recipe = "allores_cadmoselite:Cadmoselite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_cadmoselite:Cadmoselite",
