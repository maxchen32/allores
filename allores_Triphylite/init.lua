...
if minetest.get_modpath("allores_triphylite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_triphylite:Triphylite", {
	description = S("Triphylite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_triphylite:allores2 1",
	recipe = "allores_triphylite:Triphylite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_triphylite:Triphylite",
