...
if minetest.get_modpath("allores_boggsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_boggsite:Boggsite", {
	description = S("Boggsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_boggsite:allores2 1",
	recipe = "allores_boggsite:Boggsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
