...
if minetest.get_modpath("allores_pollucite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pollucite:Pollucite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pollucite:allores2 1",
	recipe = "allores_pollucite:Pollucite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_pollucite:Pollucite",
