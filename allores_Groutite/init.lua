...
if minetest.get_modpath("allores_groutite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_groutite:Groutite", {
	description = S("Groutite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_groutite:allores2 1",
	recipe = "allores_groutite:Groutite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
