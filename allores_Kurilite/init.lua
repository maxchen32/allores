...
if minetest.get_modpath("allores_kurilite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kurilite:Kurilite", {
	description = S("Kurilite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kurilite:allores2 1",
	recipe = "allores_kurilite:Kurilite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
