...
if minetest.get_modpath("allores_biehlite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_biehlite:Biehlite", {
	description = S("Biehlite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_biehlite:allores2 1",
	recipe = "allores_biehlite:Biehlite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
