...
if minetest.get_modpath("allores_chibaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chibaite:Chibaite", {
	description = S("Chibaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chibaite:allores2 1",
	recipe = "allores_chibaite:Chibaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
