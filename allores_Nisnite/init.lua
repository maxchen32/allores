...
if minetest.get_modpath("allores_nisnite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nisnite:Nisnite", {
	description = S("Nisnite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nisnite:allores2 1",
	recipe = "allores_nisnite:Nisnite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
