...
if minetest.get_modpath("allores_laueite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_laueite:Laueite", {
	description = S("Laueite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_laueite:allores2 1",
	recipe = "allores_laueite:Laueite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
