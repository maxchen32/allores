...
if minetest.get_modpath("allores_yukonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_yukonite:Yukonite", {
	description = S("Yukonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_yukonite:allores2 1",
	recipe = "allores_yukonite:Yukonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
