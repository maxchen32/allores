...
if minetest.get_modpath("allores_kyzylkumite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kyzylkumite:Kyzylkumite", {
	description = S("Kyzylkumite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kyzylkumite:allores2 1",
	recipe = "allores_kyzylkumite:Kyzylkumite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kyzylkumite:Kyzylkumite",
