...
if minetest.get_modpath("allores_erazoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_erazoite:Erazoite", {
	description = S("Erazoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_erazoite:allores2 1",
	recipe = "allores_erazoite:Erazoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
