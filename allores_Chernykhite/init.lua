...
if minetest.get_modpath("allores_chernykhite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chernykhite:Chernykhite", {
	description = S("Chernykhite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chernykhite:allores2 1",
	recipe = "allores_chernykhite:Chernykhite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chernykhite:Chernykhite",
