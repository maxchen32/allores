...
if minetest.get_modpath("allores_jeankempite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jeankempite:Jeankempite", {
	description = S("Jeankempite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jeankempite:allores2 1",
	recipe = "allores_jeankempite:Jeankempite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_jeankempite:Jeankempite",
