...
if minetest.get_modpath("allores_zykaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zykaite:Zykaite", {
	description = S("Zykaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zykaite:allores2 1",
	recipe = "allores_zykaite:Zykaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
