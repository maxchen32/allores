...
if minetest.get_modpath("allores_crandallite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_crandallite:Crandallite", {
	description = S("Crandallite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_crandallite:allores2 1",
	recipe = "allores_crandallite:Crandallite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_crandallite:Crandallite",
