...
if minetest.get_modpath("allores_griphite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_griphite:Griphite", {
	description = S("Griphite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_griphite:allores2 1",
	recipe = "allores_griphite:Griphite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
