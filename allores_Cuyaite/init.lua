...
if minetest.get_modpath("allores_cuyaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cuyaite:Cuyaite", {
	description = S("Cuyaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cuyaite:allores2 1",
	recipe = "allores_cuyaite:Cuyaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
