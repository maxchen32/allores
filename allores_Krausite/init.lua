...
if minetest.get_modpath("allores_krausite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_krausite:Krausite", {
	description = S("Krausite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_krausite:allores2 1",
	recipe = "allores_krausite:Krausite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
