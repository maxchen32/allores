...
if minetest.get_modpath("allores_iwakiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_iwakiite:Iwakiite", {
	description = S("Iwakiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_iwakiite:allores2 1",
	recipe = "allores_iwakiite:Iwakiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
