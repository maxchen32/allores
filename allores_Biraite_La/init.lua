...
if minetest.get_modpath("allores_biraite_la") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_biraite_la:Biraite_La", {
	description = S("Biraite_La") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_biraite_la:allores2 1",
	recipe = "allores_biraite_la:Biraite_La",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_biraite_la:Biraite_La",
