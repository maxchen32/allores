...
if minetest.get_modpath("allores_seidozerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_seidozerite:Seidozerite", {
	description = S("Seidozerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_seidozerite:allores2 1",
	recipe = "allores_seidozerite:Seidozerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_seidozerite:Seidozerite",
