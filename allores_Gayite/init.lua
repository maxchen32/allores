...
if minetest.get_modpath("allores_gayite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gayite:Gayite", {
	description = S("Gayite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gayite:allores2 1",
	recipe = "allores_gayite:Gayite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
