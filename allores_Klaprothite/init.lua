...
if minetest.get_modpath("allores_klaprothite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_klaprothite:Klaprothite", {
	description = S("Klaprothite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_klaprothite:allores2 1",
	recipe = "allores_klaprothite:Klaprothite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_klaprothite:Klaprothite",
