...
if minetest.get_modpath("allores_camerolaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_camerolaite:Camerolaite", {
	description = S("Camerolaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_camerolaite:allores2 1",
	recipe = "allores_camerolaite:Camerolaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_camerolaite:Camerolaite",
