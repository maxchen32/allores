...
if minetest.get_modpath("allores_buserite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_buserite:Buserite", {
	description = S("Buserite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_buserite:allores2 1",
	recipe = "allores_buserite:Buserite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
