...
if minetest.get_modpath("allores_torbernite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_torbernite:Torbernite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_torbernite:allores2 1",
	recipe = "allores_torbernite:Torbernite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_torbernite:Torbernite",
