...
if minetest.get_modpath("allores_ishikawaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ishikawaite:Ishikawaite", {
	description = S("Ishikawaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ishikawaite:allores2 1",
	recipe = "allores_ishikawaite:Ishikawaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ishikawaite:Ishikawaite",
