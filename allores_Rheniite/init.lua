...
if minetest.get_modpath("allores_rheniite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rheniite:Rheniite", {
	description = S("Rheniite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rheniite:allores2 1",
	recipe = "allores_rheniite:Rheniite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
