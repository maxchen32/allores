...
if minetest.get_modpath("allores_dolomite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dolomite:Dolomite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dolomite:allores2 1",
	recipe = "allores_dolomite:Dolomite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
