...
if minetest.get_modpath("allores_povondraite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_povondraite:Povondraite", {
	description = S("Povondraite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_povondraite:allores2 1",
	recipe = "allores_povondraite:Povondraite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_povondraite:Povondraite",
