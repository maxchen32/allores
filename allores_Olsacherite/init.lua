...
if minetest.get_modpath("allores_olsacherite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_olsacherite:Olsacherite", {
	description = S("Olsacherite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_olsacherite:allores2 1",
	recipe = "allores_olsacherite:Olsacherite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_olsacherite:Olsacherite",
