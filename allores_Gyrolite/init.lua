...
if minetest.get_modpath("allores_gyrolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gyrolite:Gyrolite", {
	description = S("Gyrolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gyrolite:allores2 1",
	recipe = "allores_gyrolite:Gyrolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
