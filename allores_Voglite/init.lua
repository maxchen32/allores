...
if minetest.get_modpath("allores_voglite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_voglite:Voglite", {
	description = S("Voglite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_voglite:allores2 1",
	recipe = "allores_voglite:Voglite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
