...
if minetest.get_modpath("allores_veatchite_p") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_veatchite_p:Veatchite_p", {
	description = S("Veatchite_p") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_veatchite_p:allores2 1",
	recipe = "allores_veatchite_p:Veatchite_p",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_veatchite_p:Veatchite_p",
