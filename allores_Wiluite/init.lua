...
if minetest.get_modpath("allores_wiluite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wiluite:Wiluite", {
	description = S("Wiluite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wiluite:allores2 1",
	recipe = "allores_wiluite:Wiluite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
