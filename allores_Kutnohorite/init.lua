...
if minetest.get_modpath("allores_kutnohorite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kutnohorite:Kutnohorite", {
	description = S("Kutnohorite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kutnohorite:allores2 1",
	recipe = "allores_kutnohorite:Kutnohorite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kutnohorite:Kutnohorite",
