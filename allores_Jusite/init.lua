...
if minetest.get_modpath("allores_jusite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jusite:Jusite", {
	description = S("Jusite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jusite:allores2 1",
	recipe = "allores_jusite:Jusite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
