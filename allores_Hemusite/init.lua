...
if minetest.get_modpath("allores_hemusite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hemusite:Hemusite", {
	description = S("Hemusite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hemusite:allores2 1",
	recipe = "allores_hemusite:Hemusite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
