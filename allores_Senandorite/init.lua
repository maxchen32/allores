...
if minetest.get_modpath("allores_senandorite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_senandorite:Senandorite", {
	description = S("Senandorite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_senandorite:allores2 1",
	recipe = "allores_senandorite:Senandorite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_senandorite:Senandorite",
