...
if minetest.get_modpath("allores_zincomenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zincomenite:Zincomenite", {
	description = S("Zincomenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zincomenite:allores2 1",
	recipe = "allores_zincomenite:Zincomenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_zincomenite:Zincomenite",
