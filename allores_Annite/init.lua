...
if minetest.get_modpath("allores_annite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_annite:Annite", {
	description = S("Annite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_annite:allores2 1",
	recipe = "allores_annite:Annite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
