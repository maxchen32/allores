...
if minetest.get_modpath("allores_stronalsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_stronalsite:Stronalsite", {
	description = S("Stronalsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_stronalsite:allores2 1",
	recipe = "allores_stronalsite:Stronalsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_stronalsite:Stronalsite",
