...
if minetest.get_modpath("allores_eulytine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_eulytine:Eulytine", {
	description = S("Eulytine") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_eulytine:allores2 1",
	recipe = "allores_eulytine:Eulytine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
