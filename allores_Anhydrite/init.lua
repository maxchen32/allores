...
if minetest.get_modpath("allores_anhydrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_anhydrite:Anhydrite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_anhydrite:allores2 1",
	recipe = "allores_anhydrite:Anhydrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_anhydrite:Anhydrite",
