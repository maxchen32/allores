...
if minetest.get_modpath("allores_paracelsian") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_paracelsian:Paracelsian", {
	description = S("Paracelsian") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_paracelsian:allores2 1",
	recipe = "allores_paracelsian:Paracelsian",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_paracelsian:Paracelsian",
