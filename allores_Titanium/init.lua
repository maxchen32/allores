...
if minetest.get_modpath("allores_titanium") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_titanium:Titanium", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_titanium:allores2 1",
	recipe = "allores_titanium:Titanium",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
