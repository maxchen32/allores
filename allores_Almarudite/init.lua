...
if minetest.get_modpath("allores_almarudite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_almarudite:Almarudite", {
	description = S("Almarudite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_almarudite:allores2 1",
	recipe = "allores_almarudite:Almarudite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_almarudite:Almarudite",
