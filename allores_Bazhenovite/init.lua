...
if minetest.get_modpath("allores_bazhenovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bazhenovite:Bazhenovite", {
	description = S("Bazhenovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bazhenovite:allores2 1",
	recipe = "allores_bazhenovite:Bazhenovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bazhenovite:Bazhenovite",
