...
if minetest.get_modpath("allores_diaspore") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_diaspore:Diaspore", {
	description = S("Diaspore") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_diaspore:allores2 1",
	recipe = "allores_diaspore:Diaspore",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
