...
if minetest.get_modpath("allores_cesanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cesanite:Cesanite", {
	description = S("Cesanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cesanite:allores2 1",
	recipe = "allores_cesanite:Cesanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
