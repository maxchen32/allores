...
if minetest.get_modpath("allores_gorerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gorerite:Gorerite", {
	description = S("Gorerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gorerite:allores2 1",
	recipe = "allores_gorerite:Gorerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
