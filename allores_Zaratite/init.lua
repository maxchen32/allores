...
if minetest.get_modpath("allores_zaratite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zaratite:Zaratite", {
	description = S("Zaratite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zaratite:allores2 1",
	recipe = "allores_zaratite:Zaratite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
