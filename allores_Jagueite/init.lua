...
if minetest.get_modpath("allores_jagueite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jagueite:Jagueite", {
	description = S("Jagueite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jagueite:allores2 1",
	recipe = "allores_jagueite:Jagueite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
