...
if minetest.get_modpath("allores_realgar") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_realgar:Realgar", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_realgar:allores2 1",
	recipe = "allores_realgar:Realgar",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
