...
if minetest.get_modpath("allores_bairdite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bairdite:Bairdite", {
	description = S("Bairdite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bairdite:allores2 1",
	recipe = "allores_bairdite:Bairdite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
