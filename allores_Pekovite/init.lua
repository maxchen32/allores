...
if minetest.get_modpath("allores_pekovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pekovite:Pekovite", {
	description = S("Pekovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pekovite:allores2 1",
	recipe = "allores_pekovite:Pekovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
