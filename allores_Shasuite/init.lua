...
if minetest.get_modpath("allores_shasuite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_shasuite:Shasuite", {
	description = S("Shasuite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_shasuite:allores2 1",
	recipe = "allores_shasuite:Shasuite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
