...
if minetest.get_modpath("allores_ognitite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ognitite:Ognitite", {
	description = S("Ognitite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ognitite:allores2 1",
	recipe = "allores_ognitite:Ognitite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
