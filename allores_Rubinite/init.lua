...
if minetest.get_modpath("allores_rubinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rubinite:Rubinite", {
	description = S("Rubinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rubinite:allores2 1",
	recipe = "allores_rubinite:Rubinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
