...
if minetest.get_modpath("allores_ellisite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ellisite:Ellisite", {
	description = S("Ellisite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ellisite:allores2 1",
	recipe = "allores_ellisite:Ellisite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
