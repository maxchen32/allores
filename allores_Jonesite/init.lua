...
if minetest.get_modpath("allores_jonesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jonesite:Jonesite", {
	description = S("Jonesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jonesite:allores2 1",
	recipe = "allores_jonesite:Jonesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
