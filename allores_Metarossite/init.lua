...
if minetest.get_modpath("allores_metarossite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_metarossite:Metarossite", {
	description = S("Metarossite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_metarossite:allores2 1",
	recipe = "allores_metarossite:Metarossite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_metarossite:Metarossite",
