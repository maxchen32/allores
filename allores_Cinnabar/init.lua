...
if minetest.get_modpath("allores_cinnabar") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cinnabar:Cinnabar", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cinnabar:allores2 1",
	recipe = "allores_cinnabar:Cinnabar",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
