...
if minetest.get_modpath("allores_anorpiment") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_anorpiment:Anorpiment", {
	description = S("Anorpiment") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_anorpiment:allores2 1",
	recipe = "allores_anorpiment:Anorpiment",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_anorpiment:Anorpiment",
