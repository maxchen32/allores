...
if minetest.get_modpath("allores_eyselite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_eyselite:Eyselite", {
	description = S("Eyselite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_eyselite:allores2 1",
	recipe = "allores_eyselite:Eyselite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
