...
if minetest.get_modpath("allores_jonassonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jonassonite:Jonassonite", {
	description = S("Jonassonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jonassonite:allores2 1",
	recipe = "allores_jonassonite:Jonassonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_jonassonite:Jonassonite",
