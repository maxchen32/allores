...
if minetest.get_modpath("allores_greenockite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_greenockite:Greenockite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_greenockite:allores2 1",
	recipe = "allores_greenockite:Greenockite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_greenockite:Greenockite",
