...
if minetest.get_modpath("allores_townendite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_townendite:Townendite", {
	description = S("Townendite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_townendite:allores2 1",
	recipe = "allores_townendite:Townendite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_townendite:Townendite",
