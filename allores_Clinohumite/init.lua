...
if minetest.get_modpath("allores_clinohumite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_clinohumite:Clinohumite", {
	description = S("Clinohumite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_clinohumite:allores2 1",
	recipe = "allores_clinohumite:Clinohumite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_clinohumite:Clinohumite",
