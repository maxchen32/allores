...
if minetest.get_modpath("allores_scorticoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_scorticoite:Scorticoite", {
	description = S("Scorticoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_scorticoite:allores2 1",
	recipe = "allores_scorticoite:Scorticoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_scorticoite:Scorticoite",
