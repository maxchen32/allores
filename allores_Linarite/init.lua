...
if minetest.get_modpath("allores_linarite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_linarite:Linarite", {
	description = S("Linarite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_linarite:allores2 1",
	recipe = "allores_linarite:Linarite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
