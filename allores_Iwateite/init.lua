...
if minetest.get_modpath("allores_iwateite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_iwateite:Iwateite", {
	description = S("Iwateite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_iwateite:allores2 1",
	recipe = "allores_iwateite:Iwateite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
