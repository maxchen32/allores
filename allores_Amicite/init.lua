...
if minetest.get_modpath("allores_amicite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_amicite:Amicite", {
	description = S("Amicite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_amicite:allores2 1",
	recipe = "allores_amicite:Amicite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
