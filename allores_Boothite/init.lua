...
if minetest.get_modpath("allores_boothite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_boothite:Boothite", {
	description = S("Boothite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_boothite:allores2 1",
	recipe = "allores_boothite:Boothite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
