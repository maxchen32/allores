...
if minetest.get_modpath("allores_sassite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sassite:Sassite", {
	description = S("Sassite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sassite:allores2 1",
	recipe = "allores_sassite:Sassite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
