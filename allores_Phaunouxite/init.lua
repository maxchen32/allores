...
if minetest.get_modpath("allores_phaunouxite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_phaunouxite:Phaunouxite", {
	description = S("Phaunouxite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_phaunouxite:allores2 1",
	recipe = "allores_phaunouxite:Phaunouxite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_phaunouxite:Phaunouxite",
