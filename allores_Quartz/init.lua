...
if minetest.get_modpath("allores_quartz") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_quartz:Quartz", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_quartz:allores2 1",
	recipe = "allores_quartz:Quartz",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
