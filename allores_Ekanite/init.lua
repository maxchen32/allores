...
if minetest.get_modpath("allores_ekanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ekanite:Ekanite", {
	description = S("Ekanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ekanite:allores2 1",
	recipe = "allores_ekanite:Ekanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
