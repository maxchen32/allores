...
if minetest.get_modpath("allores_saponite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_saponite:Saponite", {
	description = S("Saponite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_saponite:allores2 1",
	recipe = "allores_saponite:Saponite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
