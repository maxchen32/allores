...
if minetest.get_modpath("allores_schorl") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_schorl:Schorl", {
	description = S("Schorl") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_schorl:allores2 1",
	recipe = "allores_schorl:Schorl",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
