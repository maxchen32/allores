...
if minetest.get_modpath("allores_elbaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_elbaite:Elbaite", {
	description = S("Elbaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_elbaite:allores2 1",
	recipe = "allores_elbaite:Elbaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
