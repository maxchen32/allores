...
if minetest.get_modpath("allores_howlite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_howlite:Howlite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_howlite:allores2 1",
	recipe = "allores_howlite:Howlite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
