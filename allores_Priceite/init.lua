...
if minetest.get_modpath("allores_priceite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_priceite:Priceite", {
	description = S("Priceite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_priceite:allores2 1",
	recipe = "allores_priceite:Priceite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
