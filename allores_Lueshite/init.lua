...
if minetest.get_modpath("allores_lueshite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lueshite:Lueshite", {
	description = S("Lueshite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lueshite:allores2 1",
	recipe = "allores_lueshite:Lueshite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
