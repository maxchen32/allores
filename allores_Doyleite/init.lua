...
if minetest.get_modpath("allores_doyleite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_doyleite:Doyleite", {
	description = S("Doyleite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_doyleite:allores2 1",
	recipe = "allores_doyleite:Doyleite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
