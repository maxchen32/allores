...
if minetest.get_modpath("allores_orpiment") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_orpiment:Orpiment", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_orpiment:allores2 1",
	recipe = "allores_orpiment:Orpiment",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
