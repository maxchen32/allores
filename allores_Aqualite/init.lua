...
if minetest.get_modpath("allores_aqualite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_aqualite:Aqualite", {
	description = S("Aqualite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_aqualite:allores2 1",
	recipe = "allores_aqualite:Aqualite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
