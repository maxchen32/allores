...
if minetest.get_modpath("allores_sharpite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sharpite:Sharpite", {
	description = S("Sharpite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sharpite:allores2 1",
	recipe = "allores_sharpite:Sharpite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
