...
if minetest.get_modpath("allores_olenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_olenite:Olenite", {
	description = S("Olenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_olenite:allores2 1",
	recipe = "allores_olenite:Olenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
