...
if minetest.get_modpath("allores_mooreite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mooreite:Mooreite", {
	description = S("Mooreite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mooreite:allores2 1",
	recipe = "allores_mooreite:Mooreite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
