...
if minetest.get_modpath("allores_brass") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_brass:Brass", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_brass:allores2 1",
	recipe = "allores_brass:Brass",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
