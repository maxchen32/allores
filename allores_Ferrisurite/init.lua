...
if minetest.get_modpath("allores_ferrisurite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ferrisurite:Ferrisurite", {
	description = S("Ferrisurite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ferrisurite:allores2 1",
	recipe = "allores_ferrisurite:Ferrisurite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ferrisurite:Ferrisurite",
