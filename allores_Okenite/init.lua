...
if minetest.get_modpath("allores_okenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_okenite:Okenite", {
	description = S("Okenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_okenite:allores2 1",
	recipe = "allores_okenite:Okenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
