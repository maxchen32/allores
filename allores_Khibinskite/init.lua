...
if minetest.get_modpath("allores_khibinskite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_khibinskite:Khibinskite", {
	description = S("Khibinskite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_khibinskite:allores2 1",
	recipe = "allores_khibinskite:Khibinskite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_khibinskite:Khibinskite",
