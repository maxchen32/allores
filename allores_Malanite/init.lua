...
if minetest.get_modpath("allores_malanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_malanite:Malanite", {
	description = S("Malanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_malanite:allores2 1",
	recipe = "allores_malanite:Malanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
