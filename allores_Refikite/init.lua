...
if minetest.get_modpath("allores_refikite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_refikite:Refikite", {
	description = S("Refikite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_refikite:allores2 1",
	recipe = "allores_refikite:Refikite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
