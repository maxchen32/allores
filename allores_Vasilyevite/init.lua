...
if minetest.get_modpath("allores_vasilyevite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vasilyevite:Vasilyevite", {
	description = S("Vasilyevite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vasilyevite:allores2 1",
	recipe = "allores_vasilyevite:Vasilyevite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_vasilyevite:Vasilyevite",
