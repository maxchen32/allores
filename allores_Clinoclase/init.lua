...
if minetest.get_modpath("allores_clinoclase") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_clinoclase:Clinoclase", {
	description = S("Clinoclase") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_clinoclase:allores2 1",
	recipe = "allores_clinoclase:Clinoclase",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_clinoclase:Clinoclase",
