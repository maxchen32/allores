...
if minetest.get_modpath("allores_elyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_elyite:Elyite", {
	description = S("Elyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_elyite:allores2 1",
	recipe = "allores_elyite:Elyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
