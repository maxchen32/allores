...
if minetest.get_modpath("allores_surite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_surite:Surite", {
	description = S("Surite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_surite:allores2 1",
	recipe = "allores_surite:Surite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
