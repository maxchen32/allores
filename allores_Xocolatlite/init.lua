...
if minetest.get_modpath("allores_xocolatlite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_xocolatlite:Xocolatlite", {
	description = S("Xocolatlite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_xocolatlite:allores2 1",
	recipe = "allores_xocolatlite:Xocolatlite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_xocolatlite:Xocolatlite",
