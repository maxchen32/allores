...
if minetest.get_modpath("allores_ursilite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ursilite:Ursilite", {
	description = S("Ursilite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ursilite:allores2 1",
	recipe = "allores_ursilite:Ursilite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
