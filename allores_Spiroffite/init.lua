...
if minetest.get_modpath("allores_spiroffite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_spiroffite:Spiroffite", {
	description = S("Spiroffite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_spiroffite:allores2 1",
	recipe = "allores_spiroffite:Spiroffite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_spiroffite:Spiroffite",
