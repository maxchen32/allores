...
if minetest.get_modpath("allores_mohrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mohrite:Mohrite", {
	description = S("Mohrite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mohrite:allores2 1",
	recipe = "allores_mohrite:Mohrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
