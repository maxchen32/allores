...
if minetest.get_modpath("allores_nabesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nabesite:Nabesite", {
	description = S("Nabesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nabesite:allores2 1",
	recipe = "allores_nabesite:Nabesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
