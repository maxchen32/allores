...
if minetest.get_modpath("allores_teallite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_teallite:Teallite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_teallite:allores2 1",
	recipe = "allores_teallite:Teallite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
