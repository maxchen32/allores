...
if minetest.get_modpath("allores_weissite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_weissite:Weissite", {
	description = S("Weissite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_weissite:allores2 1",
	recipe = "allores_weissite:Weissite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
