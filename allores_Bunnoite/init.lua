...
if minetest.get_modpath("allores_bunnoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bunnoite:Bunnoite", {
	description = S("Bunnoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bunnoite:allores2 1",
	recipe = "allores_bunnoite:Bunnoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
