...
if minetest.get_modpath("allores_smirnite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_smirnite:Smirnite", {
	description = S("Smirnite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_smirnite:allores2 1",
	recipe = "allores_smirnite:Smirnite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
