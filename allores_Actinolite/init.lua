...
if minetest.get_modpath("allores_actinolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_actinolite:Actinolite", {
	description = S("Actinolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_actinolite:allores2 1",
	recipe = "allores_actinolite:Actinolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_actinolite:Actinolite",
