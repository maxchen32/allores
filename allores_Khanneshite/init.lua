...
if minetest.get_modpath("allores_khanneshite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_khanneshite:Khanneshite", {
	description = S("Khanneshite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_khanneshite:allores2 1",
	recipe = "allores_khanneshite:Khanneshite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_khanneshite:Khanneshite",
