...
if minetest.get_modpath("allores_ikranite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ikranite:Ikranite", {
	description = S("Ikranite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ikranite:allores2 1",
	recipe = "allores_ikranite:Ikranite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
