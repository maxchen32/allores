...
if minetest.get_modpath("allores_betzite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_betzite:Betzite", {
	description = S("Betzite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_betzite:allores2 1",
	recipe = "allores_betzite:Betzite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
