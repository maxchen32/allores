...
if minetest.get_modpath("allores_huntite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_huntite:Huntite", {
	description = S("Huntite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_huntite:allores2 1",
	recipe = "allores_huntite:Huntite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
