...
if minetest.get_modpath("allores_perite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_perite:Perite", {
	description = S("Perite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_perite:allores2 1",
	recipe = "allores_perite:Perite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
