...
if minetest.get_modpath("allores_selenium") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_selenium:Selenium", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_selenium:allores2 1",
	recipe = "allores_selenium:Selenium",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
