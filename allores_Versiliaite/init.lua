...
if minetest.get_modpath("allores_versiliaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_versiliaite:Versiliaite", {
	description = S("Versiliaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_versiliaite:allores2 1",
	recipe = "allores_versiliaite:Versiliaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_versiliaite:Versiliaite",
