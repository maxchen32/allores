...
if minetest.get_modpath("allores_cejkaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cejkaite:Cejkaite", {
	description = S("Cejkaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cejkaite:allores2 1",
	recipe = "allores_cejkaite:Cejkaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
