...
if minetest.get_modpath("allores_hulsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hulsite:Hulsite", {
	description = S("Hulsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hulsite:allores2 1",
	recipe = "allores_hulsite:Hulsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
