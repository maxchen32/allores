...
if minetest.get_modpath("allores_schoonerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_schoonerite:Schoonerite", {
	description = S("Schoonerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_schoonerite:allores2 1",
	recipe = "allores_schoonerite:Schoonerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_schoonerite:Schoonerite",
