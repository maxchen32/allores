...
if minetest.get_modpath("allores_kamitugaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kamitugaite:Kamitugaite", {
	description = S("Kamitugaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kamitugaite:allores2 1",
	recipe = "allores_kamitugaite:Kamitugaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kamitugaite:Kamitugaite",
