...
if minetest.get_modpath("allores_picromerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_picromerite:Picromerite", {
	description = S("Picromerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_picromerite:allores2 1",
	recipe = "allores_picromerite:Picromerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_picromerite:Picromerite",
