...
if minetest.get_modpath("allores_pyrope") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pyrope:Pyrope", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pyrope:allores2 1",
	recipe = "allores_pyrope:Pyrope",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
