...
if minetest.get_modpath("allores_apachite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_apachite:Apachite", {
	description = S("Apachite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_apachite:allores2 1",
	recipe = "allores_apachite:Apachite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
