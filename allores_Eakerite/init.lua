...
if minetest.get_modpath("allores_eakerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_eakerite:Eakerite", {
	description = S("Eakerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_eakerite:allores2 1",
	recipe = "allores_eakerite:Eakerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
