...
if minetest.get_modpath("allores_bismuth") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bismuth:Bismuth", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bismuth:allores2 1",
	recipe = "allores_bismuth:Bismuth",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
