...
if minetest.get_modpath("allores_girdite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_girdite:Girdite", {
	description = S("Girdite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_girdite:allores2 1",
	recipe = "allores_girdite:Girdite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
