...
if minetest.get_modpath("allores_rhomboclase") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rhomboclase:Rhomboclase", {
	description = S("Rhomboclase") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rhomboclase:allores2 1",
	recipe = "allores_rhomboclase:Rhomboclase",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_rhomboclase:Rhomboclase",
