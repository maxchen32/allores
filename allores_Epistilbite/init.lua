...
if minetest.get_modpath("allores_epistilbite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_epistilbite:Epistilbite", {
	description = S("Epistilbite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_epistilbite:allores2 1",
	recipe = "allores_epistilbite:Epistilbite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_epistilbite:Epistilbite",
