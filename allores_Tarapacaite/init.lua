...
if minetest.get_modpath("allores_tarapacaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tarapacaite:Tarapacaite", {
	description = S("Tarapacaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tarapacaite:allores2 1",
	recipe = "allores_tarapacaite:Tarapacaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_tarapacaite:Tarapacaite",
