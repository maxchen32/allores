...
if minetest.get_modpath("allores_epididymite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_epididymite:Epididymite", {
	description = S("Epididymite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_epididymite:allores2 1",
	recipe = "allores_epididymite:Epididymite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_epididymite:Epididymite",
