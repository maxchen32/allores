...
if minetest.get_modpath("allores_cohenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cohenite:Cohenite", {
	description = S("Cohenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cohenite:allores2 1",
	recipe = "allores_cohenite:Cohenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
