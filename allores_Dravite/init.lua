...
if minetest.get_modpath("allores_dravite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dravite:Dravite", {
	description = S("Dravite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dravite:allores2 1",
	recipe = "allores_dravite:Dravite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
