...
if minetest.get_modpath("allores_coalingite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_coalingite:Coalingite", {
	description = S("Coalingite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_coalingite:allores2 1",
	recipe = "allores_coalingite:Coalingite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_coalingite:Coalingite",
