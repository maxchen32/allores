...
if minetest.get_modpath("allores_vanalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vanalite:Vanalite", {
	description = S("Vanalite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vanalite:allores2 1",
	recipe = "allores_vanalite:Vanalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
