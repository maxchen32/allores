...
if minetest.get_modpath("allores_dwornikite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dwornikite:Dwornikite", {
	description = S("Dwornikite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dwornikite:allores2 1",
	recipe = "allores_dwornikite:Dwornikite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_dwornikite:Dwornikite",
