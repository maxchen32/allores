...
if minetest.get_modpath("allores_fletcherite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fletcherite:Fletcherite", {
	description = S("Fletcherite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fletcherite:allores2 1",
	recipe = "allores_fletcherite:Fletcherite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_fletcherite:Fletcherite",
