...
if minetest.get_modpath("allores_donowensite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_donowensite:Donowensite", {
	description = S("Donowensite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_donowensite:allores2 1",
	recipe = "allores_donowensite:Donowensite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_donowensite:Donowensite",
