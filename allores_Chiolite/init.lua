...
if minetest.get_modpath("allores_chiolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chiolite:Chiolite", {
	description = S("Chiolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chiolite:allores2 1",
	recipe = "allores_chiolite:Chiolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
