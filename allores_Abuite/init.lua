...
if minetest.get_modpath("allores_abuite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_abuite:Abuite", {
	description = S("Abuite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_abuite:allores2 1",
	recipe = "allores_abuite:Abuite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
