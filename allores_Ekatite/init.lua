...
if minetest.get_modpath("allores_ekatite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ekatite:Ekatite", {
	description = S("Ekatite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ekatite:allores2 1",
	recipe = "allores_ekatite:Ekatite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
