...
if minetest.get_modpath("allores_ardaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ardaite:Ardaite", {
	description = S("Ardaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ardaite:allores2 1",
	recipe = "allores_ardaite:Ardaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
