...
if minetest.get_modpath("allores_ziroite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ziroite:Ziroite", {
	description = S("Ziroite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ziroite:allores2 1",
	recipe = "allores_ziroite:Ziroite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
