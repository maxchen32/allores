...
if minetest.get_modpath("allores_potarite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_potarite:Potarite", {
	description = S("Potarite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_potarite:allores2 1",
	recipe = "allores_potarite:Potarite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
