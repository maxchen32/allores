...
if minetest.get_modpath("allores_natanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_natanite:Natanite", {
	description = S("Natanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_natanite:allores2 1",
	recipe = "allores_natanite:Natanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
