...
if minetest.get_modpath("allores_iquiqueite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_iquiqueite:Iquiqueite", {
	description = S("Iquiqueite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_iquiqueite:allores2 1",
	recipe = "allores_iquiqueite:Iquiqueite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_iquiqueite:Iquiqueite",
