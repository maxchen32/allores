...
if minetest.get_modpath("allores_gugiaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gugiaite:Gugiaite", {
	description = S("Gugiaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gugiaite:allores2 1",
	recipe = "allores_gugiaite:Gugiaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
