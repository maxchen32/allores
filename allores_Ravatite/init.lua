...
if minetest.get_modpath("allores_ravatite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ravatite:Ravatite", {
	description = S("Ravatite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ravatite:allores2 1",
	recipe = "allores_ravatite:Ravatite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
