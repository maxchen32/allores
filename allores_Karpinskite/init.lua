...
if minetest.get_modpath("allores_karpinskite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_karpinskite:Karpinskite", {
	description = S("Karpinskite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_karpinskite:allores2 1",
	recipe = "allores_karpinskite:Karpinskite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_karpinskite:Karpinskite",
