...
if minetest.get_modpath("allores_megawite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_megawite:Megawite", {
	description = S("Megawite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_megawite:allores2 1",
	recipe = "allores_megawite:Megawite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
