...
if minetest.get_modpath("allores_poughite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_poughite:Poughite", {
	description = S("Poughite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_poughite:allores2 1",
	recipe = "allores_poughite:Poughite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
