...
if minetest.get_modpath("allores_voggite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_voggite:Voggite", {
	description = S("Voggite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_voggite:allores2 1",
	recipe = "allores_voggite:Voggite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
