...
if minetest.get_modpath("allores_rathite_iv") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rathite_iv:Rathite_IV", {
	description = S("Rathite_IV") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rathite_iv:allores2 1",
	recipe = "allores_rathite_iv:Rathite_IV",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_rathite_iv:Rathite_IV",
