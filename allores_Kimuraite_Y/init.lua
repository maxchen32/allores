...
if minetest.get_modpath("allores_kimuraite_y") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kimuraite_y:Kimuraite_Y", {
	description = S("Kimuraite_Y") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kimuraite_y:allores2 1",
	recipe = "allores_kimuraite_y:Kimuraite_Y",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kimuraite_y:Kimuraite_Y",
