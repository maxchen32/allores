...
if minetest.get_modpath("allores_anandite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_anandite:Anandite", {
	description = S("Anandite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_anandite:allores2 1",
	recipe = "allores_anandite:Anandite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
