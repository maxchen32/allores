...
if minetest.get_modpath("allores_ilesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ilesite:Ilesite", {
	description = S("Ilesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ilesite:allores2 1",
	recipe = "allores_ilesite:Ilesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
