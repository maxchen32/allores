...
if minetest.get_modpath("allores_wittiteb") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wittiteb:WittiteB", {
	description = S("WittiteB") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wittiteb:allores2 1",
	recipe = "allores_wittiteb:WittiteB",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
