...
if minetest.get_modpath("allores_keilite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_keilite:Keilite", {
	description = S("Keilite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_keilite:allores2 1",
	recipe = "allores_keilite:Keilite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
