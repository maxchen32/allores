...
if minetest.get_modpath("allores_beusite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_beusite:Beusite", {
	description = S("Beusite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_beusite:allores2 1",
	recipe = "allores_beusite:Beusite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
