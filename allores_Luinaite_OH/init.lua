...
if minetest.get_modpath("allores_luinaite_oh") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_luinaite_oh:Luinaite_OH", {
	description = S("Luinaite_OH") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_luinaite_oh:allores2 1",
	recipe = "allores_luinaite_oh:Luinaite_OH",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_luinaite_oh:Luinaite_OH",
