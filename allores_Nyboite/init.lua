...
if minetest.get_modpath("allores_nyboite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nyboite:Nyboite", {
	description = S("Nyboite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nyboite:allores2 1",
	recipe = "allores_nyboite:Nyboite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
