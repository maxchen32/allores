allores_bismuthinite = {}
local S = minetest.get_translator(minetest.get_current_modname())

if minetest.get_modpath("allores_bismuthinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bismuthinite:Bismuthinite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bismuthinite:allores2 1",
	recipe = "allores_bismuthinite:Bismuthinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bismuthinite:Bismuthinite",
