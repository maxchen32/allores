...
if minetest.get_modpath("allores_orickite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_orickite:Orickite", {
	description = S("Orickite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_orickite:allores2 1",
	recipe = "allores_orickite:Orickite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
