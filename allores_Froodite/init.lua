...
if minetest.get_modpath("allores_froodite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_froodite:Froodite", {
	description = S("Froodite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_froodite:allores2 1",
	recipe = "allores_froodite:Froodite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
