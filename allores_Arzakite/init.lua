...
if minetest.get_modpath("allores_arzakite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_arzakite:Arzakite", {
	description = S("Arzakite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_arzakite:allores2 1",
	recipe = "allores_arzakite:Arzakite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
