...
if minetest.get_modpath("allores_mieite_y") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mieite_y:Mieite_Y", {
	description = S("Mieite_Y") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mieite_y:allores2 1",
	recipe = "allores_mieite_y:Mieite_Y",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
