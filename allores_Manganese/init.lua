...
if minetest.get_modpath("allores_manganese") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_manganese:Manganese", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_manganese:allores2 1",
	recipe = "allores_manganese:Manganese",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_manganese:Manganese",
