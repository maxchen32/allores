...
if minetest.get_modpath("allores_jamesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jamesite:Jamesite", {
	description = S("Jamesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jamesite:allores2 1",
	recipe = "allores_jamesite:Jamesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
