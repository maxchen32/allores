...
if minetest.get_modpath("allores_humite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_humite:Humite", {
	description = S("Humite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_humite:allores2 1",
	recipe = "allores_humite:Humite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
