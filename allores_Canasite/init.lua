...
if minetest.get_modpath("allores_canasite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_canasite:Canasite", {
	description = S("Canasite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_canasite:allores2 1",
	recipe = "allores_canasite:Canasite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
