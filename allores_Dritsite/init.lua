...
if minetest.get_modpath("allores_dritsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dritsite:Dritsite", {
	description = S("Dritsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dritsite:allores2 1",
	recipe = "allores_dritsite:Dritsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
