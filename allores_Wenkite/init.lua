...
if minetest.get_modpath("allores_wenkite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wenkite:Wenkite", {
	description = S("Wenkite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wenkite:allores2 1",
	recipe = "allores_wenkite:Wenkite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
