...
if minetest.get_modpath("allores_sellaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sellaite:Sellaite", {
	description = S("Sellaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sellaite:allores2 1",
	recipe = "allores_sellaite:Sellaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
