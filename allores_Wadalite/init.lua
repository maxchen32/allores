...
if minetest.get_modpath("allores_wadalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wadalite:Wadalite", {
	description = S("Wadalite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wadalite:allores2 1",
	recipe = "allores_wadalite:Wadalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
