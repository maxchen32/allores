...
if minetest.get_modpath("allores_hapkeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hapkeite:Hapkeite", {
	description = S("Hapkeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hapkeite:allores2 1",
	recipe = "allores_hapkeite:Hapkeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
