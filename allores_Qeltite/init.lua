...
if minetest.get_modpath("allores_qeltite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_qeltite:Qeltite", {
	description = S("Qeltite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_qeltite:allores2 1",
	recipe = "allores_qeltite:Qeltite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
