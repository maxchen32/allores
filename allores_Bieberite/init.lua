...
if minetest.get_modpath("allores_bieberite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bieberite:Bieberite", {
	description = S("Bieberite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bieberite:allores2 1",
	recipe = "allores_bieberite:Bieberite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bieberite:Bieberite",
