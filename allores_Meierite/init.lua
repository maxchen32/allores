...
if minetest.get_modpath("allores_meierite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_meierite:Meierite", {
	description = S("Meierite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_meierite:allores2 1",
	recipe = "allores_meierite:Meierite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
