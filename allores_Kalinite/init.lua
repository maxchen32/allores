...
if minetest.get_modpath("allores_kalinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kalinite:Kalinite", {
	description = S("Kalinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kalinite:allores2 1",
	recipe = "allores_kalinite:Kalinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
