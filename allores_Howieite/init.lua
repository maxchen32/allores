...
if minetest.get_modpath("allores_howieite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_howieite:Howieite", {
	description = S("Howieite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_howieite:allores2 1",
	recipe = "allores_howieite:Howieite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
