...
if minetest.get_modpath("allores_rostite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rostite:Rostite", {
	description = S("Rostite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rostite:allores2 1",
	recipe = "allores_rostite:Rostite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
