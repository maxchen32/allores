...
if minetest.get_modpath("allores_ramikite_y") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ramikite_y:Ramikite_Y", {
	description = S("Ramikite_Y") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ramikite_y:allores2 1",
	recipe = "allores_ramikite_y:Ramikite_Y",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ramikite_y:Ramikite_Y",
