...
if minetest.get_modpath("allores_kempite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kempite:Kempite", {
	description = S("Kempite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kempite:allores2 1",
	recipe = "allores_kempite:Kempite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
