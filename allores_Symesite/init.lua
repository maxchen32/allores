...
if minetest.get_modpath("allores_symesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_symesite:Symesite", {
	description = S("Symesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_symesite:allores2 1",
	recipe = "allores_symesite:Symesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
