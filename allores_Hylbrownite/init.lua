...
if minetest.get_modpath("allores_hylbrownite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hylbrownite:Hylbrownite", {
	description = S("Hylbrownite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hylbrownite:allores2 1",
	recipe = "allores_hylbrownite:Hylbrownite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hylbrownite:Hylbrownite",
