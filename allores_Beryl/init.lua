...
if minetest.get_modpath("allores_beryl") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_beryl:Beryl", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_beryl:allores2 1",
	recipe = "allores_beryl:Beryl",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
