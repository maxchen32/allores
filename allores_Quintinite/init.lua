...
if minetest.get_modpath("allores_quintinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_quintinite:Quintinite", {
	description = S("Quintinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_quintinite:allores2 1",
	recipe = "allores_quintinite:Quintinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_quintinite:Quintinite",
