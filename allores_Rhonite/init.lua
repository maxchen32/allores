...
if minetest.get_modpath("allores_rhonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rhonite:Rhonite", {
	description = S("Rhonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rhonite:allores2 1",
	recipe = "allores_rhonite:Rhonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
