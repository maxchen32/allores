...
if minetest.get_modpath("allores_geminite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_geminite:Geminite", {
	description = S("Geminite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_geminite:allores2 1",
	recipe = "allores_geminite:Geminite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
