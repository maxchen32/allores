...
if minetest.get_modpath("allores_rinneite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rinneite:Rinneite", {
	description = S("Rinneite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rinneite:allores2 1",
	recipe = "allores_rinneite:Rinneite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
