...
if minetest.get_modpath("allores_zoharite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zoharite:Zoharite", {
	description = S("Zoharite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zoharite:allores2 1",
	recipe = "allores_zoharite:Zoharite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
