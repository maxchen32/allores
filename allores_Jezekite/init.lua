...
if minetest.get_modpath("allores_jezekite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jezekite:Jezekite", {
	description = S("Jezekite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jezekite:allores2 1",
	recipe = "allores_jezekite:Jezekite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
