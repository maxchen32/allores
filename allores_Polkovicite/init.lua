...
if minetest.get_modpath("allores_polkovicite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_polkovicite:Polkovicite", {
	description = S("Polkovicite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_polkovicite:allores2 1",
	recipe = "allores_polkovicite:Polkovicite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_polkovicite:Polkovicite",
