...
if minetest.get_modpath("allores_arakiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_arakiite:Arakiite", {
	description = S("Arakiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_arakiite:allores2 1",
	recipe = "allores_arakiite:Arakiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
