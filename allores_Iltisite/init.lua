...
if minetest.get_modpath("allores_iltisite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_iltisite:Iltisite", {
	description = S("Iltisite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_iltisite:allores2 1",
	recipe = "allores_iltisite:Iltisite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
