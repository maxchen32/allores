...
if minetest.get_modpath("allores_platinum") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_platinum:Platinum", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_platinum:allores2 1",
	recipe = "allores_platinum:Platinum",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
