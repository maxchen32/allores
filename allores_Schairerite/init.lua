...
if minetest.get_modpath("allores_schairerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_schairerite:Schairerite", {
	description = S("Schairerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_schairerite:allores2 1",
	recipe = "allores_schairerite:Schairerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_schairerite:Schairerite",
