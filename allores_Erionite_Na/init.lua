...
if minetest.get_modpath("allores_erionite_na") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_erionite_na:Erionite_Na", {
	description = S("Erionite_Na") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_erionite_na:allores2 1",
	recipe = "allores_erionite_na:Erionite_Na",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_erionite_na:Erionite_Na",
