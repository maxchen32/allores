...
if minetest.get_modpath("allores_madocite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_madocite:Madocite", {
	description = S("Madocite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_madocite:allores2 1",
	recipe = "allores_madocite:Madocite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
