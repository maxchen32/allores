...
if minetest.get_modpath("allores_zoisite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zoisite:Zoisite", {
	description = S("Zoisite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zoisite:allores2 1",
	recipe = "allores_zoisite:Zoisite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
