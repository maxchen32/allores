...
if minetest.get_modpath("allores_bytizite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bytizite:Bytizite", {
	description = S("Bytizite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bytizite:allores2 1",
	recipe = "allores_bytizite:Bytizite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
