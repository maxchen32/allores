...
if minetest.get_modpath("allores_oberthurite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_oberthurite:Oberthurite", {
	description = S("Oberthurite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_oberthurite:allores2 1",
	recipe = "allores_oberthurite:Oberthurite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_oberthurite:Oberthurite",
