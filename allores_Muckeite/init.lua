...
if minetest.get_modpath("allores_muckeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_muckeite:Muckeite", {
	description = S("Muckeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_muckeite:allores2 1",
	recipe = "allores_muckeite:Muckeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
