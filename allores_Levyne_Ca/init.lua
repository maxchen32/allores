...
if minetest.get_modpath("allores_levyne_ca") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_levyne_ca:Levyne_Ca", {
	description = S("Levyne_Ca") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_levyne_ca:allores2 1",
	recipe = "allores_levyne_ca:Levyne_Ca",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_levyne_ca:Levyne_Ca",
