...
if minetest.get_modpath("allores_ardennite_v") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ardennite_v:Ardennite_V", {
	description = S("Ardennite_V") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ardennite_v:allores2 1",
	recipe = "allores_ardennite_v:Ardennite_V",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ardennite_v:Ardennite_V",
