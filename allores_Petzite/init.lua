...
if minetest.get_modpath("allores_petzite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_petzite:Petzite", {
	description = S("Petzite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_petzite:allores2 1",
	recipe = "allores_petzite:Petzite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
