...
if minetest.get_modpath("allores_lavenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lavenite:Lavenite", {
	description = S("Lavenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lavenite:allores2 1",
	recipe = "allores_lavenite:Lavenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
