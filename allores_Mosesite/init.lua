...
if minetest.get_modpath("allores_mosesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mosesite:Mosesite", {
	description = S("Mosesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mosesite:allores2 1",
	recipe = "allores_mosesite:Mosesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
