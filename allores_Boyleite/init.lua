...
if minetest.get_modpath("allores_boyleite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_boyleite:Boyleite", {
	description = S("Boyleite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_boyleite:allores2 1",
	recipe = "allores_boyleite:Boyleite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
