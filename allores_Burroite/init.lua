...
if minetest.get_modpath("allores_burroite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_burroite:Burroite", {
	description = S("Burroite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_burroite:allores2 1",
	recipe = "allores_burroite:Burroite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
