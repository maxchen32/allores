...
if minetest.get_modpath("allores_spertiniite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_spertiniite:Spertiniite", {
	description = S("Spertiniite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_spertiniite:allores2 1",
	recipe = "allores_spertiniite:Spertiniite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_spertiniite:Spertiniite",
