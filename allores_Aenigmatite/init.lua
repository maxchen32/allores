...
if minetest.get_modpath("allores_aenigmatite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_aenigmatite:Aenigmatite", {
	description = S("Aenigmatite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_aenigmatite:allores2 1",
	recipe = "allores_aenigmatite:Aenigmatite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_aenigmatite:Aenigmatite",
