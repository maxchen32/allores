...
if minetest.get_modpath("allores_viteite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_viteite:Viteite", {
	description = S("Viteite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_viteite:allores2 1",
	recipe = "allores_viteite:Viteite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
