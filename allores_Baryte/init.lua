...
if minetest.get_modpath("allores_baryte") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_baryte:Baryte", {
	description = S("Baryte") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_baryte:allores2 1",
	recipe = "allores_baryte:Baryte",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
