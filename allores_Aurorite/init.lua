...
if minetest.get_modpath("allores_aurorite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_aurorite:Aurorite", {
	description = S("Aurorite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_aurorite:allores2 1",
	recipe = "allores_aurorite:Aurorite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
