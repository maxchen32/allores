...
if minetest.get_modpath("allores_loseyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_loseyite:Loseyite", {
	description = S("Loseyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_loseyite:allores2 1",
	recipe = "allores_loseyite:Loseyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
