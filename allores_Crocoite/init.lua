...
if minetest.get_modpath("allores_crocoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_crocoite:Crocoite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_crocoite:allores2 1",
	recipe = "allores_crocoite:Crocoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
