...
if minetest.get_modpath("allores_larnite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_larnite:Larnite", {
	description = S("Larnite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_larnite:allores2 1",
	recipe = "allores_larnite:Larnite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
