...
if minetest.get_modpath("allores_epidote") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_epidote:Epidote", {
	description = S("Epidote") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_epidote:allores2 1",
	recipe = "allores_epidote:Epidote",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
