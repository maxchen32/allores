...
if minetest.get_modpath("allores_kernite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kernite:Kernite", {
	description = S("Kernite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kernite:allores2 1",
	recipe = "allores_kernite:Kernite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
