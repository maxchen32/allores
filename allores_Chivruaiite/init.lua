...
if minetest.get_modpath("allores_chivruaiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chivruaiite:Chivruaiite", {
	description = S("Chivruaiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chivruaiite:allores2 1",
	recipe = "allores_chivruaiite:Chivruaiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chivruaiite:Chivruaiite",
