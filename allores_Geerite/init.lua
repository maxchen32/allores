...
if minetest.get_modpath("allores_geerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_geerite:Geerite", {
	description = S("Geerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_geerite:allores2 1",
	recipe = "allores_geerite:Geerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
