...
if minetest.get_modpath("allores_elpidite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_elpidite:Elpidite", {
	description = S("Elpidite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_elpidite:allores2 1",
	recipe = "allores_elpidite:Elpidite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
