...
if minetest.get_modpath("allores_keyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_keyite:Keyite", {
	description = S("Keyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_keyite:allores2 1",
	recipe = "allores_keyite:Keyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
