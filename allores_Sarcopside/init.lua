...
if minetest.get_modpath("allores_sarcopside") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sarcopside:Sarcopside", {
	description = S("Sarcopside") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sarcopside:allores2 1",
	recipe = "allores_sarcopside:Sarcopside",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_sarcopside:Sarcopside",
