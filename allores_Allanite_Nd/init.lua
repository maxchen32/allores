...
if minetest.get_modpath("allores_allanite_nd") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_allanite_nd:Allanite_Nd", {
	description = S("Allanite_Nd") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_allanite_nd:allores2 1",
	recipe = "allores_allanite_nd:Allanite_Nd",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_allanite_nd:Allanite_Nd",
