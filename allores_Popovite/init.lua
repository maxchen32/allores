...
if minetest.get_modpath("allores_popovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_popovite:Popovite", {
	description = S("Popovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_popovite:allores2 1",
	recipe = "allores_popovite:Popovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
