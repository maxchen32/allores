...
if minetest.get_modpath("allores_piypite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_piypite:Piypite", {
	description = S("Piypite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_piypite:allores2 1",
	recipe = "allores_piypite:Piypite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
