...
if minetest.get_modpath("allores_nixonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nixonite:Nixonite", {
	description = S("Nixonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nixonite:allores2 1",
	recipe = "allores_nixonite:Nixonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
