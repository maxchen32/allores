...
if minetest.get_modpath("allores_electrum") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_electrum:Electrum", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_electrum:allores2 1",
	recipe = "allores_electrum:Electrum",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
