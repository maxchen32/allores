...
if minetest.get_modpath("allores_stranskiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_stranskiite:Stranskiite", {
	description = S("Stranskiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_stranskiite:allores2 1",
	recipe = "allores_stranskiite:Stranskiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_stranskiite:Stranskiite",
