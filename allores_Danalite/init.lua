...
if minetest.get_modpath("allores_danalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_danalite:Danalite", {
	description = S("Danalite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_danalite:allores2 1",
	recipe = "allores_danalite:Danalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
