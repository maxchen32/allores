...
if minetest.get_modpath("allores_kukisvumite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kukisvumite:Kukisvumite", {
	description = S("Kukisvumite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kukisvumite:allores2 1",
	recipe = "allores_kukisvumite:Kukisvumite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kukisvumite:Kukisvumite",
