...
if minetest.get_modpath("allores_wadeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wadeite:Wadeite", {
	description = S("Wadeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wadeite:allores2 1",
	recipe = "allores_wadeite:Wadeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
