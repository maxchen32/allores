...
if minetest.get_modpath("allores_barylite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_barylite:Barylite", {
	description = S("Barylite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_barylite:allores2 1",
	recipe = "allores_barylite:Barylite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
