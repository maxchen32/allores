...
if minetest.get_modpath("allores_balipholite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_balipholite:Balipholite", {
	description = S("Balipholite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_balipholite:allores2 1",
	recipe = "allores_balipholite:Balipholite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_balipholite:Balipholite",
