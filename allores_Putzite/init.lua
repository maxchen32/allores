...
if minetest.get_modpath("allores_putzite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_putzite:Putzite", {
	description = S("Putzite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_putzite:allores2 1",
	recipe = "allores_putzite:Putzite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
