...
if minetest.get_modpath("allores_topaz") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_topaz:Topaz", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_topaz:allores2 1",
	recipe = "allores_topaz:Topaz",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
