...
if minetest.get_modpath("allores_keckite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_keckite:Keckite", {
	description = S("Keckite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_keckite:allores2 1",
	recipe = "allores_keckite:Keckite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
