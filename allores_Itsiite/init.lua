...
if minetest.get_modpath("allores_itsiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_itsiite:Itsiite", {
	description = S("Itsiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_itsiite:allores2 1",
	recipe = "allores_itsiite:Itsiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
