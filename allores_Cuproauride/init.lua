...
if minetest.get_modpath("allores_cuproauride") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cuproauride:Cuproauride", {
	description = S("Cuproauride") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cuproauride:allores2 1",
	recipe = "allores_cuproauride:Cuproauride",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_cuproauride:Cuproauride",
