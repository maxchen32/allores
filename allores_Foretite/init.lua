...
if minetest.get_modpath("allores_foretite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_foretite:Foretite", {
	description = S("Foretite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_foretite:allores2 1",
	recipe = "allores_foretite:Foretite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
