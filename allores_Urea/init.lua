...
if minetest.get_modpath("allores_urea") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_urea:Urea", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_urea:allores2 1",
	recipe = "allores_urea:Urea",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
