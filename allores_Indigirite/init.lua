...
if minetest.get_modpath("allores_indigirite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_indigirite:Indigirite", {
	description = S("Indigirite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_indigirite:allores2 1",
	recipe = "allores_indigirite:Indigirite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_indigirite:Indigirite",
