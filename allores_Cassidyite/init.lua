...
if minetest.get_modpath("allores_cassidyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cassidyite:Cassidyite", {
	description = S("Cassidyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cassidyite:allores2 1",
	recipe = "allores_cassidyite:Cassidyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_cassidyite:Cassidyite",
