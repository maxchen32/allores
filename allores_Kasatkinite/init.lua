...
if minetest.get_modpath("allores_kasatkinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kasatkinite:Kasatkinite", {
	description = S("Kasatkinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kasatkinite:allores2 1",
	recipe = "allores_kasatkinite:Kasatkinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kasatkinite:Kasatkinite",
