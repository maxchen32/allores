...
if minetest.get_modpath("allores_bohseite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bohseite:Bohseite", {
	description = S("Bohseite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bohseite:allores2 1",
	recipe = "allores_bohseite:Bohseite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
