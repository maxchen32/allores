...
if minetest.get_modpath("allores_corkite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_corkite:Corkite", {
	description = S("Corkite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_corkite:allores2 1",
	recipe = "allores_corkite:Corkite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
