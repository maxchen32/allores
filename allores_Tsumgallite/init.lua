...
if minetest.get_modpath("allores_tsumgallite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tsumgallite:Tsumgallite", {
	description = S("Tsumgallite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tsumgallite:allores2 1",
	recipe = "allores_tsumgallite:Tsumgallite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_tsumgallite:Tsumgallite",
