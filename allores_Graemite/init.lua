...
if minetest.get_modpath("allores_graemite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_graemite:Graemite", {
	description = S("Graemite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_graemite:allores2 1",
	recipe = "allores_graemite:Graemite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
