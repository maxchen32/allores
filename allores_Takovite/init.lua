...
if minetest.get_modpath("allores_takovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_takovite:Takovite", {
	description = S("Takovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_takovite:allores2 1",
	recipe = "allores_takovite:Takovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
