...
if minetest.get_modpath("allores_hakite_hg") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hakite_hg:Hakite_Hg", {
	description = S("Hakite_Hg") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hakite_hg:allores2 1",
	recipe = "allores_hakite_hg:Hakite_Hg",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hakite_hg:Hakite_Hg",
