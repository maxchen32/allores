...
if minetest.get_modpath("allores_chiluite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chiluite:Chiluite", {
	description = S("Chiluite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chiluite:allores2 1",
	recipe = "allores_chiluite:Chiluite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
