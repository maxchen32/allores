...
if minetest.get_modpath("allores_niter") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_niter:Niter", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_niter:allores2 1",
	recipe = "allores_niter:Niter",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
