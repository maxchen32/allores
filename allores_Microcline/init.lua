...
if minetest.get_modpath("allores_microcline") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_microcline:Microcline", {
	description = S("Microcline") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_microcline:allores2 1",
	recipe = "allores_microcline:Microcline",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_microcline:Microcline",
