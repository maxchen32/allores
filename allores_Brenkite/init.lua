...
if minetest.get_modpath("allores_brenkite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_brenkite:Brenkite", {
	description = S("Brenkite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_brenkite:allores2 1",
	recipe = "allores_brenkite:Brenkite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
