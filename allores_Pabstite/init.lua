...
if minetest.get_modpath("allores_pabstite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pabstite:Pabstite", {
	description = S("Pabstite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pabstite:allores2 1",
	recipe = "allores_pabstite:Pabstite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
