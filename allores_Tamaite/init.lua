...
if minetest.get_modpath("allores_tamaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tamaite:Tamaite", {
	description = S("Tamaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tamaite:allores2 1",
	recipe = "allores_tamaite:Tamaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
