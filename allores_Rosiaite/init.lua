...
if minetest.get_modpath("allores_rosiaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rosiaite:Rosiaite", {
	description = S("Rosiaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rosiaite:allores2 1",
	recipe = "allores_rosiaite:Rosiaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
