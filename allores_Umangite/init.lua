...
if minetest.get_modpath("allores_umangite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_umangite:Umangite", {
	description = S("Umangite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_umangite:allores2 1",
	recipe = "allores_umangite:Umangite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
