...
if minetest.get_modpath("allores_spangolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_spangolite:Spangolite", {
	description = S("Spangolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_spangolite:allores2 1",
	recipe = "allores_spangolite:Spangolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_spangolite:Spangolite",
