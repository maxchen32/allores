...
if minetest.get_modpath("allores_studtite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_studtite:Studtite", {
	description = S("Studtite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_studtite:allores2 1",
	recipe = "allores_studtite:Studtite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
