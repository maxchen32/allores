...
if minetest.get_modpath("allores_aikinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_aikinite:Aikinite", {
	description = S("Aikinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_aikinite:allores2 1",
	recipe = "allores_aikinite:Aikinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
