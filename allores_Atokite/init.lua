...
if minetest.get_modpath("allores_atokite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_atokite:Atokite", {
	description = S("Atokite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_atokite:allores2 1",
	recipe = "allores_atokite:Atokite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
