...
if minetest.get_modpath("allores_dualite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dualite:Dualite", {
	description = S("Dualite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dualite:allores2 1",
	recipe = "allores_dualite:Dualite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
