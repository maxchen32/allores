...
if minetest.get_modpath("allores_tundrite_nd") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tundrite_nd:Tundrite_Nd", {
	description = S("Tundrite_Nd") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tundrite_nd:allores2 1",
	recipe = "allores_tundrite_nd:Tundrite_Nd",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_tundrite_nd:Tundrite_Nd",
