...
if minetest.get_modpath("allores_rumoiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rumoiite:Rumoiite", {
	description = S("Rumoiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rumoiite:allores2 1",
	recipe = "allores_rumoiite:Rumoiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
