...
if minetest.get_modpath("allores_emilite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_emilite:Emilite", {
	description = S("Emilite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_emilite:allores2 1",
	recipe = "allores_emilite:Emilite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
