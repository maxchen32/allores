...
if minetest.get_modpath("allores_gananite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gananite:Gananite", {
	description = S("Gananite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gananite:allores2 1",
	recipe = "allores_gananite:Gananite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
