allores_gersdorffite = {}
local S = minetest.get_translator(minetest.get_current_modname())

if minetest.get_modpath("allores_gersdorffite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gersdorffite:Gersdorffite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gersdorffite:allores2 1",
	recipe = "allores_gersdorffite:Gersdorffite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_gersdorffite:Gersdorffite",
