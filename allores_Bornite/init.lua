...
if minetest.get_modpath("allores_bornite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bornite:Bornite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bornite:allores2 1",
	recipe = "allores_bornite:Bornite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
