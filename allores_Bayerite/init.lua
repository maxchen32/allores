...
if minetest.get_modpath("allores_bayerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bayerite:Bayerite", {
	description = S("Bayerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bayerite:allores2 1",
	recipe = "allores_bayerite:Bayerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
