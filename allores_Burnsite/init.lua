...
if minetest.get_modpath("allores_burnsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_burnsite:Burnsite", {
	description = S("Burnsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_burnsite:allores2 1",
	recipe = "allores_burnsite:Burnsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
