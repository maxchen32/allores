...
if minetest.get_modpath("allores_nitrobarite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nitrobarite:Nitrobarite", {
	description = S("Nitrobarite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nitrobarite:allores2 1",
	recipe = "allores_nitrobarite:Nitrobarite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_nitrobarite:Nitrobarite",
