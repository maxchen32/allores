...
if minetest.get_modpath("allores_dashkovaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dashkovaite:Dashkovaite", {
	description = S("Dashkovaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dashkovaite:allores2 1",
	recipe = "allores_dashkovaite:Dashkovaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_dashkovaite:Dashkovaite",
