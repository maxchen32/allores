...
if minetest.get_modpath("allores_franklinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_franklinite:Franklinite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_franklinite:allores2 1",
	recipe = "allores_franklinite:Franklinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_franklinite:Franklinite",
