...
if minetest.get_modpath("allores_eskebornite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_eskebornite:Eskebornite", {
	description = S("Eskebornite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_eskebornite:allores2 1",
	recipe = "allores_eskebornite:Eskebornite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_eskebornite:Eskebornite",
