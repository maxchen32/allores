...
if minetest.get_modpath("allores_vashegyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vashegyite:Vashegyite", {
	description = S("Vashegyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vashegyite:allores2 1",
	recipe = "allores_vashegyite:Vashegyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_vashegyite:Vashegyite",
