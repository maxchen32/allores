...
if minetest.get_modpath("allores_moeloite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_moeloite:Moeloite", {
	description = S("Moeloite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_moeloite:allores2 1",
	recipe = "allores_moeloite:Moeloite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
