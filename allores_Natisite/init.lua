...
if minetest.get_modpath("allores_natisite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_natisite:Natisite", {
	description = S("Natisite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_natisite:allores2 1",
	recipe = "allores_natisite:Natisite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
