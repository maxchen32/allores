...
if minetest.get_modpath("allores_carboborite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_carboborite:Carboborite", {
	description = S("Carboborite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_carboborite:allores2 1",
	recipe = "allores_carboborite:Carboborite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_carboborite:Carboborite",
