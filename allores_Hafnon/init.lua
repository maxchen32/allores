...
if minetest.get_modpath("allores_hafnon") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hafnon:Hafnon", {
	description = S("Hafnon") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hafnon:allores2 1",
	recipe = "allores_hafnon:Hafnon",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
