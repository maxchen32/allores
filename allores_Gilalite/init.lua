...
if minetest.get_modpath("allores_gilalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gilalite:Gilalite", {
	description = S("Gilalite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gilalite:allores2 1",
	recipe = "allores_gilalite:Gilalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
