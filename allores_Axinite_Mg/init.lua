...
if minetest.get_modpath("allores_axinite_mg") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_axinite_mg:Axinite_Mg", {
	description = S("Axinite_Mg") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_axinite_mg:allores2 1",
	recipe = "allores_axinite_mg:Axinite_Mg",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_axinite_mg:Axinite_Mg",
