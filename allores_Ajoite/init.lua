...
if minetest.get_modpath("allores_ajoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ajoite:Ajoite", {
	description = S("Ajoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ajoite:allores2 1",
	recipe = "allores_ajoite:Ajoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
