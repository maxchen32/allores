...
if minetest.get_modpath("allores_niahite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_niahite:Niahite", {
	description = S("Niahite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_niahite:allores2 1",
	recipe = "allores_niahite:Niahite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
