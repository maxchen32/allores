...
if minetest.get_modpath("allores_xieite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_xieite:Xieite", {
	description = S("Xieite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_xieite:allores2 1",
	recipe = "allores_xieite:Xieite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
