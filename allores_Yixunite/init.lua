...
if minetest.get_modpath("allores_yixunite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_yixunite:Yixunite", {
	description = S("Yixunite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_yixunite:allores2 1",
	recipe = "allores_yixunite:Yixunite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
