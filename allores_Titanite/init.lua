...
if minetest.get_modpath("allores_titanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_titanite:Titanite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_titanite:allores2 1",
	recipe = "allores_titanite:Titanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
