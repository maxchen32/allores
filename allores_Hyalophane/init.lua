...
if minetest.get_modpath("allores_hyalophane") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hyalophane:Hyalophane", {
	description = S("Hyalophane") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hyalophane:allores2 1",
	recipe = "allores_hyalophane:Hyalophane",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hyalophane:Hyalophane",
