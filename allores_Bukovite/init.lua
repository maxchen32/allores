...
if minetest.get_modpath("allores_bukovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bukovite:Bukovite", {
	description = S("Bukovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bukovite:allores2 1",
	recipe = "allores_bukovite:Bukovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
