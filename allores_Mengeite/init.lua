...
if minetest.get_modpath("allores_mengeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mengeite:Mengeite", {
	description = S("Mengeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mengeite:allores2 1",
	recipe = "allores_mengeite:Mengeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
