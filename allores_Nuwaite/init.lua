...
if minetest.get_modpath("allores_nuwaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nuwaite:Nuwaite", {
	description = S("Nuwaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nuwaite:allores2 1",
	recipe = "allores_nuwaite:Nuwaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
