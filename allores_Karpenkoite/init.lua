...
if minetest.get_modpath("allores_karpenkoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_karpenkoite:Karpenkoite", {
	description = S("Karpenkoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_karpenkoite:allores2 1",
	recipe = "allores_karpenkoite:Karpenkoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_karpenkoite:Karpenkoite",
