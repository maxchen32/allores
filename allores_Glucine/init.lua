...
if minetest.get_modpath("allores_glucine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_glucine:Glucine", {
	description = S("Glucine") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_glucine:allores2 1",
	recipe = "allores_glucine:Glucine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
