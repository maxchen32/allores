...
if minetest.get_modpath("allores_bokite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bokite:Bokite", {
	description = S("Bokite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bokite:allores2 1",
	recipe = "allores_bokite:Bokite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
