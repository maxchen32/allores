...
if minetest.get_modpath("allores_koktaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_koktaite:Koktaite", {
	description = S("Koktaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_koktaite:allores2 1",
	recipe = "allores_koktaite:Koktaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
