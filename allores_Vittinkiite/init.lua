...
if minetest.get_modpath("allores_vittinkiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vittinkiite:Vittinkiite", {
	description = S("Vittinkiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vittinkiite:allores2 1",
	recipe = "allores_vittinkiite:Vittinkiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_vittinkiite:Vittinkiite",
