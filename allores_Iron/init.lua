...
if minetest.get_modpath("allores_iron") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_iron:Iron", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_iron:allores2 1",
	recipe = "allores_iron:Iron",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
