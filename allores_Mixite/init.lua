...
if minetest.get_modpath("allores_mixite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mixite:Mixite", {
	description = S("Mixite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mixite:allores2 1",
	recipe = "allores_mixite:Mixite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
