...
if minetest.get_modpath("allores_spessartine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_spessartine:Spessartine", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_spessartine:allores2 1",
	recipe = "allores_spessartine:Spessartine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_spessartine:Spessartine",
