...
if minetest.get_modpath("allores_spodumene") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_spodumene:Spodumene", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_spodumene:allores2 1",
	recipe = "allores_spodumene:Spodumene",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_spodumene:Spodumene",
