...
if minetest.get_modpath("allores_spurrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_spurrite:Spurrite", {
	description = S("Spurrite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_spurrite:allores2 1",
	recipe = "allores_spurrite:Spurrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
