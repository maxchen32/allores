...
if minetest.get_modpath("allores_brookite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_brookite:Brookite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_brookite:allores2 1",
	recipe = "allores_brookite:Brookite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
