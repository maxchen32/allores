...
if minetest.get_modpath("allores_vladykinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vladykinite:Vladykinite", {
	description = S("Vladykinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vladykinite:allores2 1",
	recipe = "allores_vladykinite:Vladykinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_vladykinite:Vladykinite",
