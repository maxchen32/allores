...
if minetest.get_modpath("allores_tenorite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tenorite:Tenorite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tenorite:allores2 1",
	recipe = "allores_tenorite:Tenorite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
