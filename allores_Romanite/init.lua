...
if minetest.get_modpath("allores_romanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_romanite:Romanite", {
	description = S("Romanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_romanite:allores2 1",
	recipe = "allores_romanite:Romanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
