...
if minetest.get_modpath("allores_vasilite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vasilite:Vasilite", {
	description = S("Vasilite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vasilite:allores2 1",
	recipe = "allores_vasilite:Vasilite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
