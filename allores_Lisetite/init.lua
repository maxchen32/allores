...
if minetest.get_modpath("allores_lisetite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lisetite:Lisetite", {
	description = S("Lisetite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lisetite:allores2 1",
	recipe = "allores_lisetite:Lisetite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
