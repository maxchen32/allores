...
if minetest.get_modpath("allores_caminite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_caminite:Caminite", {
	description = S("Caminite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_caminite:allores2 1",
	recipe = "allores_caminite:Caminite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
