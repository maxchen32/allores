...
if minetest.get_modpath("allores_honzaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_honzaite:Honzaite", {
	description = S("Honzaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_honzaite:allores2 1",
	recipe = "allores_honzaite:Honzaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
