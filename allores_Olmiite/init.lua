...
if minetest.get_modpath("allores_olmiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_olmiite:Olmiite", {
	description = S("Olmiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_olmiite:allores2 1",
	recipe = "allores_olmiite:Olmiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
