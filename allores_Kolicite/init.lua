...
if minetest.get_modpath("allores_kolicite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kolicite:Kolicite", {
	description = S("Kolicite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kolicite:allores2 1",
	recipe = "allores_kolicite:Kolicite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
