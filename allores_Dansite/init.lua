...
if minetest.get_modpath("allores_dansite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dansite:Dansite", {
	description = S("Dansite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dansite:allores2 1",
	recipe = "allores_dansite:Dansite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
