...
if minetest.get_modpath("allores_flinkite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_flinkite:Flinkite", {
	description = S("Flinkite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_flinkite:allores2 1",
	recipe = "allores_flinkite:Flinkite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
