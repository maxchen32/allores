...
if minetest.get_modpath("allores_osakaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_osakaite:Osakaite", {
	description = S("Osakaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_osakaite:allores2 1",
	recipe = "allores_osakaite:Osakaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
