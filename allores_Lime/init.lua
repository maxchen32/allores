...
if minetest.get_modpath("allores_lime") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lime:Lime", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lime:allores2 1",
	recipe = "allores_lime:Lime",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
