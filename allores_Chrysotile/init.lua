...
if minetest.get_modpath("allores_chrysotile") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chrysotile:Chrysotile", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chrysotile:allores2 1",
	recipe = "allores_chrysotile:Chrysotile",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chrysotile:Chrysotile",
