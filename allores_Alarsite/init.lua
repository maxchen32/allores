...
if minetest.get_modpath("allores_alarsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_alarsite:Alarsite", {
	description = S("Alarsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_alarsite:allores2 1",
	recipe = "allores_alarsite:Alarsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
