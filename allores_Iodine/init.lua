...
if minetest.get_modpath("allores_iodine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_iodine:Iodine", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_iodine:allores2 1",
	recipe = "allores_iodine:Iodine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
