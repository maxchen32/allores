...
if minetest.get_modpath("allores_cubanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cubanite:Cubanite", {
	description = S("Cubanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cubanite:allores2 1",
	recipe = "allores_cubanite:Cubanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
