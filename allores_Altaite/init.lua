...
if minetest.get_modpath("allores_altaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_altaite:Altaite", {
	description = S("Altaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_altaite:allores2 1",
	recipe = "allores_altaite:Altaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
