...
if minetest.get_modpath("allores_kanoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kanoite:Kanoite", {
	description = S("Kanoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kanoite:allores2 1",
	recipe = "allores_kanoite:Kanoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
