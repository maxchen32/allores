...
if minetest.get_modpath("allores_eckerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_eckerite:Eckerite", {
	description = S("Eckerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_eckerite:allores2 1",
	recipe = "allores_eckerite:Eckerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
