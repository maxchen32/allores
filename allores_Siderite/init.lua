...
if minetest.get_modpath("allores_siderite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_siderite:Siderite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_siderite:allores2 1",
	recipe = "allores_siderite:Siderite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
