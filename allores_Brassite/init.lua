...
if minetest.get_modpath("allores_brassite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_brassite:Brassite", {
	description = S("Brassite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_brassite:allores2 1",
	recipe = "allores_brassite:Brassite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
