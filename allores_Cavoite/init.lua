...
if minetest.get_modpath("allores_cavoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cavoite:Cavoite", {
	description = S("Cavoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cavoite:allores2 1",
	recipe = "allores_cavoite:Cavoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
