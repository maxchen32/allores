...
if minetest.get_modpath("allores_raberite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_raberite:Raberite", {
	description = S("Raberite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_raberite:allores2 1",
	recipe = "allores_raberite:Raberite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
