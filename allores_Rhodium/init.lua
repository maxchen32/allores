...
if minetest.get_modpath("allores_rhodium") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rhodium:Rhodium", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rhodium:allores2 1",
	recipe = "allores_rhodium:Rhodium",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
