...
if minetest.get_modpath("allores_liottite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_liottite:Liottite", {
	description = S("Liottite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_liottite:allores2 1",
	recipe = "allores_liottite:Liottite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
