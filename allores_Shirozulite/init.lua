...
if minetest.get_modpath("allores_shirozulite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_shirozulite:Shirozulite", {
	description = S("Shirozulite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_shirozulite:allores2 1",
	recipe = "allores_shirozulite:Shirozulite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_shirozulite:Shirozulite",
