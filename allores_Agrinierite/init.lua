...
if minetest.get_modpath("allores_agrinierite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_agrinierite:Agrinierite", {
	description = S("Agrinierite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_agrinierite:allores2 1",
	recipe = "allores_agrinierite:Agrinierite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_agrinierite:Agrinierite",
