...
if minetest.get_modpath("allores_garmite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_garmite:Garmite", {
	description = S("Garmite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_garmite:allores2 1",
	recipe = "allores_garmite:Garmite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
