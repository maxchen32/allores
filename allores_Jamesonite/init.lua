...
if minetest.get_modpath("allores_jamesonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jamesonite:Jamesonite", {
	description = S("Jamesonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jamesonite:allores2 1",
	recipe = "allores_jamesonite:Jamesonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_jamesonite:Jamesonite",
