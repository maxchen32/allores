...
if minetest.get_modpath("allores_queitite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_queitite:Queitite", {
	description = S("Queitite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_queitite:allores2 1",
	recipe = "allores_queitite:Queitite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
