...
if minetest.get_modpath("allores_blakeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_blakeite:Blakeite", {
	description = S("Blakeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_blakeite:allores2 1",
	recipe = "allores_blakeite:Blakeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
