...
if minetest.get_modpath("allores_sulfoborite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sulfoborite:Sulfoborite", {
	description = S("Sulfoborite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sulfoborite:allores2 1",
	recipe = "allores_sulfoborite:Sulfoborite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_sulfoborite:Sulfoborite",
