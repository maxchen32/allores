...
if minetest.get_modpath("allores_stolzite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_stolzite:Stolzite", {
	description = S("Stolzite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_stolzite:allores2 1",
	recipe = "allores_stolzite:Stolzite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
