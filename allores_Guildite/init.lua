...
if minetest.get_modpath("allores_guildite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_guildite:Guildite", {
	description = S("Guildite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_guildite:allores2 1",
	recipe = "allores_guildite:Guildite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
