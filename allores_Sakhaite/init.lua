...
if minetest.get_modpath("allores_sakhaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sakhaite:Sakhaite", {
	description = S("Sakhaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sakhaite:allores2 1",
	recipe = "allores_sakhaite:Sakhaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
