...
if minetest.get_modpath("allores_erdite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_erdite:Erdite", {
	description = S("Erdite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_erdite:allores2 1",
	recipe = "allores_erdite:Erdite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
