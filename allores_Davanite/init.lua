...
if minetest.get_modpath("allores_davanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_davanite:Davanite", {
	description = S("Davanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_davanite:allores2 1",
	recipe = "allores_davanite:Davanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
