...
if minetest.get_modpath("allores_tunisite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tunisite:Tunisite", {
	description = S("Tunisite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tunisite:allores2 1",
	recipe = "allores_tunisite:Tunisite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
