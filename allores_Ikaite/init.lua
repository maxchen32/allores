...
if minetest.get_modpath("allores_ikaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ikaite:Ikaite", {
	description = S("Ikaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ikaite:allores2 1",
	recipe = "allores_ikaite:Ikaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
