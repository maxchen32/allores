...
if minetest.get_modpath("allores_vestaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vestaite:Vestaite", {
	description = S("Vestaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vestaite:allores2 1",
	recipe = "allores_vestaite:Vestaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
