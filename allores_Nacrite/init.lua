...
if minetest.get_modpath("allores_nacrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nacrite:Nacrite", {
	description = S("Nacrite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nacrite:allores2 1",
	recipe = "allores_nacrite:Nacrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
