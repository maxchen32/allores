...
if minetest.get_modpath("allores_olympite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_olympite:Olympite", {
	description = S("Olympite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_olympite:allores2 1",
	recipe = "allores_olympite:Olympite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
