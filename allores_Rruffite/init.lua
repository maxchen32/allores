...
if minetest.get_modpath("allores_rruffite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rruffite:Rruffite", {
	description = S("Rruffite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rruffite:allores2 1",
	recipe = "allores_rruffite:Rruffite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
