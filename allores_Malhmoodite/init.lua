...
if minetest.get_modpath("allores_malhmoodite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_malhmoodite:Malhmoodite", {
	description = S("Malhmoodite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_malhmoodite:allores2 1",
	recipe = "allores_malhmoodite:Malhmoodite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_malhmoodite:Malhmoodite",
