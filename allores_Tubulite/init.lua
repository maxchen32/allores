...
if minetest.get_modpath("allores_tubulite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tubulite:Tubulite", {
	description = S("Tubulite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tubulite:allores2 1",
	recipe = "allores_tubulite:Tubulite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
