...
if minetest.get_modpath("allores_langite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_langite:Langite", {
	description = S("Langite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_langite:allores2 1",
	recipe = "allores_langite:Langite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
