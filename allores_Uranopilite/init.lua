...
if minetest.get_modpath("allores_uranopilite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_uranopilite:Uranopilite", {
	description = S("Uranopilite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_uranopilite:allores2 1",
	recipe = "allores_uranopilite:Uranopilite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_uranopilite:Uranopilite",
