...
if minetest.get_modpath("allores_chongite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chongite:Chongite", {
	description = S("Chongite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chongite:allores2 1",
	recipe = "allores_chongite:Chongite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
