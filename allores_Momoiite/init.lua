...
if minetest.get_modpath("allores_momoiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_momoiite:Momoiite", {
	description = S("Momoiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_momoiite:allores2 1",
	recipe = "allores_momoiite:Momoiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
