...
if minetest.get_modpath("allores_kornerupine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kornerupine:Kornerupine", {
	description = S("Kornerupine") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kornerupine:allores2 1",
	recipe = "allores_kornerupine:Kornerupine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kornerupine:Kornerupine",
