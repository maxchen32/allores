...
if minetest.get_modpath("allores_horakite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_horakite:Horakite", {
	description = S("Horakite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_horakite:allores2 1",
	recipe = "allores_horakite:Horakite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
