...
if minetest.get_modpath("allores_hauerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hauerite:Hauerite", {
	description = S("Hauerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hauerite:allores2 1",
	recipe = "allores_hauerite:Hauerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
