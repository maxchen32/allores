...
if minetest.get_modpath("allores_dorrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dorrite:Dorrite", {
	description = S("Dorrite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dorrite:allores2 1",
	recipe = "allores_dorrite:Dorrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
