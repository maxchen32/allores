...
if minetest.get_modpath("allores_tsumoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tsumoite:Tsumoite", {
	description = S("Tsumoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tsumoite:allores2 1",
	recipe = "allores_tsumoite:Tsumoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
