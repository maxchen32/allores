...
if minetest.get_modpath("allores_eitelite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_eitelite:Eitelite", {
	description = S("Eitelite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_eitelite:allores2 1",
	recipe = "allores_eitelite:Eitelite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
