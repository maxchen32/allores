...
if minetest.get_modpath("allores_cuprospinel") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cuprospinel:Cuprospinel", {
	description = S("Cuprospinel") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cuprospinel:allores2 1",
	recipe = "allores_cuprospinel:Cuprospinel",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_cuprospinel:Cuprospinel",
