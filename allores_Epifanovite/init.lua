...
if minetest.get_modpath("allores_epifanovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_epifanovite:Epifanovite", {
	description = S("Epifanovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_epifanovite:allores2 1",
	recipe = "allores_epifanovite:Epifanovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_epifanovite:Epifanovite",
