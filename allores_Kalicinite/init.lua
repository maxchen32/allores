...
if minetest.get_modpath("allores_kalicinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kalicinite:Kalicinite", {
	description = S("Kalicinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kalicinite:allores2 1",
	recipe = "allores_kalicinite:Kalicinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kalicinite:Kalicinite",
