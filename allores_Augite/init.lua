...
if minetest.get_modpath("allores_augite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_augite:Augite", {
	description = S("Augite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_augite:allores2 1",
	recipe = "allores_augite:Augite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
