...
if minetest.get_modpath("allores_lazurite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lazurite:Lazurite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lazurite:allores2 1",
	recipe = "allores_lazurite:Lazurite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
