...
if minetest.get_modpath("allores_kaatialaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kaatialaite:Kaatialaite", {
	description = S("Kaatialaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kaatialaite:allores2 1",
	recipe = "allores_kaatialaite:Kaatialaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kaatialaite:Kaatialaite",
