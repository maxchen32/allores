...
if minetest.get_modpath("allores_cassagnaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cassagnaite:Cassagnaite", {
	description = S("Cassagnaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cassagnaite:allores2 1",
	recipe = "allores_cassagnaite:Cassagnaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_cassagnaite:Cassagnaite",
