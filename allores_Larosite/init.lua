...
if minetest.get_modpath("allores_larosite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_larosite:Larosite", {
	description = S("Larosite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_larosite:allores2 1",
	recipe = "allores_larosite:Larosite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
