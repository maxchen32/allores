...
if minetest.get_modpath("allores_flurlite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_flurlite:Flurlite", {
	description = S("Flurlite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_flurlite:allores2 1",
	recipe = "allores_flurlite:Flurlite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
