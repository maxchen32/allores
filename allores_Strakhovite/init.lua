...
if minetest.get_modpath("allores_strakhovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_strakhovite:Strakhovite", {
	description = S("Strakhovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_strakhovite:allores2 1",
	recipe = "allores_strakhovite:Strakhovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_strakhovite:Strakhovite",
