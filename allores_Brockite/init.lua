...
if minetest.get_modpath("allores_brockite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_brockite:Brockite", {
	description = S("Brockite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_brockite:allores2 1",
	recipe = "allores_brockite:Brockite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
