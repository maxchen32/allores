...
if minetest.get_modpath("allores_hanjiangite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hanjiangite:Hanjiangite", {
	description = S("Hanjiangite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hanjiangite:allores2 1",
	recipe = "allores_hanjiangite:Hanjiangite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hanjiangite:Hanjiangite",
