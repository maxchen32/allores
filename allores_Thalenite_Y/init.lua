...
if minetest.get_modpath("allores_thalenite_y") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_thalenite_y:Thalenite_Y", {
	description = S("Thalenite_Y") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_thalenite_y:allores2 1",
	recipe = "allores_thalenite_y:Thalenite_Y",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_thalenite_y:Thalenite_Y",
