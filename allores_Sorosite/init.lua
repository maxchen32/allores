...
if minetest.get_modpath("allores_sorosite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sorosite:Sorosite", {
	description = S("Sorosite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sorosite:allores2 1",
	recipe = "allores_sorosite:Sorosite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
