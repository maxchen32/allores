...
if minetest.get_modpath("allores_tyrolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tyrolite:Tyrolite", {
	description = S("Tyrolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tyrolite:allores2 1",
	recipe = "allores_tyrolite:Tyrolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
