...
if minetest.get_modpath("allores_roxbyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_roxbyite:Roxbyite", {
	description = S("Roxbyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_roxbyite:allores2 1",
	recipe = "allores_roxbyite:Roxbyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
