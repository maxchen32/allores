...
if minetest.get_modpath("allores_berryite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_berryite:Berryite", {
	description = S("Berryite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_berryite:allores2 1",
	recipe = "allores_berryite:Berryite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
