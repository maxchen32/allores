...
if minetest.get_modpath("allores_nahpoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nahpoite:Nahpoite", {
	description = S("Nahpoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nahpoite:allores2 1",
	recipe = "allores_nahpoite:Nahpoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
