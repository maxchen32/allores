...
if minetest.get_modpath("allores_lipuite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lipuite:Lipuite", {
	description = S("Lipuite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lipuite:allores2 1",
	recipe = "allores_lipuite:Lipuite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
