...
if minetest.get_modpath("allores_stergiouite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_stergiouite:Stergiouite", {
	description = S("Stergiouite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_stergiouite:allores2 1",
	recipe = "allores_stergiouite:Stergiouite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_stergiouite:Stergiouite",
