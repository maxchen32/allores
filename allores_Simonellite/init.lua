...
if minetest.get_modpath("allores_simonellite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_simonellite:Simonellite", {
	description = S("Simonellite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_simonellite:allores2 1",
	recipe = "allores_simonellite:Simonellite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_simonellite:Simonellite",
