...
if minetest.get_modpath("allores_chadwickite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chadwickite:Chadwickite", {
	description = S("Chadwickite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chadwickite:allores2 1",
	recipe = "allores_chadwickite:Chadwickite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chadwickite:Chadwickite",
