...
if minetest.get_modpath("allores_gonnardite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gonnardite:Gonnardite", {
	description = S("Gonnardite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gonnardite:allores2 1",
	recipe = "allores_gonnardite:Gonnardite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_gonnardite:Gonnardite",
