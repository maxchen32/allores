...
if minetest.get_modpath("allores_rauvite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rauvite:Rauvite", {
	description = S("Rauvite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rauvite:allores2 1",
	recipe = "allores_rauvite:Rauvite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
