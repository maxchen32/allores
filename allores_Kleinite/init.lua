...
if minetest.get_modpath("allores_kleinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kleinite:Kleinite", {
	description = S("Kleinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kleinite:allores2 1",
	recipe = "allores_kleinite:Kleinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
