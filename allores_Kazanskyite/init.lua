...
if minetest.get_modpath("allores_kazanskyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kazanskyite:Kazanskyite", {
	description = S("Kazanskyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kazanskyite:allores2 1",
	recipe = "allores_kazanskyite:Kazanskyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kazanskyite:Kazanskyite",
