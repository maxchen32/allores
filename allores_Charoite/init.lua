...
if minetest.get_modpath("allores_charoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_charoite:Charoite", {
	description = S("Charoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_charoite:allores2 1",
	recipe = "allores_charoite:Charoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
