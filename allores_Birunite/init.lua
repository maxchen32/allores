...
if minetest.get_modpath("allores_birunite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_birunite:Birunite", {
	description = S("Birunite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_birunite:allores2 1",
	recipe = "allores_birunite:Birunite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
