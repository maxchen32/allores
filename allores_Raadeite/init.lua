...
if minetest.get_modpath("allores_raadeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_raadeite:Raadeite", {
	description = S("Raadeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_raadeite:allores2 1",
	recipe = "allores_raadeite:Raadeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
