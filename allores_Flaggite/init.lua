...
if minetest.get_modpath("allores_flaggite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_flaggite:Flaggite", {
	description = S("Flaggite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_flaggite:allores2 1",
	recipe = "allores_flaggite:Flaggite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
