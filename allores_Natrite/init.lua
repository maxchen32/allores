...
if minetest.get_modpath("allores_natrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_natrite:Natrite", {
	description = S("Natrite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_natrite:allores2 1",
	recipe = "allores_natrite:Natrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
