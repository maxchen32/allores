...
if minetest.get_modpath("allores_benyacarite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_benyacarite:Benyacarite", {
	description = S("Benyacarite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_benyacarite:allores2 1",
	recipe = "allores_benyacarite:Benyacarite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_benyacarite:Benyacarite",
