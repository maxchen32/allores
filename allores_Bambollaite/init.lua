...
if minetest.get_modpath("allores_bambollaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bambollaite:Bambollaite", {
	description = S("Bambollaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bambollaite:allores2 1",
	recipe = "allores_bambollaite:Bambollaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bambollaite:Bambollaite",
