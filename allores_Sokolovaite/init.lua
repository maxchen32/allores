...
if minetest.get_modpath("allores_sokolovaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sokolovaite:Sokolovaite", {
	description = S("Sokolovaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sokolovaite:allores2 1",
	recipe = "allores_sokolovaite:Sokolovaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_sokolovaite:Sokolovaite",
