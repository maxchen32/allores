...
if minetest.get_modpath("allores_fukalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fukalite:Fukalite", {
	description = S("Fukalite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fukalite:allores2 1",
	recipe = "allores_fukalite:Fukalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
