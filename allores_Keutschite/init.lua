...
if minetest.get_modpath("allores_keutschite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_keutschite:Keutschite", {
	description = S("Keutschite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_keutschite:allores2 1",
	recipe = "allores_keutschite:Keutschite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_keutschite:Keutschite",
