...
if minetest.get_modpath("allores_siderazot") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_siderazot:Siderazot", {
	description = S("Siderazot") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_siderazot:allores2 1",
	recipe = "allores_siderazot:Siderazot",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_siderazot:Siderazot",
