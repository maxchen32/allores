...
if minetest.get_modpath("allores_nasonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nasonite:Nasonite", {
	description = S("Nasonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nasonite:allores2 1",
	recipe = "allores_nasonite:Nasonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
