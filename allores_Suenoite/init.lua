...
if minetest.get_modpath("allores_suenoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_suenoite:Suenoite", {
	description = S("Suenoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_suenoite:allores2 1",
	recipe = "allores_suenoite:Suenoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
