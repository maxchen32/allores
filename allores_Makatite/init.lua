...
if minetest.get_modpath("allores_makatite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_makatite:Makatite", {
	description = S("Makatite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_makatite:allores2 1",
	recipe = "allores_makatite:Makatite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
