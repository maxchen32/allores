...
if minetest.get_modpath("allores_zairite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zairite:Zairite", {
	description = S("Zairite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zairite:allores2 1",
	recipe = "allores_zairite:Zairite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
