...
if minetest.get_modpath("allores_mohnite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mohnite:Mohnite", {
	description = S("Mohnite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mohnite:allores2 1",
	recipe = "allores_mohnite:Mohnite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
