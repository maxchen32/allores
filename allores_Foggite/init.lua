...
if minetest.get_modpath("allores_foggite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_foggite:Foggite", {
	description = S("Foggite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_foggite:allores2 1",
	recipe = "allores_foggite:Foggite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
