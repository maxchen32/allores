...
if minetest.get_modpath("allores_urphoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_urphoite:Urphoite", {
	description = S("Urphoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_urphoite:allores2 1",
	recipe = "allores_urphoite:Urphoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
