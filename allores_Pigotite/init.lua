...
if minetest.get_modpath("allores_pigotite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pigotite:Pigotite", {
	description = S("Pigotite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pigotite:allores2 1",
	recipe = "allores_pigotite:Pigotite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
