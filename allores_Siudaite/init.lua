...
if minetest.get_modpath("allores_siudaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_siudaite:Siudaite", {
	description = S("Siudaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_siudaite:allores2 1",
	recipe = "allores_siudaite:Siudaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
