...
if minetest.get_modpath("allores_oulankaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_oulankaite:Oulankaite", {
	description = S("Oulankaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_oulankaite:allores2 1",
	recipe = "allores_oulankaite:Oulankaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_oulankaite:Oulankaite",
