...
if minetest.get_modpath("allores_xenotime_yb") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_xenotime_yb:Xenotime_Yb", {
	description = S("Xenotime_Yb") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_xenotime_yb:allores2 1",
	recipe = "allores_xenotime_yb:Xenotime_Yb",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_xenotime_yb:Xenotime_Yb",
