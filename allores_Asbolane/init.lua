...
if minetest.get_modpath("allores_asbolane") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_asbolane:Asbolane", {
	description = S("Asbolane") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_asbolane:allores2 1",
	recipe = "allores_asbolane:Asbolane",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
