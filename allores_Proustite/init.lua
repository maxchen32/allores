...
if minetest.get_modpath("allores_proustite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_proustite:Proustite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_proustite:allores2 1",
	recipe = "allores_proustite:Proustite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_proustite:Proustite",
