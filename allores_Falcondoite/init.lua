...
if minetest.get_modpath("allores_falcondoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_falcondoite:Falcondoite", {
	description = S("Falcondoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_falcondoite:allores2 1",
	recipe = "allores_falcondoite:Falcondoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_falcondoite:Falcondoite",
