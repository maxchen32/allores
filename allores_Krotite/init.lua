...
if minetest.get_modpath("allores_krotite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_krotite:Krotite", {
	description = S("Krotite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_krotite:allores2 1",
	recipe = "allores_krotite:Krotite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
