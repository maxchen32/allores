...
if minetest.get_modpath("allores_salesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_salesite:Salesite", {
	description = S("Salesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_salesite:allores2 1",
	recipe = "allores_salesite:Salesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
