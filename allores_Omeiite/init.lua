...
if minetest.get_modpath("allores_omeiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_omeiite:Omeiite", {
	description = S("Omeiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_omeiite:allores2 1",
	recipe = "allores_omeiite:Omeiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
