...
if minetest.get_modpath("allores_ginorite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ginorite:Ginorite", {
	description = S("Ginorite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ginorite:allores2 1",
	recipe = "allores_ginorite:Ginorite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
