...
if minetest.get_modpath("allores_hemloite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hemloite:Hemloite", {
	description = S("Hemloite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hemloite:allores2 1",
	recipe = "allores_hemloite:Hemloite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
