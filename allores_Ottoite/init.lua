...
if minetest.get_modpath("allores_ottoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ottoite:Ottoite", {
	description = S("Ottoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ottoite:allores2 1",
	recipe = "allores_ottoite:Ottoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
