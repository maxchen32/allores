...
if minetest.get_modpath("allores_quijarroite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_quijarroite:Quijarroite", {
	description = S("Quijarroite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_quijarroite:allores2 1",
	recipe = "allores_quijarroite:Quijarroite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_quijarroite:Quijarroite",
