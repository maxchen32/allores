...
if minetest.get_modpath("allores_curite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_curite:Curite", {
	description = S("Curite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_curite:allores2 1",
	recipe = "allores_curite:Curite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
