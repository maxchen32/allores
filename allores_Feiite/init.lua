...
if minetest.get_modpath("allores_feiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_feiite:Feiite", {
	description = S("Feiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_feiite:allores2 1",
	recipe = "allores_feiite:Feiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
