...
if minetest.get_modpath("allores_mohite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mohite:Mohite", {
	description = S("Mohite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mohite:allores2 1",
	recipe = "allores_mohite:Mohite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
