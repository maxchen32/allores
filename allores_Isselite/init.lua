...
if minetest.get_modpath("allores_isselite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_isselite:Isselite", {
	description = S("Isselite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_isselite:allores2 1",
	recipe = "allores_isselite:Isselite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
