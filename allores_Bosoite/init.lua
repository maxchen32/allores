...
if minetest.get_modpath("allores_bosoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bosoite:Bosoite", {
	description = S("Bosoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bosoite:allores2 1",
	recipe = "allores_bosoite:Bosoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
