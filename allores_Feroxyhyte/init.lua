...
if minetest.get_modpath("allores_feroxyhyte") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_feroxyhyte:Feroxyhyte", {
	description = S("Feroxyhyte") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_feroxyhyte:allores2 1",
	recipe = "allores_feroxyhyte:Feroxyhyte",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_feroxyhyte:Feroxyhyte",
