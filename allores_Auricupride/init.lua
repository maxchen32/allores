...
if minetest.get_modpath("allores_auricupride") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_auricupride:Auricupride", {
	description = S("Auricupride") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_auricupride:allores2 1",
	recipe = "allores_auricupride:Auricupride",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_auricupride:Auricupride",
