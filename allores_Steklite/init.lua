...
if minetest.get_modpath("allores_steklite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_steklite:Steklite", {
	description = S("Steklite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_steklite:allores2 1",
	recipe = "allores_steklite:Steklite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
