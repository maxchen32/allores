...
if minetest.get_modpath("allores_duftite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_duftite:Duftite", {
	description = S("Duftite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_duftite:allores2 1",
	recipe = "allores_duftite:Duftite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
