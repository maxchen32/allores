...
if minetest.get_modpath("allores_pinnoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pinnoite:Pinnoite", {
	description = S("Pinnoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pinnoite:allores2 1",
	recipe = "allores_pinnoite:Pinnoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
