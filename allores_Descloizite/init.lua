...
if minetest.get_modpath("allores_descloizite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_descloizite:Descloizite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_descloizite:allores2 1",
	recipe = "allores_descloizite:Descloizite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_descloizite:Descloizite",
