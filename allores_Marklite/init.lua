...
if minetest.get_modpath("allores_marklite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_marklite:Marklite", {
	description = S("Marklite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_marklite:allores2 1",
	recipe = "allores_marklite:Marklite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
