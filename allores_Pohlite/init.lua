...
if minetest.get_modpath("allores_pohlite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pohlite:Pohlite", {
	description = S("Pohlite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pohlite:allores2 1",
	recipe = "allores_pohlite:Pohlite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
