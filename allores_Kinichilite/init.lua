...
if minetest.get_modpath("allores_kinichilite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kinichilite:Kinichilite", {
	description = S("Kinichilite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kinichilite:allores2 1",
	recipe = "allores_kinichilite:Kinichilite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kinichilite:Kinichilite",
