...
if minetest.get_modpath("allores_rajite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rajite:Rajite", {
	description = S("Rajite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rajite:allores2 1",
	recipe = "allores_rajite:Rajite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
