...
if minetest.get_modpath("allores_cupalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cupalite:Cupalite", {
	description = S("Cupalite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cupalite:allores2 1",
	recipe = "allores_cupalite:Cupalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
