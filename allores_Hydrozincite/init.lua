allores_hydrozincite = {}
local S = minetest.get_translator(minetest.get_current_modname())

if minetest.get_modpath("allores_hydrozincite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hydrozincite:Hydrozincite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hydrozincite:allores2 1",
	recipe = "allores_hydrozincite:Hydrozincite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hydrozincite:Hydrozincite",
