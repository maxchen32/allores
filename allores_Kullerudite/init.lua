...
if minetest.get_modpath("allores_kullerudite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kullerudite:Kullerudite", {
	description = S("Kullerudite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kullerudite:allores2 1",
	recipe = "allores_kullerudite:Kullerudite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kullerudite:Kullerudite",
