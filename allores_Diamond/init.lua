...
if minetest.get_modpath("allores_diamond") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_diamond:Diamond", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_diamond:allores2 1",
	recipe = "allores_diamond:Diamond",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
