...
if minetest.get_modpath("allores_anilite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_anilite:Anilite", {
	description = S("Anilite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_anilite:allores2 1",
	recipe = "allores_anilite:Anilite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
