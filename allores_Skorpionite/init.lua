...
if minetest.get_modpath("allores_skorpionite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_skorpionite:Skorpionite", {
	description = S("Skorpionite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_skorpionite:allores2 1",
	recipe = "allores_skorpionite:Skorpionite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_skorpionite:Skorpionite",
