...
if minetest.get_modpath("allores_scawtite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_scawtite:Scawtite", {
	description = S("Scawtite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_scawtite:allores2 1",
	recipe = "allores_scawtite:Scawtite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
