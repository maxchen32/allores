...
if minetest.get_modpath("allores_naquite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_naquite:Naquite", {
	description = S("Naquite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_naquite:allores2 1",
	recipe = "allores_naquite:Naquite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
