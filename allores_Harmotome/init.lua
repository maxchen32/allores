...
if minetest.get_modpath("allores_harmotome") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_harmotome:Harmotome", {
	description = S("Harmotome") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_harmotome:allores2 1",
	recipe = "allores_harmotome:Harmotome",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_harmotome:Harmotome",
