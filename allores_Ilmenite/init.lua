...
if minetest.get_modpath("allores_ilmenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ilmenite:Ilmenite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ilmenite:allores2 1",
	recipe = "allores_ilmenite:Ilmenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
