...
if minetest.get_modpath("allores_belloite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_belloite:Belloite", {
	description = S("Belloite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_belloite:allores2 1",
	recipe = "allores_belloite:Belloite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
