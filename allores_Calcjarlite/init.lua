...
if minetest.get_modpath("allores_calcjarlite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_calcjarlite:Calcjarlite", {
	description = S("Calcjarlite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_calcjarlite:allores2 1",
	recipe = "allores_calcjarlite:Calcjarlite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_calcjarlite:Calcjarlite",
