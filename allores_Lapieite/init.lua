...
if minetest.get_modpath("allores_lapieite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lapieite:Lapieite", {
	description = S("Lapieite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lapieite:allores2 1",
	recipe = "allores_lapieite:Lapieite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
