...
if minetest.get_modpath("allores_yvonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_yvonite:Yvonite", {
	description = S("Yvonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_yvonite:allores2 1",
	recipe = "allores_yvonite:Yvonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
