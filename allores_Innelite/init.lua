...
if minetest.get_modpath("allores_innelite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_innelite:Innelite", {
	description = S("Innelite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_innelite:allores2 1",
	recipe = "allores_innelite:Innelite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
