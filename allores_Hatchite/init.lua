...
if minetest.get_modpath("allores_hatchite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hatchite:Hatchite", {
	description = S("Hatchite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hatchite:allores2 1",
	recipe = "allores_hatchite:Hatchite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
