...
if minetest.get_modpath("allores_romerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_romerite:Romerite", {
	description = S("Romerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_romerite:allores2 1",
	recipe = "allores_romerite:Romerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
