...
if minetest.get_modpath("allores_faheyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_faheyite:Faheyite", {
	description = S("Faheyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_faheyite:allores2 1",
	recipe = "allores_faheyite:Faheyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
