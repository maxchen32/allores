...
if minetest.get_modpath("allores_natron") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_natron:Natron", {
	description = S("Natron") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_natron:allores2 1",
	recipe = "allores_natron:Natron",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
