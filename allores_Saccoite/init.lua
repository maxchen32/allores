...
if minetest.get_modpath("allores_saccoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_saccoite:Saccoite", {
	description = S("Saccoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_saccoite:allores2 1",
	recipe = "allores_saccoite:Saccoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
