...
if minetest.get_modpath("allores_ferberite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ferberite:Ferberite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ferberite:allores2 1",
	recipe = "allores_ferberite:Ferberite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ferberite:Ferberite",
