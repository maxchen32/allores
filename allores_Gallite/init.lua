...
if minetest.get_modpath("allores_gallite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gallite:Gallite", {
	description = S("Gallite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gallite:allores2 1",
	recipe = "allores_gallite:Gallite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
