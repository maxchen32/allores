...
if minetest.get_modpath("allores_fangite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fangite:Fangite", {
	description = S("Fangite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fangite:allores2 1",
	recipe = "allores_fangite:Fangite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
