...
if minetest.get_modpath("allores_erniggliite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_erniggliite:Erniggliite", {
	description = S("Erniggliite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_erniggliite:allores2 1",
	recipe = "allores_erniggliite:Erniggliite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_erniggliite:Erniggliite",
