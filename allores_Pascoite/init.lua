...
if minetest.get_modpath("allores_pascoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pascoite:Pascoite", {
	description = S("Pascoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pascoite:allores2 1",
	recipe = "allores_pascoite:Pascoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
