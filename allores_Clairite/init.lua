...
if minetest.get_modpath("allores_clairite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_clairite:Clairite", {
	description = S("Clairite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_clairite:allores2 1",
	recipe = "allores_clairite:Clairite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
