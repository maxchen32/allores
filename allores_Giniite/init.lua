...
if minetest.get_modpath("allores_giniite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_giniite:Giniite", {
	description = S("Giniite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_giniite:allores2 1",
	recipe = "allores_giniite:Giniite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
