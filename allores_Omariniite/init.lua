...
if minetest.get_modpath("allores_omariniite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_omariniite:Omariniite", {
	description = S("Omariniite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_omariniite:allores2 1",
	recipe = "allores_omariniite:Omariniite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_omariniite:Omariniite",
