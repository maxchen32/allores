...
if minetest.get_modpath("allores_pilawite_y") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pilawite_y:Pilawite_Y", {
	description = S("Pilawite_Y") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pilawite_y:allores2 1",
	recipe = "allores_pilawite_y:Pilawite_Y",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_pilawite_y:Pilawite_Y",
