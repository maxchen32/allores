...
if minetest.get_modpath("allores_gladite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gladite:Gladite", {
	description = S("Gladite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gladite:allores2 1",
	recipe = "allores_gladite:Gladite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
