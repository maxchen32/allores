...
if minetest.get_modpath("allores_lenaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lenaite:Lenaite", {
	description = S("Lenaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lenaite:allores2 1",
	recipe = "allores_lenaite:Lenaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
