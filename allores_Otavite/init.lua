...
if minetest.get_modpath("allores_otavite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_otavite:Otavite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_otavite:allores2 1",
	recipe = "allores_otavite:Otavite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
