...
if minetest.get_modpath("allores_darapskite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_darapskite:Darapskite", {
	description = S("Darapskite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_darapskite:allores2 1",
	recipe = "allores_darapskite:Darapskite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_darapskite:Darapskite",
