...
if minetest.get_modpath("allores_mundite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mundite:Mundite", {
	description = S("Mundite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mundite:allores2 1",
	recipe = "allores_mundite:Mundite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
