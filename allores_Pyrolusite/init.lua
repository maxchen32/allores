...
if minetest.get_modpath("allores_pyrolusite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pyrolusite:Pyrolusite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pyrolusite:allores2 1",
	recipe = "allores_pyrolusite:Pyrolusite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_pyrolusite:Pyrolusite",
