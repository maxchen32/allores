...
if minetest.get_modpath("allores_wurtzite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wurtzite:Wurtzite", {
	description = S("Wurtzite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wurtzite:allores2 1",
	recipe = "allores_wurtzite:Wurtzite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
