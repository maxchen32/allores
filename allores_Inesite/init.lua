...
if minetest.get_modpath("allores_inesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_inesite:Inesite", {
	description = S("Inesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_inesite:allores2 1",
	recipe = "allores_inesite:Inesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
