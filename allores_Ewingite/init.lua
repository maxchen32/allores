...
if minetest.get_modpath("allores_ewingite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ewingite:Ewingite", {
	description = S("Ewingite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ewingite:allores2 1",
	recipe = "allores_ewingite:Ewingite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
