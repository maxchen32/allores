...
if minetest.get_modpath("allores_wardite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wardite:Wardite", {
	description = S("Wardite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wardite:allores2 1",
	recipe = "allores_wardite:Wardite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
