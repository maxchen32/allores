...
if minetest.get_modpath("allores_tosudite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tosudite:Tosudite", {
	description = S("Tosudite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tosudite:allores2 1",
	recipe = "allores_tosudite:Tosudite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
