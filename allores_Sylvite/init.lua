...
if minetest.get_modpath("allores_sylvite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sylvite:Sylvite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sylvite:allores2 1",
	recipe = "allores_sylvite:Sylvite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
