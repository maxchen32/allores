...
if minetest.get_modpath("allores_negevite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_negevite:Negevite", {
	description = S("Negevite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_negevite:allores2 1",
	recipe = "allores_negevite:Negevite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
