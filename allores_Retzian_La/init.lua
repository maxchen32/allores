...
if minetest.get_modpath("allores_retzian_la") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_retzian_la:Retzian_La", {
	description = S("Retzian_La") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_retzian_la:allores2 1",
	recipe = "allores_retzian_la:Retzian_La",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_retzian_la:Retzian_La",
