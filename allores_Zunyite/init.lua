...
if minetest.get_modpath("allores_zunyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zunyite:Zunyite", {
	description = S("Zunyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zunyite:allores2 1",
	recipe = "allores_zunyite:Zunyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
