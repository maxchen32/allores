...
if minetest.get_modpath("allores_cafetite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cafetite:Cafetite", {
	description = S("Cafetite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cafetite:allores2 1",
	recipe = "allores_cafetite:Cafetite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
