allores_hemimorphite = {}
local S = minetest.get_translator(minetest.get_current_modname())

if minetest.get_modpath("allores_hemimorphite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hemimorphite:Hemimorphite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hemimorphite:allores2 1",
	recipe = "allores_hemimorphite:Hemimorphite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hemimorphite:Hemimorphite",
