...
if minetest.get_modpath("allores_aegirine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_aegirine:Aegirine", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_aegirine:allores2 1",
	recipe = "allores_aegirine:Aegirine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
