...
if minetest.get_modpath("allores_huangite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_huangite:Huangite", {
	description = S("Huangite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_huangite:allores2 1",
	recipe = "allores_huangite:Huangite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
