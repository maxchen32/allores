...
if minetest.get_modpath("allores_levyne_na") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_levyne_na:Levyne_Na", {
	description = S("Levyne_Na") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_levyne_na:allores2 1",
	recipe = "allores_levyne_na:Levyne_Na",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_levyne_na:Levyne_Na",
