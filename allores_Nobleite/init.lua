...
if minetest.get_modpath("allores_nobleite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nobleite:Nobleite", {
	description = S("Nobleite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nobleite:allores2 1",
	recipe = "allores_nobleite:Nobleite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
