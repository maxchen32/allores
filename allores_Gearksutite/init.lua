...
if minetest.get_modpath("allores_gearksutite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gearksutite:Gearksutite", {
	description = S("Gearksutite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gearksutite:allores2 1",
	recipe = "allores_gearksutite:Gearksutite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_gearksutite:Gearksutite",
