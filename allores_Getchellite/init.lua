...
if minetest.get_modpath("allores_getchellite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_getchellite:Getchellite", {
	description = S("Getchellite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_getchellite:allores2 1",
	recipe = "allores_getchellite:Getchellite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_getchellite:Getchellite",
