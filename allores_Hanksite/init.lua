...
if minetest.get_modpath("allores_hanksite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hanksite:Hanksite", {
	description = S("Hanksite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hanksite:allores2 1",
	recipe = "allores_hanksite:Hanksite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
