allores_boulangerite = {}
local S = minetest.get_translator(minetest.get_current_modname())

if minetest.get_modpath("allores_boulangerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_boulangerite:Boulangerite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_boulangerite:allores2 1",
	recipe = "allores_boulangerite:Boulangerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_boulangerite:Boulangerite",
