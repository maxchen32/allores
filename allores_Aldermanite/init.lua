...
if minetest.get_modpath("allores_aldermanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_aldermanite:Aldermanite", {
	description = S("Aldermanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_aldermanite:allores2 1",
	recipe = "allores_aldermanite:Aldermanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_aldermanite:Aldermanite",
