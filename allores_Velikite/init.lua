...
if minetest.get_modpath("allores_velikite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_velikite:Velikite", {
	description = S("Velikite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_velikite:allores2 1",
	recipe = "allores_velikite:Velikite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
