...
if minetest.get_modpath("allores_hessite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hessite:Hessite", {
	description = S("Hessite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hessite:allores2 1",
	recipe = "allores_hessite:Hessite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
