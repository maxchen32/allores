...
if minetest.get_modpath("allores_zadovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zadovite:Zadovite", {
	description = S("Zadovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zadovite:allores2 1",
	recipe = "allores_zadovite:Zadovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
