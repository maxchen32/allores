...
if minetest.get_modpath("allores_chalcocite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chalcocite:Chalcocite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chalcocite:allores2 1",
	recipe = "allores_chalcocite:Chalcocite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chalcocite:Chalcocite",
