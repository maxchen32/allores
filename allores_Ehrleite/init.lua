...
if minetest.get_modpath("allores_ehrleite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ehrleite:Ehrleite", {
	description = S("Ehrleite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ehrleite:allores2 1",
	recipe = "allores_ehrleite:Ehrleite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
