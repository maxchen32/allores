...
if minetest.get_modpath("allores_haxonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_haxonite:Haxonite", {
	description = S("Haxonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_haxonite:allores2 1",
	recipe = "allores_haxonite:Haxonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
