...
if minetest.get_modpath("allores_salammoniac") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_salammoniac:Salammoniac", {
	description = S("Salammoniac") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_salammoniac:allores2 1",
	recipe = "allores_salammoniac:Salammoniac",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_salammoniac:Salammoniac",
