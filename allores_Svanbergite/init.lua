...
if minetest.get_modpath("allores_svanbergite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_svanbergite:Svanbergite", {
	description = S("Svanbergite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_svanbergite:allores2 1",
	recipe = "allores_svanbergite:Svanbergite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_svanbergite:Svanbergite",
