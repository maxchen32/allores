...
if minetest.get_modpath("allores_kulanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kulanite:Kulanite", {
	description = S("Kulanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kulanite:allores2 1",
	recipe = "allores_kulanite:Kulanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
