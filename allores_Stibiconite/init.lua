...
if minetest.get_modpath("allores_stibiconite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_stibiconite:Stibiconite", {
	description = S("Stibiconite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_stibiconite:allores2 1",
	recipe = "allores_stibiconite:Stibiconite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_stibiconite:Stibiconite",
