...
if minetest.get_modpath("allores_ivsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ivsite:Ivsite", {
	description = S("Ivsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ivsite:allores2 1",
	recipe = "allores_ivsite:Ivsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
