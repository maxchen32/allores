...
if minetest.get_modpath("allores_epidote_sr") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_epidote_sr:Epidote_Sr", {
	description = S("Epidote_Sr") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_epidote_sr:allores2 1",
	recipe = "allores_epidote_sr:Epidote_Sr",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_epidote_sr:Epidote_Sr",
