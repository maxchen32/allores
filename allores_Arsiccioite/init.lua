...
if minetest.get_modpath("allores_arsiccioite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_arsiccioite:Arsiccioite", {
	description = S("Arsiccioite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_arsiccioite:allores2 1",
	recipe = "allores_arsiccioite:Arsiccioite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_arsiccioite:Arsiccioite",
