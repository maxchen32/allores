...
if minetest.get_modpath("allores_ewaldite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ewaldite:Ewaldite", {
	description = S("Ewaldite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ewaldite:allores2 1",
	recipe = "allores_ewaldite:Ewaldite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
