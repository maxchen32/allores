...
if minetest.get_modpath("allores_mirabilite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mirabilite:Mirabilite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mirabilite:allores2 1",
	recipe = "allores_mirabilite:Mirabilite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_mirabilite:Mirabilite",
