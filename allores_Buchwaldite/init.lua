...
if minetest.get_modpath("allores_buchwaldite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_buchwaldite:Buchwaldite", {
	description = S("Buchwaldite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_buchwaldite:allores2 1",
	recipe = "allores_buchwaldite:Buchwaldite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_buchwaldite:Buchwaldite",
