...
if minetest.get_modpath("allores_hexahydrite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hexahydrite:Hexahydrite", {
	description = S("Hexahydrite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hexahydrite:allores2 1",
	recipe = "allores_hexahydrite:Hexahydrite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hexahydrite:Hexahydrite",
