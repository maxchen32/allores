...
if minetest.get_modpath("allores_fairbankite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fairbankite:Fairbankite", {
	description = S("Fairbankite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fairbankite:allores2 1",
	recipe = "allores_fairbankite:Fairbankite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_fairbankite:Fairbankite",
