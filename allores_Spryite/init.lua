...
if minetest.get_modpath("allores_spryite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_spryite:Spryite", {
	description = S("Spryite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_spryite:allores2 1",
	recipe = "allores_spryite:Spryite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
