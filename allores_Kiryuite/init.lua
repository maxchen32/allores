...
if minetest.get_modpath("allores_kiryuite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kiryuite:Kiryuite", {
	description = S("Kiryuite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kiryuite:allores2 1",
	recipe = "allores_kiryuite:Kiryuite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
