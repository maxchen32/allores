...
if minetest.get_modpath("allores_jennite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jennite:Jennite", {
	description = S("Jennite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jennite:allores2 1",
	recipe = "allores_jennite:Jennite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
