...
if minetest.get_modpath("allores_mullite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mullite:Mullite", {
	description = S("Mullite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mullite:allores2 1",
	recipe = "allores_mullite:Mullite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
