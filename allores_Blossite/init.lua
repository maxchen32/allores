...
if minetest.get_modpath("allores_blossite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_blossite:Blossite", {
	description = S("Blossite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_blossite:allores2 1",
	recipe = "allores_blossite:Blossite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
