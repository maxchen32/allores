...
if minetest.get_modpath("allores_chrysocolla") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chrysocolla:Chrysocolla", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chrysocolla:allores2 1",
	recipe = "allores_chrysocolla:Chrysocolla",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chrysocolla:Chrysocolla",
