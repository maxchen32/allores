...
if minetest.get_modpath("allores_heideite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_heideite:Heideite", {
	description = S("Heideite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_heideite:allores2 1",
	recipe = "allores_heideite:Heideite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
