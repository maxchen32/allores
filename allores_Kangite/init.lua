...
if minetest.get_modpath("allores_kangite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kangite:Kangite", {
	description = S("Kangite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kangite:allores2 1",
	recipe = "allores_kangite:Kangite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
