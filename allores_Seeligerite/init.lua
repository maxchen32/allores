...
if minetest.get_modpath("allores_seeligerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_seeligerite:Seeligerite", {
	description = S("Seeligerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_seeligerite:allores2 1",
	recipe = "allores_seeligerite:Seeligerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_seeligerite:Seeligerite",
