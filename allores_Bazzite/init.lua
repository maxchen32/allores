...
if minetest.get_modpath("allores_bazzite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bazzite:Bazzite", {
	description = S("Bazzite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bazzite:allores2 1",
	recipe = "allores_bazzite:Bazzite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
