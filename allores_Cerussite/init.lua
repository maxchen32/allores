...
if minetest.get_modpath("allores_cerussite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cerussite:Cerussite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cerussite:allores2 1",
	recipe = "allores_cerussite:Cerussite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_cerussite:Cerussite",
