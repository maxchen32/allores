...
if minetest.get_modpath("allores_krutaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_krutaite:Krutaite", {
	description = S("Krutaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_krutaite:allores2 1",
	recipe = "allores_krutaite:Krutaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
