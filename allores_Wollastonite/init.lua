allores_wollastonite = {}
local S = minetest.get_translator(minetest.get_current_modname())

if minetest.get_modpath("allores_wollastonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wollastonite:Wollastonite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wollastonite:allores2 1",
	recipe = "allores_wollastonite:Wollastonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_wollastonite:Wollastonite",
