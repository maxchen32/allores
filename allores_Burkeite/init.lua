...
if minetest.get_modpath("allores_burkeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_burkeite:Burkeite", {
	description = S("Burkeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_burkeite:allores2 1",
	recipe = "allores_burkeite:Burkeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
