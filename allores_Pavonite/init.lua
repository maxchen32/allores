...
if minetest.get_modpath("allores_pavonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pavonite:Pavonite", {
	description = S("Pavonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pavonite:allores2 1",
	recipe = "allores_pavonite:Pavonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
