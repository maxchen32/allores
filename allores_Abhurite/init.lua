...
if minetest.get_modpath("allores_abhurite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_abhurite:Abhurite", {
	description = S("Abhurite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_abhurite:allores2 1",
	recipe = "allores_abhurite:Abhurite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
