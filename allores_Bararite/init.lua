...
if minetest.get_modpath("allores_bararite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bararite:Bararite", {
	description = S("Bararite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bararite:allores2 1",
	recipe = "allores_bararite:Bararite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
