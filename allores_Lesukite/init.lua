...
if minetest.get_modpath("allores_lesukite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_lesukite:Lesukite", {
	description = S("Lesukite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_lesukite:allores2 1",
	recipe = "allores_lesukite:Lesukite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
