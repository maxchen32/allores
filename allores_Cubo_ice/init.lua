...
if minetest.get_modpath("allores_cubo_ice") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cubo_ice:Cubo_ice", {
	description = S("Cubo_ice") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cubo_ice:allores2 1",
	recipe = "allores_cubo_ice:Cubo_ice",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
