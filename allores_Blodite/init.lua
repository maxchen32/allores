...
if minetest.get_modpath("allores_blodite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_blodite:Blodite", {
	description = S("Blodite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_blodite:allores2 1",
	recipe = "allores_blodite:Blodite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
