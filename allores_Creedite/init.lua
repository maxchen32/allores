...
if minetest.get_modpath("allores_creedite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_creedite:Creedite", {
	description = S("Creedite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_creedite:allores2 1",
	recipe = "allores_creedite:Creedite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
