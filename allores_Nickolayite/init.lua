...
if minetest.get_modpath("allores_nickolayite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nickolayite:Nickolayite", {
	description = S("Nickolayite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nickolayite:allores2 1",
	recipe = "allores_nickolayite:Nickolayite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_nickolayite:Nickolayite",
