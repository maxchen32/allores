...
if minetest.get_modpath("allores_metauroxite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_metauroxite:Metauroxite", {
	description = S("Metauroxite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_metauroxite:allores2 1",
	recipe = "allores_metauroxite:Metauroxite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_metauroxite:Metauroxite",
