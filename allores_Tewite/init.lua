...
if minetest.get_modpath("allores_tewite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tewite:Tewite", {
	description = S("Tewite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tewite:allores2 1",
	recipe = "allores_tewite:Tewite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
