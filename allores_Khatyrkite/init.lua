...
if minetest.get_modpath("allores_khatyrkite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_khatyrkite:Khatyrkite", {
	description = S("Khatyrkite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_khatyrkite:allores2 1",
	recipe = "allores_khatyrkite:Khatyrkite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_khatyrkite:Khatyrkite",
