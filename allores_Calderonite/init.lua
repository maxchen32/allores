...
if minetest.get_modpath("allores_calderonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_calderonite:Calderonite", {
	description = S("Calderonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_calderonite:allores2 1",
	recipe = "allores_calderonite:Calderonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_calderonite:Calderonite",
