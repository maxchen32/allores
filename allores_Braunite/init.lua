...
if minetest.get_modpath("allores_braunite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_braunite:Braunite", {
	description = S("Braunite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_braunite:allores2 1",
	recipe = "allores_braunite:Braunite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
