...
if minetest.get_modpath("allores_uvite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_uvite:Uvite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_uvite:allores2 1",
	recipe = "allores_uvite:Uvite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
