...
-------------------------------------------------
-- node --
minetest.register_node("allores:Potassic_ferro_ferri_sadanagaite", {
	description = ("Potassic_ferro_ferri_sadanagaite") .. "\n" .. ("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	...
	recipe = "allores:Potassic_ferro_ferri_sadanagaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores:Potassic_ferro_ferri_sadanagaite",
