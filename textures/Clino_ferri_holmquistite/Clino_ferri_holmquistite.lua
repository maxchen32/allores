...
-------------------------------------------------
-- node --
minetest.register_node("allores:Clino_ferri_holmquistite", {
	description = ("Clino_ferri_holmquistite") .. "\n" .. ("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	...
	recipe = "allores:Clino_ferri_holmquistite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores:Clino_ferri_holmquistite",
