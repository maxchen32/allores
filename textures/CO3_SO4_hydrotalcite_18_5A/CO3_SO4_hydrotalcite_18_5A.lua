...
-------------------------------------------------
-- node --
minetest.register_node("allores:CO3_SO4_hydrotalcite_18_5A", {
	description = ("CO3_SO4_hydrotalcite_18_5A") .. "\n" .. ("(CO3_SO4_hydrotalcite_18.5A)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	...
	recipe = "allores:CO3_SO4_hydrotalcite_18_5A",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores:CO3_SO4_hydrotalcite_18_5A",
