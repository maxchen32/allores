...
-------------------------------------------------
-- node --
minetest.register_node("allores:SO4_hydrotalcite_8_8A", {
	description = ("SO4_hydrotalcite_8_8A") .. "\n" .. ("(SO4_hydrotalcite_8.8A)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	...
	recipe = "allores:SO4_hydrotalcite_8_8A",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores:SO4_hydrotalcite_8_8A",
