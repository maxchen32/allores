...
-------------------------------------------------
-- node --
minetest.register_node("allores:Carbonatecyanotrichite", {
	description = ("Carbonatecyanotrichite") .. "\n" .. ("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	...
	recipe = "allores:Carbonatecyanotrichite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores:Carbonatecyanotrichite",
