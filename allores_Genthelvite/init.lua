...
if minetest.get_modpath("allores_genthelvite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_genthelvite:Genthelvite", {
	description = S("Genthelvite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_genthelvite:allores2 1",
	recipe = "allores_genthelvite:Genthelvite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_genthelvite:Genthelvite",
