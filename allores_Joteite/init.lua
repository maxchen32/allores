...
if minetest.get_modpath("allores_joteite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_joteite:Joteite", {
	description = S("Joteite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_joteite:allores2 1",
	recipe = "allores_joteite:Joteite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
