...
if minetest.get_modpath("allores_armenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_armenite:Armenite", {
	description = S("Armenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_armenite:allores2 1",
	recipe = "allores_armenite:Armenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
