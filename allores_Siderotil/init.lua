...
if minetest.get_modpath("allores_siderotil") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_siderotil:Siderotil", {
	description = S("Siderotil") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_siderotil:allores2 1",
	recipe = "allores_siderotil:Siderotil",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_siderotil:Siderotil",
