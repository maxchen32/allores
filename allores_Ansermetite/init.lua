...
if minetest.get_modpath("allores_ansermetite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ansermetite:Ansermetite", {
	description = S("Ansermetite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ansermetite:allores2 1",
	recipe = "allores_ansermetite:Ansermetite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ansermetite:Ansermetite",
