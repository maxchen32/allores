...
if minetest.get_modpath("allores_zabinskiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zabinskiite:Zabinskiite", {
	description = S("Zabinskiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zabinskiite:allores2 1",
	recipe = "allores_zabinskiite:Zabinskiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_zabinskiite:Zabinskiite",
