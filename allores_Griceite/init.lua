...
if minetest.get_modpath("allores_griceite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_griceite:Griceite", {
	description = S("Griceite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_griceite:allores2 1",
	recipe = "allores_griceite:Griceite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
