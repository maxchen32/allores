...
if minetest.get_modpath("allores_junoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_junoite:Junoite", {
	description = S("Junoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_junoite:allores2 1",
	recipe = "allores_junoite:Junoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
