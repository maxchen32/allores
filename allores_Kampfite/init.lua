...
if minetest.get_modpath("allores_kampfite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kampfite:Kampfite", {
	description = S("Kampfite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kampfite:allores2 1",
	recipe = "allores_kampfite:Kampfite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
