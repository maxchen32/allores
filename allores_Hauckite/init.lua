...
if minetest.get_modpath("allores_hauckite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hauckite:Hauckite", {
	description = S("Hauckite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hauckite:allores2 1",
	recipe = "allores_hauckite:Hauckite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
