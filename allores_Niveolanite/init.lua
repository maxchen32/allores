...
if minetest.get_modpath("allores_niveolanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_niveolanite:Niveolanite", {
	description = S("Niveolanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_niveolanite:allores2 1",
	recipe = "allores_niveolanite:Niveolanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_niveolanite:Niveolanite",
