...
if minetest.get_modpath("allores_talc") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_talc:Talc", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_talc:allores2 1",
	recipe = "allores_talc:Talc",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
