...
if minetest.get_modpath("allores_upalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_upalite:Upalite", {
	description = S("Upalite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_upalite:allores2 1",
	recipe = "allores_upalite:Upalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
