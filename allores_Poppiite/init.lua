...
if minetest.get_modpath("allores_poppiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_poppiite:Poppiite", {
	description = S("Poppiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_poppiite:allores2 1",
	recipe = "allores_poppiite:Poppiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
