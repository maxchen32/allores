...
if minetest.get_modpath("allores_aravaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_aravaite:Aravaite", {
	description = S("Aravaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_aravaite:allores2 1",
	recipe = "allores_aravaite:Aravaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
