...
if minetest.get_modpath("allores_cabalzarite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cabalzarite:Cabalzarite", {
	description = S("Cabalzarite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cabalzarite:allores2 1",
	recipe = "allores_cabalzarite:Cabalzarite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_cabalzarite:Cabalzarite",
