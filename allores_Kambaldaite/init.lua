...
if minetest.get_modpath("allores_kambaldaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kambaldaite:Kambaldaite", {
	description = S("Kambaldaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kambaldaite:allores2 1",
	recipe = "allores_kambaldaite:Kambaldaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kambaldaite:Kambaldaite",
