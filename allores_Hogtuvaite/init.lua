...
if minetest.get_modpath("allores_hogtuvaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hogtuvaite:Hogtuvaite", {
	description = S("Hogtuvaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hogtuvaite:allores2 1",
	recipe = "allores_hogtuvaite:Hogtuvaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hogtuvaite:Hogtuvaite",
