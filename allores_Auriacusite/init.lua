...
if minetest.get_modpath("allores_auriacusite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_auriacusite:Auriacusite", {
	description = S("Auriacusite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_auriacusite:allores2 1",
	recipe = "allores_auriacusite:Auriacusite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_auriacusite:Auriacusite",
