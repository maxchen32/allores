...
if minetest.get_modpath("allores_dickite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dickite:Dickite", {
	description = S("Dickite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dickite:allores2 1",
	recipe = "allores_dickite:Dickite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
