...
if minetest.get_modpath("allores_jadarite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jadarite:Jadarite", {
	description = S("Jadarite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jadarite:allores2 1",
	recipe = "allores_jadarite:Jadarite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
