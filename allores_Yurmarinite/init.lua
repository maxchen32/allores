...
if minetest.get_modpath("allores_yurmarinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_yurmarinite:Yurmarinite", {
	description = S("Yurmarinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_yurmarinite:allores2 1",
	recipe = "allores_yurmarinite:Yurmarinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_yurmarinite:Yurmarinite",
