...
if minetest.get_modpath("allores_chvilevaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chvilevaite:Chvilevaite", {
	description = S("Chvilevaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chvilevaite:allores2 1",
	recipe = "allores_chvilevaite:Chvilevaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chvilevaite:Chvilevaite",
