...
if minetest.get_modpath("allores_zeophyllite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zeophyllite:Zeophyllite", {
	description = S("Zeophyllite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zeophyllite:allores2 1",
	recipe = "allores_zeophyllite:Zeophyllite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_zeophyllite:Zeophyllite",
