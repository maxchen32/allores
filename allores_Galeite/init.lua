...
if minetest.get_modpath("allores_galeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_galeite:Galeite", {
	description = S("Galeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_galeite:allores2 1",
	recipe = "allores_galeite:Galeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
