...
if minetest.get_modpath("allores_bavsiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bavsiite:Bavsiite", {
	description = S("Bavsiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bavsiite:allores2 1",
	recipe = "allores_bavsiite:Bavsiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
