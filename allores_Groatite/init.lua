...
if minetest.get_modpath("allores_groatite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_groatite:Groatite", {
	description = S("Groatite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_groatite:allores2 1",
	recipe = "allores_groatite:Groatite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
