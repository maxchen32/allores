...
if minetest.get_modpath("allores_thorsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_thorsite:Thorsite", {
	description = S("Thorsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_thorsite:allores2 1",
	recipe = "allores_thorsite:Thorsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
