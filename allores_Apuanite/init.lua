...
if minetest.get_modpath("allores_apuanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_apuanite:Apuanite", {
	description = S("Apuanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_apuanite:allores2 1",
	recipe = "allores_apuanite:Apuanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
