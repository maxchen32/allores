...
if minetest.get_modpath("allores_muirite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_muirite:Muirite", {
	description = S("Muirite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_muirite:allores2 1",
	recipe = "allores_muirite:Muirite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
