...
if minetest.get_modpath("allores_mummeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mummeite:Mummeite", {
	description = S("Mummeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mummeite:allores2 1",
	recipe = "allores_mummeite:Mummeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
