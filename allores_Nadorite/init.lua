...
if minetest.get_modpath("allores_nadorite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nadorite:Nadorite", {
	description = S("Nadorite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nadorite:allores2 1",
	recipe = "allores_nadorite:Nadorite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
