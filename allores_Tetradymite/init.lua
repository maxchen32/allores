...
if minetest.get_modpath("allores_tetradymite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tetradymite:Tetradymite", {
	description = S("Tetradymite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tetradymite:allores2 1",
	recipe = "allores_tetradymite:Tetradymite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_tetradymite:Tetradymite",
