...
if minetest.get_modpath("allores_bostwickite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bostwickite:Bostwickite", {
	description = S("Bostwickite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bostwickite:allores2 1",
	recipe = "allores_bostwickite:Bostwickite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bostwickite:Bostwickite",
