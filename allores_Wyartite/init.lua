...
if minetest.get_modpath("allores_wyartite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wyartite:Wyartite", {
	description = S("Wyartite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wyartite:allores2 1",
	recipe = "allores_wyartite:Wyartite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
