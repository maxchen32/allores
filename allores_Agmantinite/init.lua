...
if minetest.get_modpath("allores_agmantinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_agmantinite:Agmantinite", {
	description = S("Agmantinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_agmantinite:allores2 1",
	recipe = "allores_agmantinite:Agmantinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_agmantinite:Agmantinite",
