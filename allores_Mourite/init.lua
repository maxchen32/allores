...
if minetest.get_modpath("allores_mourite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mourite:Mourite", {
	description = S("Mourite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mourite:allores2 1",
	recipe = "allores_mourite:Mourite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
