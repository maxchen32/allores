...
if minetest.get_modpath("allores_kenyaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kenyaite:Kenyaite", {
	description = S("Kenyaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kenyaite:allores2 1",
	recipe = "allores_kenyaite:Kenyaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
