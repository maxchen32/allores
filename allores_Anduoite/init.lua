...
if minetest.get_modpath("allores_anduoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_anduoite:Anduoite", {
	description = S("Anduoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_anduoite:allores2 1",
	recipe = "allores_anduoite:Anduoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
