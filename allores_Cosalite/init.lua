...
if minetest.get_modpath("allores_cosalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cosalite:Cosalite", {
	description = S("Cosalite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cosalite:allores2 1",
	recipe = "allores_cosalite:Cosalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
