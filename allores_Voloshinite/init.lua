...
if minetest.get_modpath("allores_voloshinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_voloshinite:Voloshinite", {
	description = S("Voloshinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_voloshinite:allores2 1",
	recipe = "allores_voloshinite:Voloshinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_voloshinite:Voloshinite",
