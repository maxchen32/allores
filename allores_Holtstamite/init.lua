...
if minetest.get_modpath("allores_holtstamite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_holtstamite:Holtstamite", {
	description = S("Holtstamite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_holtstamite:allores2 1",
	recipe = "allores_holtstamite:Holtstamite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_holtstamite:Holtstamite",
