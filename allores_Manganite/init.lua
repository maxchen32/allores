...
if minetest.get_modpath("allores_manganite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_manganite:Manganite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_manganite:allores2 1",
	recipe = "allores_manganite:Manganite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_manganite:Manganite",
