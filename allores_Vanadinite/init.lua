...
if minetest.get_modpath("allores_vanadinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vanadinite:Vanadinite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vanadinite:allores2 1",
	recipe = "allores_vanadinite:Vanadinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_vanadinite:Vanadinite",
