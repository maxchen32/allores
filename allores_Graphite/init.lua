...
if minetest.get_modpath("allores_graphite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_graphite:Graphite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_graphite:allores2 1",
	recipe = "allores_graphite:Graphite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
