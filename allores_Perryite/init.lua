...
if minetest.get_modpath("allores_perryite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_perryite:Perryite", {
	description = S("Perryite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_perryite:allores2 1",
	recipe = "allores_perryite:Perryite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
