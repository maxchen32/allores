...
if minetest.get_modpath("allores_bottinoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bottinoite:Bottinoite", {
	description = S("Bottinoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bottinoite:allores2 1",
	recipe = "allores_bottinoite:Bottinoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bottinoite:Bottinoite",
