...
if minetest.get_modpath("allores_criddleite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_criddleite:Criddleite", {
	description = S("Criddleite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_criddleite:allores2 1",
	recipe = "allores_criddleite:Criddleite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_criddleite:Criddleite",
