...
if minetest.get_modpath("allores_sonolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sonolite:Sonolite", {
	description = S("Sonolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sonolite:allores2 1",
	recipe = "allores_sonolite:Sonolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
