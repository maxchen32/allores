...
if minetest.get_modpath("allores_efremovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_efremovite:Efremovite", {
	description = S("Efremovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_efremovite:allores2 1",
	recipe = "allores_efremovite:Efremovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_efremovite:Efremovite",
