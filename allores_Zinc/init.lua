...
if minetest.get_modpath("allores_zinc") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zinc:Zinc", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zinc:allores2 1",
	recipe = "allores_zinc:Zinc",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
