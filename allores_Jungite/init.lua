...
if minetest.get_modpath("allores_jungite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jungite:Jungite", {
	description = S("Jungite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jungite:allores2 1",
	recipe = "allores_jungite:Jungite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
