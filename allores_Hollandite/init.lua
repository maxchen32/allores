...
if minetest.get_modpath("allores_hollandite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hollandite:Hollandite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hollandite:allores2 1",
	recipe = "allores_hollandite:Hollandite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hollandite:Hollandite",
