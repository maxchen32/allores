...
if minetest.get_modpath("allores_dellaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dellaite:Dellaite", {
	description = S("Dellaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dellaite:allores2 1",
	recipe = "allores_dellaite:Dellaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
