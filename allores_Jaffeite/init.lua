...
if minetest.get_modpath("allores_jaffeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jaffeite:Jaffeite", {
	description = S("Jaffeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jaffeite:allores2 1",
	recipe = "allores_jaffeite:Jaffeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
