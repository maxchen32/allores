...
if minetest.get_modpath("allores_inyoite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_inyoite:Inyoite", {
	description = S("Inyoite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_inyoite:allores2 1",
	recipe = "allores_inyoite:Inyoite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
