...
if minetest.get_modpath("allores_angelellite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_angelellite:Angelellite", {
	description = S("Angelellite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_angelellite:allores2 1",
	recipe = "allores_angelellite:Angelellite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_angelellite:Angelellite",
