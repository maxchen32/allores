...
if minetest.get_modpath("allores_vladimirite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vladimirite:Vladimirite", {
	description = S("Vladimirite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vladimirite:allores2 1",
	recipe = "allores_vladimirite:Vladimirite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_vladimirite:Vladimirite",
