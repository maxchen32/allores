...
if minetest.get_modpath("allores_baricite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_baricite:Baricite", {
	description = S("Baricite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_baricite:allores2 1",
	recipe = "allores_baricite:Baricite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
