...
if minetest.get_modpath("allores_nastrophite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nastrophite:Nastrophite", {
	description = S("Nastrophite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nastrophite:allores2 1",
	recipe = "allores_nastrophite:Nastrophite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_nastrophite:Nastrophite",
