...
if minetest.get_modpath("allores_kochite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kochite:Kochite", {
	description = S("Kochite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kochite:allores2 1",
	recipe = "allores_kochite:Kochite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
