...
if minetest.get_modpath("allores_mesaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mesaite:Mesaite", {
	description = S("Mesaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mesaite:allores2 1",
	recipe = "allores_mesaite:Mesaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
