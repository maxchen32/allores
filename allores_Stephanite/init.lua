...
if minetest.get_modpath("allores_stephanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_stephanite:Stephanite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_stephanite:allores2 1",
	recipe = "allores_stephanite:Stephanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_stephanite:Stephanite",
