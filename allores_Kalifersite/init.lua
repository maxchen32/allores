...
if minetest.get_modpath("allores_kalifersite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kalifersite:Kalifersite", {
	description = S("Kalifersite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kalifersite:allores2 1",
	recipe = "allores_kalifersite:Kalifersite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kalifersite:Kalifersite",
