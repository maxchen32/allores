...
if minetest.get_modpath("allores_caresite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_caresite:Caresite", {
	description = S("Caresite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_caresite:allores2 1",
	recipe = "allores_caresite:Caresite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
