...
if minetest.get_modpath("allores_sedovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sedovite:Sedovite", {
	description = S("Sedovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sedovite:allores2 1",
	recipe = "allores_sedovite:Sedovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
