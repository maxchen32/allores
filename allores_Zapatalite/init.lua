...
if minetest.get_modpath("allores_zapatalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zapatalite:Zapatalite", {
	description = S("Zapatalite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zapatalite:allores2 1",
	recipe = "allores_zapatalite:Zapatalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_zapatalite:Zapatalite",
