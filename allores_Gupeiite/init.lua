...
if minetest.get_modpath("allores_gupeiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gupeiite:Gupeiite", {
	description = S("Gupeiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gupeiite:allores2 1",
	recipe = "allores_gupeiite:Gupeiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
