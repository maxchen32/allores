...
if minetest.get_modpath("allores_terskite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_terskite:Terskite", {
	description = S("Terskite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_terskite:allores2 1",
	recipe = "allores_terskite:Terskite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
