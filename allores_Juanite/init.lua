...
if minetest.get_modpath("allores_juanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_juanite:Juanite", {
	description = S("Juanite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_juanite:allores2 1",
	recipe = "allores_juanite:Juanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
