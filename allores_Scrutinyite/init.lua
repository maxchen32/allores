...
if minetest.get_modpath("allores_scrutinyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_scrutinyite:Scrutinyite", {
	description = S("Scrutinyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_scrutinyite:allores2 1",
	recipe = "allores_scrutinyite:Scrutinyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_scrutinyite:Scrutinyite",
