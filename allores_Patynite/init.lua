...
if minetest.get_modpath("allores_patynite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_patynite:Patynite", {
	description = S("Patynite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_patynite:allores2 1",
	recipe = "allores_patynite:Patynite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
