...
if minetest.get_modpath("allores_ilyukhinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ilyukhinite:Ilyukhinite", {
	description = S("Ilyukhinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ilyukhinite:allores2 1",
	recipe = "allores_ilyukhinite:Ilyukhinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_ilyukhinite:Ilyukhinite",
