...
if minetest.get_modpath("allores_pinchite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pinchite:Pinchite", {
	description = S("Pinchite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pinchite:allores2 1",
	recipe = "allores_pinchite:Pinchite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
