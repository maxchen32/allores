...
if minetest.get_modpath("allores_cuspidine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cuspidine:Cuspidine", {
	description = S("Cuspidine") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cuspidine:allores2 1",
	recipe = "allores_cuspidine:Cuspidine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_cuspidine:Cuspidine",
