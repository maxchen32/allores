...
if minetest.get_modpath("allores_mesolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mesolite:Mesolite", {
	description = S("Mesolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mesolite:allores2 1",
	recipe = "allores_mesolite:Mesolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
