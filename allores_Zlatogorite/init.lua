...
if minetest.get_modpath("allores_zlatogorite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zlatogorite:Zlatogorite", {
	description = S("Zlatogorite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zlatogorite:allores2 1",
	recipe = "allores_zlatogorite:Zlatogorite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_zlatogorite:Zlatogorite",
