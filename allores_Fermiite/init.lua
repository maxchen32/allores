...
if minetest.get_modpath("allores_fermiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fermiite:Fermiite", {
	description = S("Fermiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fermiite:allores2 1",
	recipe = "allores_fermiite:Fermiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
