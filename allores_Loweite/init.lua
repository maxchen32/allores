...
if minetest.get_modpath("allores_loweite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_loweite:Loweite", {
	description = S("Loweite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_loweite:allores2 1",
	recipe = "allores_loweite:Loweite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
