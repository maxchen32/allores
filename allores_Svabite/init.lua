...
if minetest.get_modpath("allores_svabite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_svabite:Svabite", {
	description = S("Svabite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_svabite:allores2 1",
	recipe = "allores_svabite:Svabite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
