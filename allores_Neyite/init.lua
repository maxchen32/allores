...
if minetest.get_modpath("allores_neyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_neyite:Neyite", {
	description = S("Neyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_neyite:allores2 1",
	recipe = "allores_neyite:Neyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
