...
if minetest.get_modpath("allores_paceite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_paceite:Paceite", {
	description = S("Paceite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_paceite:allores2 1",
	recipe = "allores_paceite:Paceite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
