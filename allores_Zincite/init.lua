...
if minetest.get_modpath("allores_zincite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zincite:Zincite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zincite:allores2 1",
	recipe = "allores_zincite:Zincite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
