...
if minetest.get_modpath("allores_gaultite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gaultite:Gaultite", {
	description = S("Gaultite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gaultite:allores2 1",
	recipe = "allores_gaultite:Gaultite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
