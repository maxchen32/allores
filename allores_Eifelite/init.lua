...
if minetest.get_modpath("allores_eifelite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_eifelite:Eifelite", {
	description = S("Eifelite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_eifelite:allores2 1",
	recipe = "allores_eifelite:Eifelite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
