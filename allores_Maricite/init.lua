...
if minetest.get_modpath("allores_maricite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_maricite:Maricite", {
	description = S("Maricite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_maricite:allores2 1",
	recipe = "allores_maricite:Maricite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
