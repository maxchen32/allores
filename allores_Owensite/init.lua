...
if minetest.get_modpath("allores_owensite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_owensite:Owensite", {
	description = S("Owensite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_owensite:allores2 1",
	recipe = "allores_owensite:Owensite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
