...
if minetest.get_modpath("allores_rutile") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rutile:Rutile", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rutile:allores2 1",
	recipe = "allores_rutile:Rutile",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
