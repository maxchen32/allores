...
if minetest.get_modpath("allores_axinite_mn") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_axinite_mn:Axinite_Mn", {
	description = S("Axinite_Mn") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_axinite_mn:allores2 1",
	recipe = "allores_axinite_mn:Axinite_Mn",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_axinite_mn:Axinite_Mn",
