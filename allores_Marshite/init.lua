...
if minetest.get_modpath("allores_marshite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_marshite:Marshite", {
	description = S("Marshite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_marshite:allores2 1",
	recipe = "allores_marshite:Marshite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
