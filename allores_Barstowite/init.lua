...
if minetest.get_modpath("allores_barstowite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_barstowite:Barstowite", {
	description = S("Barstowite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_barstowite:allores2 1",
	recipe = "allores_barstowite:Barstowite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_barstowite:Barstowite",
