...
if minetest.get_modpath("allores_bismite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bismite:Bismite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bismite:allores2 1",
	recipe = "allores_bismite:Bismite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
