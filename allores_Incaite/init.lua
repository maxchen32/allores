...
if minetest.get_modpath("allores_incaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_incaite:Incaite", {
	description = S("Incaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_incaite:allores2 1",
	recipe = "allores_incaite:Incaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
