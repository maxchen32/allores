...
if minetest.get_modpath("allores_ilvaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ilvaite:Ilvaite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ilvaite:allores2 1",
	recipe = "allores_ilvaite:Ilvaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
