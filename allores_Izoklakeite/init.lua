...
if minetest.get_modpath("allores_izoklakeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_izoklakeite:Izoklakeite", {
	description = S("Izoklakeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_izoklakeite:allores2 1",
	recipe = "allores_izoklakeite:Izoklakeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_izoklakeite:Izoklakeite",
