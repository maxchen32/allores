...
if minetest.get_modpath("allores_zircon") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zircon:Zircon", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zircon:allores2 1",
	recipe = "allores_zircon:Zircon",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
