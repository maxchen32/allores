...
if minetest.get_modpath("allores_misenite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_misenite:Misenite", {
	description = S("Misenite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_misenite:allores2 1",
	recipe = "allores_misenite:Misenite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
