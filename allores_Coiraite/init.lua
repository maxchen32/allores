...
if minetest.get_modpath("allores_coiraite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_coiraite:Coiraite", {
	description = S("Coiraite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_coiraite:allores2 1",
	recipe = "allores_coiraite:Coiraite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
