...
if minetest.get_modpath("allores_sadanagaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sadanagaite:Sadanagaite", {
	description = S("Sadanagaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sadanagaite:allores2 1",
	recipe = "allores_sadanagaite:Sadanagaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_sadanagaite:Sadanagaite",
