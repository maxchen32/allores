...
if minetest.get_modpath("allores_sodalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sodalite:Sodalite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sodalite:allores2 1",
	recipe = "allores_sodalite:Sodalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
