...
if minetest.get_modpath("allores_idaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_idaite:Idaite", {
	description = S("Idaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_idaite:allores2 1",
	recipe = "allores_idaite:Idaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
