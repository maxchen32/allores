...
if minetest.get_modpath("allores_anapaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_anapaite:Anapaite", {
	description = S("Anapaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_anapaite:allores2 1",
	recipe = "allores_anapaite:Anapaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
