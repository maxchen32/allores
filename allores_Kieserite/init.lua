...
if minetest.get_modpath("allores_kieserite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kieserite:Kieserite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kieserite:allores2 1",
	recipe = "allores_kieserite:Kieserite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kieserite:Kieserite",
