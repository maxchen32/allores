...
if minetest.get_modpath("allores_adelite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_adelite:Adelite", {
	description = S("Adelite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_adelite:allores2 1",
	recipe = "allores_adelite:Adelite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
