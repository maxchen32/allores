...
if minetest.get_modpath("allores_roaldite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_roaldite:Roaldite", {
	description = S("Roaldite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_roaldite:allores2 1",
	recipe = "allores_roaldite:Roaldite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
