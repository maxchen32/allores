...
if minetest.get_modpath("allores_amgaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_amgaite:Amgaite", {
	description = S("Amgaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_amgaite:allores2 1",
	recipe = "allores_amgaite:Amgaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
