...
if minetest.get_modpath("allores_mapimite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_mapimite:Mapimite", {
	description = S("Mapimite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_mapimite:allores2 1",
	recipe = "allores_mapimite:Mapimite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
