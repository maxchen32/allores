...
if minetest.get_modpath("allores_nolzeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nolzeite:Nolzeite", {
	description = S("Nolzeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nolzeite:allores2 1",
	recipe = "allores_nolzeite:Nolzeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
