...
if minetest.get_modpath("allores_cechite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cechite:Cechite", {
	description = S("Cechite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cechite:allores2 1",
	recipe = "allores_cechite:Cechite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
