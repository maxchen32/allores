...
if minetest.get_modpath("allores_sreinite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sreinite:Sreinite", {
	description = S("Sreinite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sreinite:allores2 1",
	recipe = "allores_sreinite:Sreinite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
