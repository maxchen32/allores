...
if minetest.get_modpath("allores_frohbergite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_frohbergite:Frohbergite", {
	description = S("Frohbergite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_frohbergite:allores2 1",
	recipe = "allores_frohbergite:Frohbergite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_frohbergite:Frohbergite",
