...
if minetest.get_modpath("allores_achavalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_achavalite:Achavalite", {
	description = S("Achavalite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_achavalite:allores2 1",
	recipe = "allores_achavalite:Achavalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_achavalite:Achavalite",
