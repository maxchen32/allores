...
if minetest.get_modpath("allores_hyrslite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hyrslite:Hyrslite", {
	description = S("Hyrslite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hyrslite:allores2 1",
	recipe = "allores_hyrslite:Hyrslite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
