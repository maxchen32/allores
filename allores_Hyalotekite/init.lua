...
if minetest.get_modpath("allores_hyalotekite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_hyalotekite:Hyalotekite", {
	description = S("Hyalotekite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_hyalotekite:allores2 1",
	recipe = "allores_hyalotekite:Hyalotekite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_hyalotekite:Hyalotekite",
