...
if minetest.get_modpath("allores_nickeline") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nickeline:Nickeline", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nickeline:allores2 1",
	recipe = "allores_nickeline:Nickeline",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_nickeline:Nickeline",
