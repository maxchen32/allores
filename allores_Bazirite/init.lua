...
if minetest.get_modpath("allores_bazirite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bazirite:Bazirite", {
	description = S("Bazirite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bazirite:allores2 1",
	recipe = "allores_bazirite:Bazirite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
