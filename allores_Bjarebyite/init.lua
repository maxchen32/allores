...
if minetest.get_modpath("allores_bjarebyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bjarebyite:Bjarebyite", {
	description = S("Bjarebyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bjarebyite:allores2 1",
	recipe = "allores_bjarebyite:Bjarebyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bjarebyite:Bjarebyite",
