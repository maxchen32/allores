...
if minetest.get_modpath("allores_holtite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_holtite:Holtite", {
	description = S("Holtite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_holtite:allores2 1",
	recipe = "allores_holtite:Holtite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
