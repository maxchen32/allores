...
if minetest.get_modpath("allores_copper") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_copper:Copper", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_copper:allores2 1",
	recipe = "allores_copper:Copper",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
