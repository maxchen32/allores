...
if minetest.get_modpath("allores_isokite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_isokite:Isokite", {
	description = S("Isokite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_isokite:allores2 1",
	recipe = "allores_isokite:Isokite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
