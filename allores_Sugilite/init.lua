...
if minetest.get_modpath("allores_sugilite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sugilite:Sugilite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sugilite:allores2 1",
	recipe = "allores_sugilite:Sugilite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
