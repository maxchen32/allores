...
if minetest.get_modpath("allores_evansite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_evansite:Evansite", {
	description = S("Evansite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_evansite:allores2 1",
	recipe = "allores_evansite:Evansite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
