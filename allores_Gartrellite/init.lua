...
if minetest.get_modpath("allores_gartrellite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gartrellite:Gartrellite", {
	description = S("Gartrellite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gartrellite:allores2 1",
	recipe = "allores_gartrellite:Gartrellite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_gartrellite:Gartrellite",
