...
if minetest.get_modpath("allores_arsenic") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_arsenic:Arsenic", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_arsenic:allores2 1",
	recipe = "allores_arsenic:Arsenic",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
