...
if minetest.get_modpath("allores_cryolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cryolite:Cryolite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cryolite:allores2 1",
	recipe = "allores_cryolite:Cryolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
