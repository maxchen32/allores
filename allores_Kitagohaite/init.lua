...
if minetest.get_modpath("allores_kitagohaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kitagohaite:Kitagohaite", {
	description = S("Kitagohaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kitagohaite:allores2 1",
	recipe = "allores_kitagohaite:Kitagohaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kitagohaite:Kitagohaite",
