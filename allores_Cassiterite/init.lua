...
if minetest.get_modpath("allores_cassiterite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cassiterite:Cassiterite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cassiterite:allores2 1",
	recipe = "allores_cassiterite:Cassiterite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_cassiterite:Cassiterite",
