...
if minetest.get_modpath("allores_litharge") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_litharge:Litharge", {
	description = S("Litharge") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_litharge:allores2 1",
	recipe = "allores_litharge:Litharge",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
