...
if minetest.get_modpath("allores_honeaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_honeaite:Honeaite", {
	description = S("Honeaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_honeaite:allores2 1",
	recipe = "allores_honeaite:Honeaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
