...
if minetest.get_modpath("allores_padmaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_padmaite:Padmaite", {
	description = S("Padmaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_padmaite:allores2 1",
	recipe = "allores_padmaite:Padmaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
