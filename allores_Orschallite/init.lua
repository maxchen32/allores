...
if minetest.get_modpath("allores_orschallite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_orschallite:Orschallite", {
	description = S("Orschallite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_orschallite:allores2 1",
	recipe = "allores_orschallite:Orschallite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_orschallite:Orschallite",
