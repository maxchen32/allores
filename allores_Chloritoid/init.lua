...
if minetest.get_modpath("allores_chloritoid") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_chloritoid:Chloritoid", {
	description = S("Chloritoid") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_chloritoid:allores2 1",
	recipe = "allores_chloritoid:Chloritoid",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_chloritoid:Chloritoid",
