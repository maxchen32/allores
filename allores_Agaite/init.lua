...
if minetest.get_modpath("allores_agaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_agaite:Agaite", {
	description = S("Agaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_agaite:allores2 1",
	recipe = "allores_agaite:Agaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
