...
if minetest.get_modpath("allores_awaruite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_awaruite:Awaruite", {
	description = S("Awaruite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_awaruite:allores2 1",
	recipe = "allores_awaruite:Awaruite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
