...
if minetest.get_modpath("allores_gaspeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gaspeite:Gaspeite", {
	description = S("Gaspeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gaspeite:allores2 1",
	recipe = "allores_gaspeite:Gaspeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
