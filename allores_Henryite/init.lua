...
if minetest.get_modpath("allores_henryite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_henryite:Henryite", {
	description = S("Henryite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_henryite:allores2 1",
	recipe = "allores_henryite:Henryite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
