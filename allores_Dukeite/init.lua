...
if minetest.get_modpath("allores_dukeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dukeite:Dukeite", {
	description = S("Dukeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dukeite:allores2 1",
	recipe = "allores_dukeite:Dukeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
