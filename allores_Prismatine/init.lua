...
if minetest.get_modpath("allores_prismatine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_prismatine:Prismatine", {
	description = S("Prismatine") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_prismatine:allores2 1",
	recipe = "allores_prismatine:Prismatine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_prismatine:Prismatine",
