...
if minetest.get_modpath("allores_cernyite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cernyite:Cernyite", {
	description = S("Cernyite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cernyite:allores2 1",
	recipe = "allores_cernyite:Cernyite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
