...
if minetest.get_modpath("allores_anatase") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_anatase:Anatase", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_anatase:allores2 1",
	recipe = "allores_anatase:Anatase",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
