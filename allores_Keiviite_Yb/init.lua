...
if minetest.get_modpath("allores_keiviite_yb") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_keiviite_yb:Keiviite_Yb", {
	description = S("Keiviite_Yb") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_keiviite_yb:allores2 1",
	recipe = "allores_keiviite_yb:Keiviite_Yb",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_keiviite_yb:Keiviite_Yb",
