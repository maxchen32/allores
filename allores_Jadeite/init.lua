...
if minetest.get_modpath("allores_jadeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_jadeite:Jadeite", {
	description = S("Jadeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_jadeite:allores2 1",
	recipe = "allores_jadeite:Jadeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
