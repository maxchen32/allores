...
if minetest.get_modpath("allores_meionite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_meionite:Meionite", {
	description = S("Meionite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_meionite:allores2 1",
	recipe = "allores_meionite:Meionite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
