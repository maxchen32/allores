...
if minetest.get_modpath("allores_benauite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_benauite:Benauite", {
	description = S("Benauite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_benauite:allores2 1",
	recipe = "allores_benauite:Benauite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
