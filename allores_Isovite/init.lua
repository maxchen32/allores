...
if minetest.get_modpath("allores_isovite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_isovite:Isovite", {
	description = S("Isovite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_isovite:allores2 1",
	recipe = "allores_isovite:Isovite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
