...
if minetest.get_modpath("allores_senaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_senaite:Senaite", {
	description = S("Senaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_senaite:allores2 1",
	recipe = "allores_senaite:Senaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
