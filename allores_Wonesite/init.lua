...
if minetest.get_modpath("allores_wonesite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wonesite:Wonesite", {
	description = S("Wonesite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wonesite:allores2 1",
	recipe = "allores_wonesite:Wonesite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
