...
if minetest.get_modpath("allores_aravaipaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_aravaipaite:Aravaipaite", {
	description = S("Aravaipaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_aravaipaite:allores2 1",
	recipe = "allores_aravaipaite:Aravaipaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_aravaipaite:Aravaipaite",
