...
if minetest.get_modpath("allores_freibergite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_freibergite:Freibergite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_freibergite:allores2 1",
	recipe = "allores_freibergite:Freibergite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_freibergite:Freibergite",
