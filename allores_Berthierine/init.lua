...
if minetest.get_modpath("allores_berthierine") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_berthierine:Berthierine", {
	description = S("Berthierine") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_berthierine:allores2 1",
	recipe = "allores_berthierine:Berthierine",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_berthierine:Berthierine",
