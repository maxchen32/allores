...
if minetest.get_modpath("allores_guite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_guite:Guite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_guite:allores2 1",
	recipe = "allores_guite:Guite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
