...
if minetest.get_modpath("allores_nollmotzite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_nollmotzite:Nollmotzite", {
	description = S("Nollmotzite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_nollmotzite:allores2 1",
	recipe = "allores_nollmotzite:Nollmotzite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_nollmotzite:Nollmotzite",
