...
if minetest.get_modpath("allores_bowieite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bowieite:Bowieite", {
	description = S("Bowieite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bowieite:allores2 1",
	recipe = "allores_bowieite:Bowieite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
