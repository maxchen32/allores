...
if minetest.get_modpath("allores_arsenolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_arsenolite:Arsenolite", {
	description = S("Arsenolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_arsenolite:allores2 1",
	recipe = "allores_arsenolite:Arsenolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_arsenolite:Arsenolite",
