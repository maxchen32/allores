...
if minetest.get_modpath("allores_romeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_romeite:Romeite", {
	description = S("Romeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_romeite:allores2 1",
	recipe = "allores_romeite:Romeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
