...
if minetest.get_modpath("allores_datolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_datolite:Datolite", {
	description = S("Datolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_datolite:allores2 1",
	recipe = "allores_datolite:Datolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
