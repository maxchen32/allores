...
if minetest.get_modpath("allores_cadmium") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cadmium:Cadmium", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cadmium:allores2 1",
	recipe = "allores_cadmium:Cadmium",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
