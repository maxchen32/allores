...
if minetest.get_modpath("allores_leonite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_leonite:Leonite", {
	description = S("Leonite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_leonite:allores2 1",
	recipe = "allores_leonite:Leonite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
