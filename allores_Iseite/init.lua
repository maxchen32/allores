...
if minetest.get_modpath("allores_iseite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_iseite:Iseite", {
	description = S("Iseite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_iseite:allores2 1",
	recipe = "allores_iseite:Iseite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
