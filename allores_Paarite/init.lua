...
if minetest.get_modpath("allores_paarite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_paarite:Paarite", {
	description = S("Paarite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_paarite:allores2 1",
	recipe = "allores_paarite:Paarite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
