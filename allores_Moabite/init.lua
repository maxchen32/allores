...
if minetest.get_modpath("allores_moabite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_moabite:Moabite", {
	description = S("Moabite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_moabite:allores2 1",
	recipe = "allores_moabite:Moabite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
