...
if minetest.get_modpath("allores_kanemite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kanemite:Kanemite", {
	description = S("Kanemite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kanemite:allores2 1",
	recipe = "allores_kanemite:Kanemite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
