...
if minetest.get_modpath("allores_turquoise") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_turquoise:Turquoise", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_turquoise:allores2 1",
	recipe = "allores_turquoise:Turquoise",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_turquoise:Turquoise",
