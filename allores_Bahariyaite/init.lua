...
if minetest.get_modpath("allores_bahariyaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bahariyaite:Bahariyaite", {
	description = S("Bahariyaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bahariyaite:allores2 1",
	recipe = "allores_bahariyaite:Bahariyaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bahariyaite:Bahariyaite",
