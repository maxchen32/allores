...
if minetest.get_modpath("allores_poubaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_poubaite:Poubaite", {
	description = S("Poubaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_poubaite:allores2 1",
	recipe = "allores_poubaite:Poubaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
