...
if minetest.get_modpath("allores_rouseite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_rouseite:Rouseite", {
	description = S("Rouseite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_rouseite:allores2 1",
	recipe = "allores_rouseite:Rouseite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
