...
if minetest.get_modpath("allores_altisite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_altisite:Altisite", {
	description = S("Altisite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_altisite:allores2 1",
	recipe = "allores_altisite:Altisite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
