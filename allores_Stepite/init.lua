...
if minetest.get_modpath("allores_stepite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_stepite:Stepite", {
	description = S("Stepite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_stepite:allores2 1",
	recipe = "allores_stepite:Stepite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
