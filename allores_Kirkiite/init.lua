...
if minetest.get_modpath("allores_kirkiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kirkiite:Kirkiite", {
	description = S("Kirkiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kirkiite:allores2 1",
	recipe = "allores_kirkiite:Kirkiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
