...
if minetest.get_modpath("allores_majorite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_majorite:Majorite", {
	description = S("Majorite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_majorite:allores2 1",
	recipe = "allores_majorite:Majorite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
