...
if minetest.get_modpath("allores_niasite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_niasite:Niasite", {
	description = S("Niasite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_niasite:allores2 1",
	recipe = "allores_niasite:Niasite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
