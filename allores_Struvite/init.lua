...
if minetest.get_modpath("allores_struvite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_struvite:Struvite", {
	description = S("Struvite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_struvite:allores2 1",
	recipe = "allores_struvite:Struvite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
