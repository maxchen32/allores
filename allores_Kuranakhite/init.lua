...
if minetest.get_modpath("allores_kuranakhite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kuranakhite:Kuranakhite", {
	description = S("Kuranakhite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kuranakhite:allores2 1",
	recipe = "allores_kuranakhite:Kuranakhite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kuranakhite:Kuranakhite",
