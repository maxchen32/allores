...
if minetest.get_modpath("allores_miserite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_miserite:Miserite", {
	description = S("Miserite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_miserite:allores2 1",
	recipe = "allores_miserite:Miserite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
