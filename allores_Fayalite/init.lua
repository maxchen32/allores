...
if minetest.get_modpath("allores_fayalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fayalite:Fayalite", {
	description = S("Fayalite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fayalite:allores2 1",
	recipe = "allores_fayalite:Fayalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
