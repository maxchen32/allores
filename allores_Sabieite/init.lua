...
if minetest.get_modpath("allores_sabieite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sabieite:Sabieite", {
	description = S("Sabieite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sabieite:allores2 1",
	recipe = "allores_sabieite:Sabieite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
