...
if minetest.get_modpath("allores_malachite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_malachite:Malachite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_malachite:allores2 1",
	recipe = "allores_malachite:Malachite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_malachite:Malachite",
