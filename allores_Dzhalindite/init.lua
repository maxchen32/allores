...
if minetest.get_modpath("allores_dzhalindite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dzhalindite:Dzhalindite", {
	description = S("Dzhalindite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dzhalindite:allores2 1",
	recipe = "allores_dzhalindite:Dzhalindite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_dzhalindite:Dzhalindite",
