...
if minetest.get_modpath("allores_prehnite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_prehnite:Prehnite", {
	description = S("Prehnite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_prehnite:allores2 1",
	recipe = "allores_prehnite:Prehnite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
