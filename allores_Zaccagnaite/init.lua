...
if minetest.get_modpath("allores_zaccagnaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_zaccagnaite:Zaccagnaite", {
	description = S("Zaccagnaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_zaccagnaite:allores2 1",
	recipe = "allores_zaccagnaite:Zaccagnaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_zaccagnaite:Zaccagnaite",
