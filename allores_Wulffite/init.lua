...
if minetest.get_modpath("allores_wulffite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_wulffite:Wulffite", {
	description = S("Wulffite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_wulffite:allores2 1",
	recipe = "allores_wulffite:Wulffite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
