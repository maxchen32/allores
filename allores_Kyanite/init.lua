...
if minetest.get_modpath("allores_kyanite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kyanite:Kyanite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kyanite:allores2 1",
	recipe = "allores_kyanite:Kyanite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
