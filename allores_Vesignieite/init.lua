...
if minetest.get_modpath("allores_vesignieite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_vesignieite:Vesignieite", {
	description = S("Vesignieite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_vesignieite:allores2 1",
	recipe = "allores_vesignieite:Vesignieite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_vesignieite:Vesignieite",
