...
if minetest.get_modpath("allores_cahnite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_cahnite:Cahnite", {
	description = S("Cahnite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_cahnite:allores2 1",
	recipe = "allores_cahnite:Cahnite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
