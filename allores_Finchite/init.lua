...
if minetest.get_modpath("allores_finchite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_finchite:Finchite", {
	description = S("Finchite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_finchite:allores2 1",
	recipe = "allores_finchite:Finchite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
