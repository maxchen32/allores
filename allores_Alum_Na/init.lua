...
if minetest.get_modpath("allores_alum_na") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_alum_na:Alum_Na", {
	description = S("Alum_Na") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_alum_na:allores2 1",
	recipe = "allores_alum_na:Alum_Na",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
