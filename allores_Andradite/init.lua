...
if minetest.get_modpath("allores_andradite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_andradite:Andradite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_andradite:allores2 1",
	recipe = "allores_andradite:Andradite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_andradite:Andradite",
