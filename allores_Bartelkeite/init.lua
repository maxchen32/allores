...
if minetest.get_modpath("allores_bartelkeite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_bartelkeite:Bartelkeite", {
	description = S("Bartelkeite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_bartelkeite:allores2 1",
	recipe = "allores_bartelkeite:Bartelkeite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_bartelkeite:Bartelkeite",
