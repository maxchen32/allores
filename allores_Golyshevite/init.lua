...
if minetest.get_modpath("allores_golyshevite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_golyshevite:Golyshevite", {
	description = S("Golyshevite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_golyshevite:allores2 1",
	recipe = "allores_golyshevite:Golyshevite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_golyshevite:Golyshevite",
