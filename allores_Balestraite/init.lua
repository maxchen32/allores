...
if minetest.get_modpath("allores_balestraite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_balestraite:Balestraite", {
	description = S("Balestraite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_balestraite:allores2 1",
	recipe = "allores_balestraite:Balestraite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_balestraite:Balestraite",
