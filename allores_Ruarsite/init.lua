...
if minetest.get_modpath("allores_ruarsite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_ruarsite:Ruarsite", {
	description = S("Ruarsite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_ruarsite:allores2 1",
	recipe = "allores_ruarsite:Ruarsite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
