...
if minetest.get_modpath("allores_pentlandite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pentlandite:Pentlandite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pentlandite:allores2 1",
	recipe = "allores_pentlandite:Pentlandite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_pentlandite:Pentlandite",
