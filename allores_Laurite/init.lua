...
if minetest.get_modpath("allores_laurite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_laurite:Laurite", {
	description = S("Laurite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_laurite:allores2 1",
	recipe = "allores_laurite:Laurite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
