...
if minetest.get_modpath("allores_milarite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_milarite:Milarite", {
	description = S("Milarite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_milarite:allores2 1",
	recipe = "allores_milarite:Milarite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
