...
if minetest.get_modpath("allores_galliskiite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_galliskiite:Galliskiite", {
	description = S("Galliskiite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_galliskiite:allores2 1",
	recipe = "allores_galliskiite:Galliskiite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_galliskiite:Galliskiite",
