...
if minetest.get_modpath("allores_kaznakhtite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_kaznakhtite:Kaznakhtite", {
	description = S("Kaznakhtite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_kaznakhtite:allores2 1",
	recipe = "allores_kaznakhtite:Kaznakhtite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_kaznakhtite:Kaznakhtite",
