...
if minetest.get_modpath("allores_tweddillite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_tweddillite:Tweddillite", {
	description = S("Tweddillite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_tweddillite:allores2 1",
	recipe = "allores_tweddillite:Tweddillite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_tweddillite:Tweddillite",
