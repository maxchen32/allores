...
if minetest.get_modpath("allores_fejerite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_fejerite:Fejerite", {
	description = S("Fejerite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_fejerite:allores2 1",
	recipe = "allores_fejerite:Fejerite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
