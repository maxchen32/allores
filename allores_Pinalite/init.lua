...
if minetest.get_modpath("allores_pinalite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_pinalite:Pinalite", {
	description = S("Pinalite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_pinalite:allores2 1",
	recipe = "allores_pinalite:Pinalite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
