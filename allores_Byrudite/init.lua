...
if minetest.get_modpath("allores_byrudite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_byrudite:Byrudite", {
	description = S("Byrudite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_byrudite:allores2 1",
	recipe = "allores_byrudite:Byrudite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
