...
if minetest.get_modpath("allores_xilingolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_xilingolite:Xilingolite", {
	description = S("Xilingolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_xilingolite:allores2 1",
	recipe = "allores_xilingolite:Xilingolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_xilingolite:Xilingolite",
