...
if minetest.get_modpath("allores_dioptase") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_dioptase:Dioptase", {
	description = S("Dioptase") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_dioptase:allores2 1",
	recipe = "allores_dioptase:Dioptase",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
