...
if minetest.get_modpath("allores_xuite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_xuite:Xuite", {
...
minetest.register_craft({
	type = "cooking",
	output = "allores_xuite:allores2 1",
	recipe = "allores_xuite:Xuite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
