...
if minetest.get_modpath("allores_celleriite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_celleriite:Celleriite", {
	description = S("Celleriite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_celleriite:allores2 1",
	recipe = "allores_celleriite:Celleriite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_celleriite:Celleriite",
