...
if minetest.get_modpath("allores_gordaite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_gordaite:Gordaite", {
	description = S("Gordaite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_gordaite:allores2 1",
	recipe = "allores_gordaite:Gordaite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
