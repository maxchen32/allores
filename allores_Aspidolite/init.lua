...
if minetest.get_modpath("allores_aspidolite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_aspidolite:Aspidolite", {
	description = S("Aspidolite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_aspidolite:allores2 1",
	recipe = "allores_aspidolite:Aspidolite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_aspidolite:Aspidolite",
