...
if minetest.get_modpath("allores_sclarite") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_sclarite:Sclarite", {
	description = S("Sclarite") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_sclarite:allores2 1",
	recipe = "allores_sclarite:Sclarite",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
