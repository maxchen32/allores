...
if minetest.get_modpath("allores_clinochlore") ~= nil then
-------------------------------------------------
-- node --
minetest.register_node("allores_clinochlore:Clinochlore", {
	description = S("Clinochlore") .. "\n" .. S("(All the minerals of the Earth, thanks to RRUFF for the list of minerals)"),
	tiles = {"allores.png"},
	groups = {cracky=3},
})
...
minetest.register_craft({
	type = "cooking",
	output = "allores_clinochlore:allores2 1",
	recipe = "allores_clinochlore:Clinochlore",
	cooktime = 1
})
-------------------------------------------------
--mapgen--
	...
	minetest.register_ore({
		ore_type        = "scatter",
		ore             = "allores_clinochlore:Clinochlore",
